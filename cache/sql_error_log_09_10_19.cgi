 ...
 ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 Date: Tue, 10 Sep 2019 13:10:09 +0000
 Error: 2013 - Lost connection to MySQL server during query
 IP Address: 212.3.198.88 - /index.php?app=core&module=search&section=search&do=search&fromsearch=1
 ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
 mySQL query error: SELECT p.pid, p.queued,t.approved, t.forum_id FROM posts p  LEFT JOIN topics t ON ( p.topic_id=t.tid )   WHERE t.forum_id IN (3,14,24,41,43,7,25,26,35,33,34,38,31,37,53,54,55,63,64,65,66,60) AND  p.queued=0  AND  t.approved=1  AND  t.topic_archive_status IN (0,3)  AND MATCH( p.post ) AGAINST( 'silikons' IN BOOLEAN MODE ) AND t.state != 'link' ORDER BY post_date desc LIMIT 0,200
 .--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------.

...
Отписаться:
-------------- 
Вы можете управлять своими подписками в данной секции форума: <#BOARD_ADDRESS#>?app=core&module=search&do=followed",
...
Адрес темы: <#BOARD_ADDRESS#>?showtopic=<#TOPIC_ID#>&view=getnewpost 
...
<#BOARD_ADDRESS#>
",
'footer' => "С уважением, <#BOARD_NAME#>, <#BOARD_ADDRESS#> ",
...
'new_comment_request' => "<#MEMBERS_DISPLAY_NAME#>, <#COMMENT_NAME#> оставил комментарий в вашем профиле. Так как у вас включена премодерация комментариев, для того, чтобы он появился, необходимо вам его активировать, в противном случае удалить. Сделать это можно по ссылке: <#LINK#>",
'new_friend_added' => "<#MEMBERS_DISPLAY_NAME#>, <#FRIEND_NAME#> стал вашим другом.
Управление списком ваших друзей: <#LINK#>",
'new_friend_approved' => "<#MEMBERS_DISPLAY_NAME#>, <#FRIEND_NAME#> принял предложение стать вашим другом! Управление вашим списком друзей по ссылке: <#LINK#>",
'new_friend_request' => "<#MEMBERS_DISPLAY_NAME#>, <#FRIEND_NAME#> хочет стать вашим другом! Так как у вас включена проверка желающих стать вашими друзьями, то для того, чтобы он появился в вашем списке друзей, его запрос необходимо подтвердить (или отклонить). Сделать это можно по ссылке: <#LINK#>",
...
'new_topic_queue_notify' => "<#BOARD_NAME#>
...
Адрес форума: <#BOARD_ADDRESS#>
",
'personal_convo_invite' => "<#NAME#>, <#POSTER#> добавил вас к личной беседе \"<#TITLE#>\". 
Вы можете прочитать диалог по указанной ниже ссылке:
<#BOARD_ADDRESS#><#LINK#>
",
'personal_convo_new_convo' => "<#NAME#>, <#POSTER#> отправил вам сообщение с заголовком \"<#TITLE#>\". 
<#POSTER#> сказал: ======================================================================
<#TEXT#>
Вы можете просмотреть беседу с ним, пройдя по указанной ниже ссылке:
<#BOARD_ADDRESS#><#LINK#>
",
'personal_convo_new_reply' => "<#NAME#>, <#POSTER#> ответил в личную беседу \"<#TITLE#>\".
<#POSTER#> сказал:
<#TEXT#>
...
'subject__new_friend_approved' => "<a href='%s'>%s</a> активировал дружбу с вами",
'subject__new_friend_request' => "<a href='%s'>%s</a> <a href='%s'>хочет</a> дружить с вами",
'subject__new_likes' => "<a href='%s'>%s</a> понравилось <a href='%s'>сообщение, сделанное вами,</a> в <a href='%s'>%s</a>",
'subject__new_post_queue_notify' => "Новое сообщение, требующее активации",
'subject__new_status' => "<a href='%s'><#OWNER#></a> обновил свой <a href='%s'>статус</a>",
...
'subject__subs_new_topic' => "<a href='%s'>%s</a> создал тему <a href='%s'>%s</a>",
'subject__subs_no_post' => "<a href='%s'>%s</a> replied to <a href='%s'>%s</a>",
'subject__subs_with_post' => "<a href='%s'>%s</a> ответил в тему <a href='%s'>%s</a>",
...
'subs_new_topic' => "<#NAME#>, <#POSTER#> открыл новую тему \"<#TITLE#>\" в разделе \"<#FORUM#>\".

----------------------------------------------------------------------
<#POST#>
----------------------------------------------------------------------

Адрес темы: <#BOARD_ADDRESS#>?showtopic=<#TOPIC_ID#> 

Имейте в виду, что вы можете подписаться на уведомления о новых ответах в этой теме. Это можно сделать как из самой темы, так и нажав на указанную ниже ссылку: <#BOARD_ADDRESS#>?app=core&module=usercp&tab=forums&area=watch&watch=topic&do=list&tid=<#TOPIC_ID#>
...
",
'subs_with_post' => "<#NAME#>, <#POSTER#> опубликовал ответ в тему \"<#TITLE#>\", на которую вы подписаны.

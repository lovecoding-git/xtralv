...
This is to let you know that we have not received a response from you regarding your support request '%s'.

If we do not receive a response within the next %d hours we will assume the matter is resolved.
If this is not the case, please respond to your support request so we can look into the matter further.

The support request can be viewed at %s.
...
We have received your support request '{title}'.

Click here to respond to this message:  <a href='{link}'>{link}</a>

Your password for this support request is \"{key}\".
",
'nexus_support_confirm_member' => "Hello {member_name},
...
'notify_autopay_text' => "Hello {member_name}, 

An invoice has been generated for you and payment has successfully been made using the card we have on file.

This message is for your information only - no further action is required.
",
'notify_autopay_title' => "{title}",
'notify_commission_earned_text' => "Hello {member_name},

You have just earned {extra} commission!

These funds can be applied towards purchases in our store, or against any renewals you have.
Alternatively, you can request a payout by clicking the link below:
{creditlink}",
'notify_commission_earned_title' => "You earned commission!",
'notify_invoicewarn' => "Hello,
...
'notify_new_invoice_text' => "Hello {member_name}, 
...
'notify_payment_failed_text' => "Hello {member_name},
...
Please log in to resubmit payment for this invoice. Pending invoices will remain active for ten business days. If payment has not been submitted within the allotted time, your invoice(s) and related service(s) will expire.
- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
Invoice Title......: {title}
Invoice Total......: {total}
Invoice ID#........: {id}
...
'notify_payment_held_text' => "Hello {member_name},
...
'notify_payment_received_text' => "Hello {member_name},

Thank you for your payment for {title}. Your payment has been received and your purchase is now active.",
'notify_payment_received_title' => "Payment received for {title}",
'notify_payment_waiting_text' => "Hello {member_name},

Thank you for your order for {title}. See the instructions below for submitting your payment:
...
'purchase_download' => "Download %s %s",

...
'agree_submit' => "Izlasīju un piekrītu noteikumiem",
'agree_to_tos' => "Esmu izlasījis un piekrītu",
'already_account' => "Ja tev jau ir lietotāja konts, vari iet uz",
'already_have_account' => "Vai Tu jau esi reģistrētes foruma lietotājs?",
'auth_text' => "Tavs reģistrācijas pieteikums ir veiksmīgi nosūtīts.<br /><br /> Tuvāko 10 minūšu laikā (parasti uzreiz) savā e-pastā saņemsi konta aktivizācijas instrukciju<br /><br />E-pasts tika nosūtīts uz ",
...
'clogin_done' => "Pieslēgšanās veiksmīga",
'clogin_submit' => "Turpināt...",
'clogin_text' => "As this is the first time you've logged in, we require just a few more details before we can proceed",
'clogin_title' => "Laipni lūdzam",
'complete_form' => "Lūdzu, pilnībā aizpildiet formu",
...
'connect_incorrect_details' => "Nepareiza e-pasta adrese vai parole",
'connect_password' => "Parole",
...
'connect_username' => "E-pasta adrese",
...
'coppa_info' => "Vecuma pārbaude",
'coppa_link' => "Lūdzu izvēlies savu dzimšanas dienu",
...
'dname_name' => "Lietotāja vārds",
'dumb_header' => "Konta aktivizācija",
'dumb_submit' => "Turpināt",
'dumb_text' => "The information you need will be in the email that was sent to you.",
'email_address' => "E-pasts",
'email_address_confirm' => "E-pasta pārbaude",
'email_reg_subj' => "Jauna reģistrācija",
...
'fb_complete_reg' => "Pabeigt reģistrāciju",
...
'fb_welcome' => "Laipni lūdzam,",
'following_errors' => "The following errors were found:",
'forum_terms' => "Foruma noteikumi",
...
'lp_random_pass_subject' => "Tava jaunā parole",
'lp_send' => "Turpināt",
...
'must_agree_to_terms' => "Jums jāpiekrīt foruma noteikumiem",
'nav_reg' => "Reģistrācija",
...
'new_account_submit' => "Izveidot jaunu kontu",
'new_account_title' => "Izveidot jaunu kontu",
'new_password' => "Jauna parole",
'new_registration_email' => "Jauna lietotāja reģistrācija",
'new_registration_email1' => "Jauna lietotāja reģistrācija",
...
'qa_question_desc' => "Nepieciešams cīņai ar mēstuļotājiem",
'qa_question_title' => "Reģistrācijas jautājums",
'qa_title' => "Challenge Question",
'ready_register' => "Pievienojies xtra.lv",
'receive_admin_emails' => "Saņemt e-pasta paziņojumus no foruma administrācijas",
'receive_member_emails' => "Saņemt e-pasta paziņojumus no citiem foruma biedriem",
'recover_password' => "Atjaunot paroli",
'register' => "Izveidot kontu",
'registration_form' => "Reģistrācijas forma",
'registration_process' => "Reģistrācija",
'regstep' => "%s. solis",
'regstep_choose_package' => "Choose Package",
'regstep_confirm' => "Apstiprinājums",
'regstep_your_account' => "Pieteikums",
'reg_choose_dname' => "Lietotāja vārds",
'reg_choose_password' => "Parole",
'reg_choose_password_desc' => "3-32 simboli",
'reg_choose_user' => "Lietotāja vārds",
'reg_enter_email' => "E-pasts",
'reg_enter_email_desc' => "So that we can verify your identity, and keep you updated",
'reg_errors_found' => "Reģistrācijas formā ir kļūdas. Lai pabeigtu reģistrāciju, lūdzu pārbaudiet visus ievadītos datus.",
...
'reg_error_email_nm' => "E-pasti nesakrīt",
'reg_error_email_taken' => "Šāds e-pasts jau ir izmantots",
...
'reg_error_username_none' => "Lietotāja vārda atļautais garums ir 3-%s simboli",
'reg_error_username_taken' => "Šāds lietotāja vārds ir aizņemts",
'reg_free' => "Reģistrācija ir ļoti vienkārša un aizņems tikai dažas minūtes. ",
'reg_reenter_email' => "E-pasta adrese vēlreiz",
'reg_reenter_password' => "Parole vēlreiz",
'reg_step1' => "Konta informācija",
'reg_step2' => "Community Options",
'reg_step3' => "Papildus informācija",
'reg_step3_spam' => "Verify you are a human",
'reg_step4_spam' => "Verify you are a human",
'reg_success' => "Reģistrācija veiksmīga",
'reg_terms_popup_title' => "Reģistrācijas noteikumi",
'reg_with_facebook' => "Register Using Facebook",
'required_field' => "Obligāta informācija",
...
'tc_regbut' => "Turpināt reģistrāciju",
'tc_text' => "Lai turpinātu ir jāpiekrīt: ",
'tc_title' => "Reģistrācijas noteikumiem",
'terms_of_use' => "foruma noteikumiem",
'thank_you' => "Paldies",
'time_zone' => "Time Zone",
...
'why_register' => "Kāpēc reģistrēties?",
 ); 

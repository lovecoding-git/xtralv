...
'hosting_terminate_blurb' => "By cancelling this purchase, the account will be terminated on the server.",
'hosting_terminate_no' => "Cancel without terminating account &rarr;",
'hosting_terminate_title' => "Cancel Purchase %s",
'hosting_terminate_yes' => "Continue &rarr;",
'hques' => "Server Queues",
'hque_add' => "Add Queue",
...
'istatus_desc_expd' => "Expired: This invoice had not been paid within 10 days of being generated and has expired. User can still pay invoice.",
...
'package_perms_desc' => "Select any permission sets that should be added to the member account after payment clears. Higher permissions will override the member's existing permission set.<br />Once the package expires, the permission sets will be removed.",
...
'package_secondary_desc' => "Select any secondary groups that should be added to the member account after payment clears.<br />Once the package expires, the secondary groups will be removed.",
...
'shipping_name' => "Name",
'shipping_notification' => "Hello {member_name},
...
'transaction_refund' => "Refuse and Refund",

...
Šis e-pasts Tev tika nosūtīts, jo e-pasta adrese tika norādīta reģistrējoties forumā xtra.lv.
Ja Tu neesi aizpildījis reģistrācijas pieteikumu, vienkārši ignorē šo e-pastu. 

------------------------------------------------
Aktivizācijas instrukcija
------------------------------------------------

Lai aktivizētu savu kontu spiediet uz zemāk esošās saites:

<#THE_LINK#>

(Ja saite nestrādā, vienkārši iekopē to sava pārlūka adreses laukā).

------------------------------------------------
Aktivizācija neizdodas?
------------------------------------------------

Ja neizdevās apstiprināt reģistrāciju, nospiežot uz augstāk minētās saites,
lūdzu spiediet uz zemāk esošās saites:

<#MAN_LINK#>

Jums tiks prasīts lietotāja ID un apstiprināšanas kods:

User ID: <#ID#>
Validation Key: <#CODE#>

Ja reģistrācijas apstiprināšana arī šādi neizdodas, rakstiet uz info@xtra.lv


Paldies par reģistrāciju xtra.lv!",

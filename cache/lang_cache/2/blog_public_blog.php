...
'akismet_error1' => "Akismet API key is invalid",
'akismet_error2' => "Response from Akismet not received",
'akismet_error3' => "Akismet server not found",
'akismet_error4' => "Trackback not identified as spam",
'akismet_error5' => "Trackback identified as spam",
...
'blog_comments_on' => "Comments on blog: %s",
'blog_create_finish' => "Finish",
'blog_create_next' => "Next &gt;",
...
'blog_desc' => "A description of your Blog",
...
'blog_global_disabled_desc' => "This blog is currently disabled. Click <a href='%s'>click here to re-enable it.</a>",
...
'blog_limitentrysize' => "Limit the entry size on main Blog page",
...
'bucpo_comments' => "Manage Comments",
...
'bucpo_rss_tags' => "Tags",
'bucpo_rss_tags_desc' => "Enter tags to apply to all imported items, separate many with a comma. (Optional)",
'bucpo_settings' => "Manage Settings",
'bucpo_view' => "View Blog",
'bucp_blog_owner' => "Owner:",
'bucp_btype_editor' => "Blog Editor",
'bucp_btype_group' => "Group Blog",
'bucp_btype_owner' => "Blog Owner",
...
'cblock_get_my_links' => "My Blog Links",
...
'entry_queued_comments' => "%s queued comment(s)",
...
'report_message' => "<b>Enter your report</b><br /><div class='desc'>Please note: The moderator will be made aware of the link and the entry title.<br /><br />This form is to be used ONLY for reporting objectional content, etc and is not to be used as a method of communicating with moderators for other reasons.</div>",
...
'save_css' => "Save Theme",
'save_settings_c' => "Save Settings &raquo;",

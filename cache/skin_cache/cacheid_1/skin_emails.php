...
{
$count_92f0e007f13acd200a291425b992016b = is_array($this->functionData['forward_form']) ? count($this->functionData['forward_form']) : 0;
$this->functionData['forward_form'][$count_92f0e007f13acd200a291425b992016b]['title'] = $title;
$this->functionData['forward_form'][$count_92f0e007f13acd200a291425b992016b]['text'] = $text;
$this->functionData['forward_form'][$count_92f0e007f13acd200a291425b992016b]['lang'] = $lang;
$this->functionData['forward_form'][$count_92f0e007f13acd200a291425b992016b]['captchaHTML'] = $captchaHTML;
$this->functionData['forward_form'][$count_92f0e007f13acd200a291425b992016b]['msg'] = $msg;
}
					...
					<li class='ipsField clear'>
						...
						<p class='ipsField_content'>
							<select name='lang' class='input_select' id='to_lang'>
								".$this->__f__f919ee2f52afee9ddb7426d0a8d3530d($title,$text,$lang,$captchaHTML,$msg)."							</select>
						</p>
					</li>
				")) . "
				<li class='ipsField clear'>
...
function __f__f919ee2f52afee9ddb7426d0a8d3530d($title="",$text="",$lang="", $captchaHTML='', $msg='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;

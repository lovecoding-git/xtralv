...
/* CACHE FILE: Generated: Tue, 26 Feb 2019 08:00:50 GMT */
...
$this->_funcHooks['globalTemplate'] = array('showingapp','applications','didfirstappnow','navigationlink','closenavigationlink','forsuredidfirstnav','navigation','didfirstappnow','navigationlink','closenavigationlink','forsuredidfirstnav','navigation','isCoreRC','hideRcForPerms','fbcenabled','pagenumberintitle','userte','isLargeTouch','isSmallTouch','showacplink','rclink','accessreports','notifications','messengerlink','notifications','showInboxNotify','authenticating','updateTwitter','updateFacebook','update','canUpdateStatus','userLikeLink','nobbyNoMates','bloglink','pmLink','gallerylink','nexuslink','limFacebook','limTwitter','limOpenid','limWindows','memberbox','brandingBar','showQuickNav','viewnewcontentapp','showhomeurl','applicationsloop','hasCustomPrimaryNavigation','didfirstnav','switchnavigation','mainpageContent','didfirstnav','switchnavigation','ruleslink','siterulestitle','siteruleslink','isTouchDevice','uagentlocked','skinchanger','langchooser','lastvisit','isfloat','sqldebuglink','closesqldebuglink','showdebuglevel','includeLightboxDoReal');
...
$IPBHTML = "";
$IPBHTML .= "<a href='https://www.xtra.lv/index.php' title='{$this->lang->words['go_home']}' rel=\"home\" accesskey='1'><img src='" . $this->registry->getClass('output')->getReplacement("logo_img") . "' alt='{$this->lang->words['logo']}' /></a>";
return $IPBHTML;
}
...
{
$count_5d158096676df15c67782ca0abed77d1 = is_array($this->functionData['globalTemplate']) ? count($this->functionData['globalTemplate']) : 0;
$this->functionData['globalTemplate'][$count_5d158096676df15c67782ca0abed77d1]['html'] = $html;
$this->functionData['globalTemplate'][$count_5d158096676df15c67782ca0abed77d1]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplate'][$count_5d158096676df15c67782ca0abed77d1]['css'] = $css;
$this->functionData['globalTemplate'][$count_5d158096676df15c67782ca0abed77d1]['jsModules'] = $jsModules;
$this->functionData['globalTemplate'][$count_5d158096676df15c67782ca0abed77d1]['metaTags'] = $metaTags;
$this->functionData['globalTemplate'][$count_5d158096676df15c67782ca0abed77d1]['header_items'] = $header_items;
$this->functionData['globalTemplate'][$count_5d158096676df15c67782ca0abed77d1]['items'] = $items;
$this->functionData['globalTemplate'][$count_5d158096676df15c67782ca0abed77d1]['footer_items'] = $footer_items;
$this->functionData['globalTemplate'][$count_5d158096676df15c67782ca0abed77d1]['stats'] = $stats;
}
...
$IPBHTML .= "<!DOCTYPE html>
	...
	<head>
		...
		//<![CDATA[
			...
			USE_RTE			= " . (($this->memberData['members_editor_choice'] == 'rte') ? ("1") : ("0")) . ";
				...
				<div class='main_width'>
					...
					" . (($this->memberData['member_id']) ? ("<div id='user_navigation' class='logged_in'>
							<ul class='ipsList_inline right'>
								...
								<li><a id='user_link' class='' href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showuser={$this->memberData['member_id']}", "public",'' ), "{$this->memberData['members_seo_name']}", "showuser" ) . "\"  title='{$this->lang->words['your_profile']}'>{$this->memberData['members_display_name']} &nbsp;<span id='user_link_dd'></span></a></li>							
							...
							<ul class='ipsList_inline right'>
								<li>
									<span class='services'>
										...
										") : ("")) . "
										" . ((IPSLib::loginMethod_enabled('openid')) ? ("
											<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=global&amp;section=login&amp;serviceClick=openid", "public",'' ), "", "" ) . "'>" . $this->registry->getClass('output')->getReplacement("lim_openid") . "</a>
										") : ("")) . "
										" . ((IPSLib::loginMethod_enabled('live')) ? ("
											<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=global&amp;section=login&amp;serviceClick=live", "public",'' ), "", "" ) . "'>" . $this->registry->getClass('output')->getReplacement("lim_windows") . "</a>
										") : ("")) . "
									</span>
									&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<div id='primary_nav' class='clearfix'>
				<div class='main_width'>
					<ul class='ipsList_inline' id='community_app_menu'>
						...
						") : ("")) . "
<!-- JAUNS KODS PEC UPGRADE 3.4.5 - SAKUMS -->
...
") : ("" . ((is_array($header_items['applications']) AND count($header_items['applications'])) ? ("
		".$this->__f__d85c1cd2bfdb04c10021674dcfa258a0($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."	") : ("")) . "")) . "
<!-- JAUNS KODS PEC UPGRADE 3.4.5 - BEIGAS -->
			...
			<div id='content' class='clearfix'>
				...
				" . ((count( $items['navigation'] )) ? ("<div id='secondary_navigation' class='clearfix'>
						<ol class='breadcrumb top ipsList_inline left'>
								...
								" . (($this->did_first=1) ? ("") : ("")) . "") : ("")) . "
							".$this->__f__74c99d0f702bb26e01b7412115d5b144($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."						</ol>
					</div>
					<br />") : ("")) . "
				<!-- ::: CONTENT ::: -->
				{$items['adHeaderCode']}
				...
				<ol class='breadcrumb bottom ipsList_inline left clearfix clear'>
					" . ((count( $items['navigation'] )) ? ("						" . ((!$this->settings['remove_forums_nav'] OR ipsRegistry::$current_application == 'forums') ? ("<li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "act=idx", "public",'' ), "false", "" ) . "'>{$this->settings['board_name']}</a></li>
							" . (($this->did_first=1) ? ("") : ("")) . "") : ("")) . "
						".$this->__f__41d96fb75a1ecde2e5e262435c754047($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."") : ("
						<li>&nbsp;</li>
					")) . "
					" . (($this->settings['gl_show'] and $this->settings['gl_title']) ? ("<li class='right ipsType_smaller'>
							<a href='" . (($this->settings['gl_link']) ? ("{$this->settings['gl_link']}") : ("" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=extras&amp;section=boardrules", "public",'' ), "", "" ) . "")) . "'>" . (($this->settings['gl_title']) ? ("{$this->settings['gl_title']}") : ("{$this->lang->words['board_rules']}")) . "</a>
						</li>") : ("")) . "	
				</ol>
			</div>
			...
			<div id='footer_utilities' class='main_width clearfix clear'>
				...
				<ul class='ipsList_inline left'>
					...
					" . ((count($footer_items['skin_chooser']) > 1) ? ("" . (($this->memberData['userAgentLocked'] AND ! $this->memberData['userAgentBypass']) ? ("
							<li id='useragent_msg'>
						...
						") : ("" . (($this->registry->output->isTouchDevice()) ? ("
							<li>
								<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "{$this->settings['query_string_formatted']}&amp;setAsMobile=1", "public",'' ), "", "" ) . "'>{$this->lang->words['set_mobile_theme']}</a>
							</li>
						") : ("")) . "
							<li>
								<a rel=\"nofollow\" id='new_skin' href='#'>{$this->lang->words['change_theme']}</a>			
								<ul id='new_skin_menucontent' class='ipbmenu_content with_checks' style='display: none'>
									".$this->__f__feab530ea55607f477ff05bf081ceb57($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								</ul>
							</li>")) . "") : ("")) . "
					" . ((count( $footer_items['lang_chooser']['options'] ) > 1) ? ("
						<li>
							...
							<ul id='new_language_menucontent' class='ipbmenu_content with_checks' style='display: none'>
								".$this->__f__9461814f158f1f1964a5153b42814f0c($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."							</ul>
						</li>
					") : ("")) . "
					<li>
						...
						<ul id='mark_all_read_menucontent' class='ipbmenu_content' style='display: none'>
							".$this->__f__b350d8689153096979b7f82443c09fd2($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."							<li>
...
<!--<p align=\"center\"><a target=\"_blank\" href=\"https://www.vedejiem.lv/\"><img src=\"" . (($this->registry->output->isHTTPS) ? ("{$this->settings['board_url_https']}") : ("{$this->settings['board_url']}")) . "/xtra_baneris/vedejiem.lv-somina-kurpes.jpg\" border=\"0\" width=\"998px\" height=\"316px\" /></a></p>
<p>&nbsp;</p>-->
...
function __f__d85c1cd2bfdb04c10021674dcfa258a0($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__74c99d0f702bb26e01b7412115d5b144($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__41d96fb75a1ecde2e5e262435c754047($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $items['navigation'] as $idx => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
							<li>" . (($this->did_first) ? ("<span class='nav_sep'>" . $this->registry->getClass('output')->getReplacement("f_nav_sep") . "</span>") : ("")) . " " . (($data[1]) ? ("<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "{$data[1]}", "$data[4]",'' ), "$data[2]", "$data[3]" ) . "' title='{$this->lang->words['nav_return_to']} {$data[0]}'>") : ("")) . "{$data[0]}" . (($data[1]) ? ("</a>") : ("")) . "</li>
							" . (($this->did_first=1) ? ("") : ("")) . "
...
function __f__feab530ea55607f477ff05bf081ceb57($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $footer_items['skin_chooser'] as $skin )
	{
		...
		$_ips___x_retval .= "
										<li " . (($skin['selected']) ? ("class='selected'") : ("")) . ">
											<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "{$this->settings['query_string_formatted']}&amp;k={$this->member->form_hash}&amp;settingNewSkin={$skin['id']}", "public",'' ), "", "" ) . "'>{$skin['title']}</a>
										</li>
...
function __f__9461814f158f1f1964a5153b42814f0c($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b350d8689153096979b7f82443c09fd2($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
<h2 class='maintitle'>{$this->settings['gm_title']}</h2>
<div class='ipsBox'>
	<div class='ipsBox_container ipsPad_double'>
             <table>
                  " . (($this->settings['gm_image_url'] && $image = str_replace('%public_dir%', $this->settings['public_dir'], $this->settings['gm_image_url'])) ? ("
                       <td width='1%'><img src='{$image}' width='120px' height='120px' /></td>
                  ") : ("")) . "
                  <td class='ipsPad'>{$this->settings['gm_message']}</td>
             </table>
        </div>
...
{
$count_061ecf6c9116c265edcde5ae2a925728 = is_array($this->functionData['includeCSS']) ? count($this->functionData['includeCSS']) : 0;
$this->functionData['includeCSS'][$count_061ecf6c9116c265edcde5ae2a925728]['css'] = $css;
}

$this->minify = array();
$IPBHTML .= "" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
	".$this->__f__9c4bff88434f50cf21a43e184830926e($css)."	" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
...
" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
	".$this->__f__dcd095ddcdd2f0db76f1cc3160b7d68c($css)."") : ("")) . "
<!--[if lte IE 7]>
...
function __f__9c4bff88434f50cf21a43e184830926e($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__dcd095ddcdd2f0db76f1cc3160b7d68c($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c2b56da3cc5cf5165103056b29fc331f = is_array($this->functionData['includeFeeds']) ? count($this->functionData['includeFeeds']) : 0;
$this->functionData['includeFeeds'][$count_c2b56da3cc5cf5165103056b29fc331f]['documentHeadItems'] = $documentHeadItems;
}
$IPBHTML .= "" . ((count($documentHeadItems)) ? ("
	".$this->__f__00c96cbd07b6b2701af6f27e9ace908f($documentHeadItems)."") : ("")) . "";
return $IPBHTML;
}


function __f__35b65fe5cfe9ca4fb9ed554e6df7a941($documentHeadItems,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__00c96cbd07b6b2701af6f27e9ace908f($documentHeadItems)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__35b65fe5cfe9ca4fb9ed554e6df7a941($documentHeadItems,$type,$idx)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_7f0dffb184f73c8f8c0ea3c0b15f1036 = is_array($this->functionData['includeJS']) ? count($this->functionData['includeJS']) : 0;
$this->functionData['includeJS'][$count_7f0dffb184f73c8f8c0ea3c0b15f1036]['jsModules'] = $jsModules;
}
...
{
$count_c70599a7cbc5c4c641faf9f8d98d491f = is_array($this->functionData['includeMeta']) ? count($this->functionData['includeMeta']) : 0;
$this->functionData['includeMeta'][$count_c70599a7cbc5c4c641faf9f8d98d491f]['metaTags'] = $metaTags;
}
$IPBHTML .= "" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
	".$this->__f__9f00ae744a6b8519e96bb8fb6466a2be($metaTags)."") : ("")) . "
<meta property=\"og:image\" content=\"{$this->settings['meta_imagesrc']}\"/>";
return $IPBHTML;
}


function __f__a7e29ee1e5c518d53caf3b89f3d05e49($metaTags,$tag='',$id='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__9f00ae744a6b8519e96bb8fb6466a2be($metaTags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $metaTags as $tag => $id )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__a7e29ee1e5c518d53caf3b89f3d05e49($metaTags,$tag,$id)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_656c5bf67e4b8a26d3e2b777e30c3005 = is_array($this->functionData['includeRTL']) ? count($this->functionData['includeRTL']) : 0;
}

$this->isRtlLang	= false;
$IPBHTML .= "".$this->__f__cde98e505a60c248c42d653079901581()."" . (($this->isRtlLang AND is_file( DOC_IPS_ROOT_PATH . '/' . PUBLIC_DIRECTORY . '/style_css/' . $this->registry->output->skin['_csscacheid'] . '/ipb_rtl.css' )) ? ("
...
function __f__cde98e505a60c248c42d653079901581()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b5ce8e680717a78101555c6be1b82157 = is_array($this->functionData['includeVars']) ? count($this->functionData['includeVars']) : 0;
$this->functionData['includeVars'][$count_b5ce8e680717a78101555c6be1b82157]['header_items'] = $header_items;
}
...
{
$count_5d89077152feb9d1ad488e927e9fcb86 = is_array($this->functionData['inlineLogin']) ? count($this->functionData['inlineLogin']) : 0;
}
				...
				" . ((IPSLib::loginMethod_enabled('facebook') || IPSLib::loginMethod_enabled('twitter') || IPSLib::loginMethod_enabled('live')) ? ("<div class='ipsBox_notice'>
						<ul class='ipsList_inline'>
							...
							" . ((is_array($this->_formFields) AND count($this->_formFields)) ? ("
								".$this->__f__c4f9d34c87e8af8e31c4b08299cbb109()."							") : ("")) . "
						</ul>
					</div>") : ("")) . "
				<br />
...
function __f__c4f9d34c87e8af8e31c4b08299cbb109()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ca4725ff84b373a680d80dbf2c03fbf9 = is_array($this->functionData['liveEditJs']) ? count($this->functionData['liveEditJs']) : 0;
}
...
<div class='ipsBox ipsPad'>
	...
	<form action='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&module=global&section=meta&do=save", "public",'' ), "", "" ) . "' method='post'>
		...
		<table class='ipb_table'>
			".$this->__f__c4bad63b3b550023440607cedccaf45e($tags,$url)."		</table>
		</div>
		<table class='ipb_table'>
			<tr>
...
function __f__c4bad63b3b550023440607cedccaf45e($tags, $url)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tags as $k => $v )
...
{
$count_1e91815b41131206723d72b4a0130c8b = is_array($this->functionData['nextPreviousTemplate']) ? count($this->functionData['nextPreviousTemplate']) : 0;
$this->functionData['nextPreviousTemplate'][$count_1e91815b41131206723d72b4a0130c8b]['data'] = $data;
}
...
{
$count_aae6bc8b9320c403249fd9187e8dee7e = is_array($this->functionData['paginationTemplate']) ? count($this->functionData['paginationTemplate']) : 0;
$this->functionData['paginationTemplate'][$count_aae6bc8b9320c403249fd9187e8dee7e]['work'] = $work;
$this->functionData['paginationTemplate'][$count_aae6bc8b9320c403249fd9187e8dee7e]['data'] = $data;
}
$IPBHTML .= "" . (($work['pages'] > 1) ? ("<div class='pagination clearfix left " . ((!$data['showNumbers']) ? ("no_numbers") : ("")) . "'>
		...
		<ul class='ipsList_inline left pages'>
			...
			" . ((is_array( $work['_pageNumbers'] ) && count( $work['_pageNumbers'] )) ? ("
				".$this->__f__889c7ec1cc19c36ce6015c56a305a898($work,$data)."			") : ("")) . "
		</ul>
...
function __f__889c7ec1cc19c36ce6015c56a305a898($work, $data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1228e9377c42cd7e0205e42b6a25dfe5 = is_array($this->functionData['quickSearch']) ? count($this->functionData['quickSearch']) : 0;
}
		...
		<fieldset>
			...
			<span id='search_wrap' class='right'>
				...
				<ul id='search_options_menucontent' class='ipbmenu_content ipsPad' style='display: none'>
					...
					".$this->__f__10b1bbe5e392478da4f436ce18ce80dc()."				</ul>
...
function __f__10b1bbe5e392478da4f436ce18ce80dc()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_75294333cf0d4c3e951fb54c15d65e21 = is_array($this->functionData['shareLinks']) ? count($this->functionData['shareLinks']) : 0;
$this->functionData['shareLinks'][$count_75294333cf0d4c3e951fb54c15d65e21]['links'] = $links;
$this->functionData['shareLinks'][$count_75294333cf0d4c3e951fb54c15d65e21]['title'] = $title;
$this->functionData['shareLinks'][$count_75294333cf0d4c3e951fb54c15d65e21]['url'] = $url;
$this->functionData['shareLinks'][$count_75294333cf0d4c3e951fb54c15d65e21]['cssClass'] = $cssClass;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("sharelinks", "0" ) . "
" . ((is_array( $links )) ? ("
	<ul class='{$cssClass} shareButtons ipsList_inline'>
	".$this->__f__1c93178dc91a15957b543c87e7c0efc0($links,$title,$url,$cssClass)."	</ul>
	<script type=\"text/javascript\">
...
function __f__1c93178dc91a15957b543c87e7c0efc0($links, $title='', $url='', $cssClass='topic_share left')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_bc5aaf682e6c27a4be740a2e53a457f9 = is_array($this->functionData['signature_separator']) ? count($this->functionData['signature_separator']) : 0;
$this->functionData['signature_separator'][$count_bc5aaf682e6c27a4be740a2e53a457f9]['sig'] = $sig;
$this->functionData['signature_separator'][$count_bc5aaf682e6c27a4be740a2e53a457f9]['author_id'] = $author_id;
$this->functionData['signature_separator'][$count_bc5aaf682e6c27a4be740a2e53a457f9]['can_ignore'] = $can_ignore;
}
...
{
$count_248da139da1961ecc1aa3880fd4aa32f = is_array($this->functionData['userHoverCard']) ? count($this->functionData['userHoverCard']) : 0;
$this->functionData['userHoverCard'][$count_248da139da1961ecc1aa3880fd4aa32f]['member'] = $member;
}
...
{
$count_5582a007cf7471bfcea14e4086996dd4 = is_array($this->functionData['userInfoPane']) ? count($this->functionData['userInfoPane']) : 0;
$this->functionData['userInfoPane'][$count_5582a007cf7471bfcea14e4086996dd4]['author'] = $author;
$this->functionData['userInfoPane'][$count_5582a007cf7471bfcea14e4086996dd4]['contentid'] = $contentid;
$this->functionData['userInfoPane'][$count_5582a007cf7471bfcea14e4086996dd4]['options'] = $options;
}
$IPBHTML .= "<div itemscope itemtype=\"http://schema.org/Person\" class='user_details'>
	...
	" . (($author['custom_fields'] != "") ? ("
		<ul class='custom_fields'>
			".$this->__f__1ab49fae8555e12b4752abcf86bf0001($author,$contentid,$options)."		</ul>
...
function __f__09b7f2dc6c497fb6798265567ff80eb2($author, $contentid, $options,$group='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__1ab49fae8555e12b4752abcf86bf0001($author, $contentid, $options)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $author['custom_fields'] as $group => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__09b7f2dc6c497fb6798265567ff80eb2($author,$contentid,$options,$group,$data)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_6ed5ac0fd4412b57b2ffe19b2e0fd3fb = is_array($this->functionData['userSmallPhoto']) ? count($this->functionData['userSmallPhoto']) : 0;
$this->functionData['userSmallPhoto'][$count_6ed5ac0fd4412b57b2ffe19b2e0fd3fb]['member'] = $member;
}
...
{
$count_23269d7139cfedb39182e8ecb3f39409 = is_array($this->functionData['warnDetails']) ? count($this->functionData['warnDetails']) : 0;
$this->functionData['warnDetails'][$count_23269d7139cfedb39182e8ecb3f39409]['warning'] = $warning;
$this->functionData['warnDetails'][$count_23269d7139cfedb39182e8ecb3f39409]['canSeeModNote'] = $canSeeModNote;
}
...
<div class='ipsBox'>
	<p class='message unspecific'>
		...
		") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
				...
				")) . "") : ("")) . "
			".$this->__f__2558ca717d202134f67965cc3d11f4a3($warning,$canSeeModNote)."")) . "
	</p>
...
function __f__2558ca717d202134f67965cc3d11f4a3($warning, $canSeeModNote)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;

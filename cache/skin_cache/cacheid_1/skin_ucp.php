...
{
$count_fd5e156865390b2e8400ea75788ae1bf = is_array($this->functionData['coreAttachments']) ? count($this->functionData['coreAttachments']) : 0;
$this->functionData['coreAttachments'][$count_fd5e156865390b2e8400ea75788ae1bf]['info'] = $info;
$this->functionData['coreAttachments'][$count_fd5e156865390b2e8400ea75788ae1bf]['pages'] = $pages;
$this->functionData['coreAttachments'][$count_fd5e156865390b2e8400ea75788ae1bf]['attachments'] = $attachments;
}
...
<div class='row1'>	
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_user_attach']}\">
		<tr class='header'>
			...
			" . ((count($attachments)) ? ("
								".$this->__f__3f2bb6b4025e1183a79447a81072600b($info,$pages,$attachments)."			") : ("
				<tr>
...
function __f__3f2bb6b4025e1183a79447a81072600b($info="",$pages="",$attachments)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ae040aa9518cf3a2a3b3892cb79b50ff = is_array($this->functionData['displayNameForm']) ? count($this->functionData['displayNameForm']) : 0;
$this->functionData['displayNameForm'][$count_ae040aa9518cf3a2a3b3892cb79b50ff]['form'] = $form;
$this->functionData['displayNameForm'][$count_ae040aa9518cf3a2a3b3892cb79b50ff]['error'] = $error;
$this->functionData['displayNameForm'][$count_ae040aa9518cf3a2a3b3892cb79b50ff]['okmessage'] = $okmessage;
$this->functionData['displayNameForm'][$count_ae040aa9518cf3a2a3b3892cb79b50ff]['isFB'] = $isFB;
}
$IPBHTML .= "" . (($okmessage != "") ? ("
...
{
$count_9c95a020cdd89e6dd741c9b37244d447 = is_array($this->functionData['emailPasswordChangeForm']) ? count($this->functionData['emailPasswordChangeForm']) : 0;
$this->functionData['emailPasswordChangeForm'][$count_9c95a020cdd89e6dd741c9b37244d447]['txt'] = $txt;
$this->functionData['emailPasswordChangeForm'][$count_9c95a020cdd89e6dd741c9b37244d447]['_message'] = $_message;
$this->functionData['emailPasswordChangeForm'][$count_9c95a020cdd89e6dd741c9b37244d447]['isFB'] = $isFB;
}
...
{
$count_d7542e8269873b7c9d4a1532e603c18a = is_array($this->functionData['field_entry']) ? count($this->functionData['field_entry']) : 0;
$this->functionData['field_entry'][$count_d7542e8269873b7c9d4a1532e603c18a]['title'] = $title;
$this->functionData['field_entry'][$count_d7542e8269873b7c9d4a1532e603c18a]['desc'] = $desc;
$this->functionData['field_entry'][$count_d7542e8269873b7c9d4a1532e603c18a]['content'] = $content;
$this->functionData['field_entry'][$count_d7542e8269873b7c9d4a1532e603c18a]['id'] = $id;
}
...
{
$count_5db588469b033b38af7553d84c4d552f = is_array($this->functionData['membersFacebookConnect']) ? count($this->functionData['membersFacebookConnect']) : 0;
$this->functionData['membersFacebookConnect'][$count_5db588469b033b38af7553d84c4d552f]['fbuid'] = $fbuid;
$this->functionData['membersFacebookConnect'][$count_5db588469b033b38af7553d84c4d552f]['fbUserData'] = $fbUserData;
$this->functionData['membersFacebookConnect'][$count_5db588469b033b38af7553d84c4d552f]['linkedMemberData'] = $linkedMemberData;
$this->functionData['membersFacebookConnect'][$count_5db588469b033b38af7553d84c4d552f]['perms'] = $perms;
$this->functionData['membersFacebookConnect'][$count_5db588469b033b38af7553d84c4d552f]['missingPerms'] = $missingPerms;
}
...
{
$count_1d5617e06dfbc8ae62d3c3c77213c04d = is_array($this->functionData['membersIgnoredUsersForm']) ? count($this->functionData['membersIgnoredUsersForm']) : 0;
$this->functionData['membersIgnoredUsersForm'][$count_1d5617e06dfbc8ae62d3c3c77213c04d]['members'] = $members;
$this->functionData['membersIgnoredUsersForm'][$count_1d5617e06dfbc8ae62d3c3c77213c04d]['pagination'] = $pagination;
}
...
<table class='ipb_table' summary=\"{$this->lang->words['ucp_ignored_users']}\">
	<tr class='header'>
		...
		" . ((count( $members )) ? ("".$this->__f__10546853ed063db94de896e718e3f0d5($members,$pagination)."	") : ("<tr>
...
function __f__10546853ed063db94de896e718e3f0d5($members, $pagination)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_6a15a44f0bfadfaae23d1644d8e48d19 = is_array($this->functionData['membersProfileForm']) ? count($this->functionData['membersProfileForm']) : 0;
$this->functionData['membersProfileForm'][$count_6a15a44f0bfadfaae23d1644d8e48d19]['custom_fields'] = $custom_fields;
$this->functionData['membersProfileForm'][$count_6a15a44f0bfadfaae23d1644d8e48d19]['group_titles'] = $group_titles;
$this->functionData['membersProfileForm'][$count_6a15a44f0bfadfaae23d1644d8e48d19]['day'] = $day;
$this->functionData['membersProfileForm'][$count_6a15a44f0bfadfaae23d1644d8e48d19]['mon'] = $mon;
$this->functionData['membersProfileForm'][$count_6a15a44f0bfadfaae23d1644d8e48d19]['year'] = $year;
$this->functionData['membersProfileForm'][$count_6a15a44f0bfadfaae23d1644d8e48d19]['amEditor'] = $amEditor;
$this->functionData['membersProfileForm'][$count_6a15a44f0bfadfaae23d1644d8e48d19]['times'] = $times;
}
...
<div class='ipsSettings'>
		...
		<div>
			<ul class='ipsForm ipsForm_horizontal'>
				<li class='ipsField'>
					...
					".$this->__f__0289b1cdc50f80612674b00f76e801ac($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."					</select><br />
				...
				" . (($day AND $mon AND $year) ? ("
					...
					<ul>
						<li>
							...
							<select name=\"month\">&nbsp;
								".$this->__f__7ab6a1ed2b957dbb7bb160c2b20c7400($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."							</select>			
							<select name=\"day\">&nbsp;
								".$this->__f__de0b54a2cc695ad6689e2cf379744f31($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."							</select> 
							<select name=\"year\">&nbsp;
								".$this->__f__0916b12423549f9821402e77a8708696($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."							</select> <br />
	...
	" . ((count( $custom_fields )) ? ("".$this->__f__d00edf2b010aa745c2bf561373d7dc89($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."	") : ("")) . "
...
function __f__0289b1cdc50f80612674b00f76e801ac($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__7ab6a1ed2b957dbb7bb160c2b20c7400($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $mon as $m )
...
function __f__de0b54a2cc695ad6689e2cf379744f31($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $day as $d )
...
function __f__0916b12423549f9821402e77a8708696($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $year as $y )
...
function __f__dc57ec46fb45c16dd3ccfac27a72f7f6($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array(),$cgroup='',$cfields='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__d00edf2b010aa745c2bf561373d7dc89($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
			" . ((count( $cfields )) ? ("
				<fieldset class='ipsSettings_section'>
					...
					<div>
						<ul>
							".$this->__f__dc57ec46fb45c16dd3ccfac27a72f7f6($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times,$cgroup,$cfields)."						</ul>
					</div>
				</fieldset>
			") : ("")) . "
...
{
$count_510d27aa92c677fb7c66483c7d57ec63 = is_array($this->functionData['membersSignatureForm']) ? count($this->functionData['membersSignatureForm']) : 0;
$this->functionData['membersSignatureForm'][$count_510d27aa92c677fb7c66483c7d57ec63]['editor_html'] = $editor_html;
$this->functionData['membersSignatureForm'][$count_510d27aa92c677fb7c66483c7d57ec63]['sig_restrictions'] = $sig_restrictions;
$this->functionData['membersSignatureForm'][$count_510d27aa92c677fb7c66483c7d57ec63]['signature'] = $signature;
}
...
{
$count_25cf9cc452530a628efdf10adc4dbd5a = is_array($this->functionData['membersTwitterConnect']) ? count($this->functionData['membersTwitterConnect']) : 0;
$this->functionData['membersTwitterConnect'][$count_25cf9cc452530a628efdf10adc4dbd5a]['isConnected'] = $isConnected;
$this->functionData['membersTwitterConnect'][$count_25cf9cc452530a628efdf10adc4dbd5a]['twitterUser'] = $twitterUser;
}
...
{
$count_bbdf55f4b1f5d2385beda8c1f2de289b = is_array($this->functionData['notificationsForm']) ? count($this->functionData['notificationsForm']) : 0;
$this->functionData['notificationsForm'][$count_bbdf55f4b1f5d2385beda8c1f2de289b]['config'] = $config;
$this->functionData['notificationsForm'][$count_bbdf55f4b1f5d2385beda8c1f2de289b]['emailData'] = $emailData;
}
...
<fieldset class='row1'>
	<span class='desc'><strong>{$this->lang->words['notifications_info_acp']}</strong></span>
		...
		".$this->__f__773dbae4471589ae7bca0ef091828bd1($config,$emailData)."		".$this->__f__51ca1ee76d705b840bb62ec491d67e9f($config,$emailData)."	</table>
</fieldset>";
return $IPBHTML;
}


function __f__46a7121ee11c44edce94f12a349e95c5($config, $emailData,$groupKey='',$group='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__773dbae4471589ae7bca0ef091828bd1($config, $emailData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $this->notifyGroups as $groupKey => $group )
	{
		...
		$_ips___x_retval .= "
			...
			".$this->__f__46a7121ee11c44edce94f12a349e95c5($config,$emailData,$groupKey,$group)."							
...
function __f__51ca1ee76d705b840bb62ec491d67e9f($config, $emailData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_3ce92e361d086672b6fdfc6b0e92091f = is_array($this->functionData['notificationsLog']) ? count($this->functionData['notificationsLog']) : 0;
$this->functionData['notificationsLog'][$count_3ce92e361d086672b6fdfc6b0e92091f]['notifications'] = $notifications;
$this->functionData['notificationsLog'][$count_3ce92e361d086672b6fdfc6b0e92091f]['error'] = $error;
$this->functionData['notificationsLog'][$count_3ce92e361d086672b6fdfc6b0e92091f]['pages'] = $pages;
}
		...
		<table class='ipb_table' summary=\"{$this->lang->words['notifications_table_head']}\">
			<tr class='header hide'>
				...
				<th scope='col' align=\"center\" width=\"5%\" class='short'>&nbsp;</th>
						...
						".$this->__f__f3bb26cb760ef4bbfd1a2f628a24eaa8($notifications,$error,$pages)."		</table>
		<script type='text/javascript'>
...
function __f__f3bb26cb760ef4bbfd1a2f628a24eaa8($notifications, $error='', $pages='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
/* -- recent_topics --*/
function recent_topics($lista,$blocked) {
$IPBHTML = "";
$IPBHTML .= "<h2 class='ipsType_subtitle ipsSettings_pagetitle'>{$this->settings['topicosrecentes_title']}</h2>
<div class='ipsSettings'>
	<fieldset class='ipsSettings_section'>
		...
		<div>
			<ul>
				<li>
					<input type='checkbox' class='input_check' id='showtr' name=\"showtr\" value=\"1\"" . (($this->memberData['recenttopics_onoff']) ? (" checked=\"checked\"") : ("")) . "/> 
				...
				<li>
					<input type='checkbox' class='input_check' id='showdqtd' name=\"showdqtd\" value=\"1\"" . (($this->memberData['topicosrecentes_showdqtd']) ? (" checked=\"checked\"") : ("")) . "/> 
			...
			<ul class='ipsForm ipsForm_horizontal'>
				<li class='ipsField'>
					...
					<select name=\"qtd_topicos\" class='input_select' id='qtd_topicos'>
						<option value='1'  " . (($this->memberData['recenttopics_qtd'] == 1) ? (" selected=\"selected\"") : ("")) . ">1</option>
						<option value='2'  " . (($this->memberData['recenttopics_qtd'] == 2) ? (" selected=\"selected\"") : ("")) . ">2</option>
						<option value='3'  " . (($this->memberData['recenttopics_qtd'] == 3) ? (" selected=\"selected\"") : ("")) . ">3</option>
						<option value='4'  " . (($this->memberData['recenttopics_qtd'] == 4) ? (" selected=\"selected\"") : ("")) . ">4</option>
						<option value='5'  " . (($this->memberData['recenttopics_qtd'] == 5) ? (" selected=\"selected\"") : ("")) . ">5</option>
						<option value='6'  " . (($this->memberData['recenttopics_qtd'] == 6) ? (" selected=\"selected\"") : ("")) . ">6</option>
						<option value='7'  " . (($this->memberData['recenttopics_qtd'] == 7) ? (" selected=\"selected\"") : ("")) . ">7</option>
						<option value='8'  " . (($this->memberData['recenttopics_qtd'] == 8) ? (" selected=\"selected\"") : ("")) . ">8</option>
						<option value='9'  " . (($this->memberData['recenttopics_qtd'] == 9) ? (" selected=\"selected\"") : ("")) . ">9</option>
						<option value='10' " . (($this->memberData['recenttopics_qtd'] == 10) ? (" selected=\"selected\"") : ("")) . ">10</option>
					</select><br />
...
{
$count_c831ca0c65ea91bf928bc4aa41278b9a = is_array($this->functionData['userCPTemplate']) ? count($this->functionData['userCPTemplate']) : 0;
$this->functionData['userCPTemplate'][$count_c831ca0c65ea91bf928bc4aa41278b9a]['current_tab'] = $current_tab;
$this->functionData['userCPTemplate'][$count_c831ca0c65ea91bf928bc4aa41278b9a]['html'] = $html;
$this->functionData['userCPTemplate'][$count_c831ca0c65ea91bf928bc4aa41278b9a]['tabs'] = $tabs;
$this->functionData['userCPTemplate'][$count_c831ca0c65ea91bf928bc4aa41278b9a]['current_area'] = $current_area;
$this->functionData['userCPTemplate'][$count_c831ca0c65ea91bf928bc4aa41278b9a]['errors'] = $errors;
$this->functionData['userCPTemplate'][$count_c831ca0c65ea91bf928bc4aa41278b9a]['hide_form'] = $hide_form;
$this->functionData['userCPTemplate'][$count_c831ca0c65ea91bf928bc4aa41278b9a]['maxUpload'] = $maxUpload;
}
...
" . ((count($tabs) > 1) ? ("
	<div class='maintitle ipsFilterbar clearfix'>
		<ul class='ipsList_inline'>
			".$this->__f__79250409d90cc6e121c939f74590df95($current_tab,$html,$tabs,$current_area,$errors,$hide_form,$maxUpload)."		</ul>
	</div>
") : ("")) . "
<div class='ipsBox'>
	<div class='ipsLayout" . (($hasMoreTabs) ? (" ipsLayout_withleft ipsLayout_smallleft ipsVerticalTabbed") : ("")) . " clearfix usercp_body'>
		" . (($hasMoreTabs) ? ("
			<div class='ipsVerticalTabbed_tabs ipsLayout_left' id='usercp_tabs'>
				<ul>
					".$this->__f__b094a6664a984a814583e995877bd0c3($current_tab,$html,$tabs,$current_area,$errors,$hide_form,$maxUpload)."				</ul>
			</div>
		") : ("")) . "
		<div class='" . (($hasMoreTabs) ? ("ipsVerticalTabbed_content ") : ("")) . "ipsLayout_content ipsBox_container' id='usercp_content'>
			<div class='ipsPad'>
				" . ((is_array( $errors ) AND count( $errors )) ? ("
					<p class='message error'>
						".$this->__f__1d9a16920d42ea9e2696fea1d7623057($current_tab,$html,$tabs,$current_area,$errors,$hide_form,$maxUpload)."					</p>
					<br />
				") : ("")) . "
...
function __f__79250409d90cc6e121c939f74590df95($current_tab, $html, $tabs, $current_area, $errors=array(), $hide_form=0, $maxUpload=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b094a6664a984a814583e995877bd0c3($current_tab, $html, $tabs, $current_area, $errors=array(), $hide_form=0, $maxUpload=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__1d9a16920d42ea9e2696fea1d7623057($current_tab, $html, $tabs, $current_area, $errors=array(), $hide_form=0, $maxUpload=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;

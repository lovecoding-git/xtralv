...
{
$count_ffcc0d775547caadd63314049a7ee707 = is_array($this->functionData['ajaxNewUser']) ? count($this->functionData['ajaxNewUser']) : 0;
$this->functionData['ajaxNewUser'][$count_ffcc0d775547caadd63314049a7ee707]['data'] = $data;
}
...
{
$count_5855e72199fe7ead9e2ef5ae822c101d = is_array($this->functionData['chatRoom']) ? count($this->functionData['chatRoom']) : 0;
$this->functionData['chatRoom'][$count_5855e72199fe7ead9e2ef5ae822c101d]['options'] = $options;
$this->functionData['chatRoom'][$count_5855e72199fe7ead9e2ef5ae822c101d]['chatters'] = $chatters;
}
...
<script type='text/javascript'>
	...
	".$this->__f__87c89b2e0fc73934c72eeb13830d0aa9($options,$chatters)."	// Ignore private chats from..
	".$this->__f__104ae7b44ba48b043a4d83a8574c7181($options,$chatters)."	" . ((isset( $this->memberData['_ignoredUsers'] ) AND count( $this->memberData['_ignoredUsers'] )) ? ("
		".$this->__f__8a220fdef99504859795a6109b173b47($options,$chatters)."	") : ("")) . "
	
	// Badwords
	" . ((is_array($this->caches['badwords']) AND count($this->caches['badwords'])) ? ("
		".$this->__f__1743ef5531ebbeb5627613d95270457c($options,$chatters)."	") : ("")) . "
	
	// Groups
	".$this->__f__270f4206aa745fe32dcb600dc194e7d8($options,$chatters)."</script>
	...
	<div class='ipsBox_container ipsLayout_right ipsPostForm_sidebar'>
		...
		<div class='ipsPad' id='chatters-online-wrap'>
			<ul id='chatters-online'>
				".$this->__f__466b680cff345635ccff41e910582da0($options,$chatters)."			</ul>
		</div>
...
<div id='mod-menu-container'>
	".$this->__f__79dae1de672a285f68072c1c0ad87d7e($options,$chatters)."</div>
...
function __f__87c89b2e0fc73934c72eeb13830d0aa9($options=array(), $chatters=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__104ae7b44ba48b043a4d83a8574c7181($options=array(), $chatters=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $chatters as $data )
...
function __f__8a220fdef99504859795a6109b173b47($options=array(), $chatters=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__1743ef5531ebbeb5627613d95270457c($options=array(), $chatters=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__270f4206aa745fe32dcb600dc194e7d8($options=array(), $chatters=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__466b680cff345635ccff41e910582da0($options=array(), $chatters=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $chatters as $data )
...
function __f__79dae1de672a285f68072c1c0ad87d7e($options=array(), $chatters=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $chatters as $data )
...
{
$count_4320d12fc325e709b26a0bea9350c5d1 = is_array($this->functionData['chatRules']) ? count($this->functionData['chatRules']) : 0;
$this->functionData['chatRules'][$count_4320d12fc325e709b26a0bea9350c5d1]['rules'] = $rules;
}
...
{
$count_d969d426752c0c25f3bcf6012ce9f6bb = is_array($this->functionData['chatUnbanModcp']) ? count($this->functionData['chatUnbanModcp']) : 0;
$this->functionData['chatUnbanModcp'][$count_d969d426752c0c25f3bcf6012ce9f6bb]['member'] = $member;
}

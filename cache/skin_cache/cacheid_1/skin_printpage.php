...
{
$count_980a7e140a3cbf254a9d13e93fe3c501 = is_array($this->functionData['pp_end']) ? count($this->functionData['pp_end']) : 0;
}
$IPBHTML .= "<!--Copyright-->
...
{
$count_94d905b17c01b5eaf97c9a58f38abb6f = is_array($this->functionData['pp_postentry']) ? count($this->functionData['pp_postentry']) : 0;
$this->functionData['pp_postentry'][$count_94d905b17c01b5eaf97c9a58f38abb6f]['poster'] = $poster;
$this->functionData['pp_postentry'][$count_94d905b17c01b5eaf97c9a58f38abb6f]['entry'] = $entry;
}

...
{
$count_5f0d0f600f75b2afff50a84e3e09ce43 = is_array($this->functionData['bbCodeEvent']) ? count($this->functionData['bbCodeEvent']) : 0;
$this->functionData['bbCodeEvent'][$count_5f0d0f600f75b2afff50a84e3e09ce43]['event'] = $event;
$this->functionData['bbCodeEvent'][$count_5f0d0f600f75b2afff50a84e3e09ce43]['type'] = $type;
$this->functionData['bbCodeEvent'][$count_5f0d0f600f75b2afff50a84e3e09ce43]['ends'] = $ends;
}
...
{
$count_8ae71997f869a2748ff46b81b4716041 = is_array($this->functionData['boardIndexBirthdays']) ? count($this->functionData['boardIndexBirthdays']) : 0;
$this->functionData['boardIndexBirthdays'][$count_8ae71997f869a2748ff46b81b4716041]['birthdays'] = $birthdays;
$this->functionData['boardIndexBirthdays'][$count_8ae71997f869a2748ff46b81b4716041]['data'] = $data;
}
		...
		<div class='_sbcollapsable'>
			" . ((count( $birthdays )) ? ("
				<ul class='ipsList_withminiphoto'>
					".$this->__f__f17ead36c41b417a730e5ccdbf910190($birthdays,$data)."				</ul>
			") : ("
...
function __f__f17ead36c41b417a730e5ccdbf910190($birthdays, $data=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_52b81e3e08b3edb68c360119ff184f91 = is_array($this->functionData['boardIndexCalEvents']) ? count($this->functionData['boardIndexCalEvents']) : 0;
$this->functionData['boardIndexCalEvents'][$count_52b81e3e08b3edb68c360119ff184f91]['events'] = $events;
}
		...
		<div class='_sbcollapsable'>
			" . ((is_array( $events )) ? ("
				<ul itemscope itemtype=\"http://schema.org/Event\" class='ipsList_withminiphoto'>
					".$this->__f__5c66c96acfb8a0e04d070b7e986bfb7c($events)."				</ul>
			") : ("
...
function __f__5c66c96acfb8a0e04d070b7e986bfb7c($events)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a5f9e7abd3d13fa169e52546cd1315c9 = is_array($this->functionData['cal_date_cell']) ? count($this->functionData['cal_date_cell']) : 0;
$this->functionData['cal_date_cell'][$count_a5f9e7abd3d13fa169e52546cd1315c9]['day'] = $day;
$this->functionData['cal_date_cell'][$count_a5f9e7abd3d13fa169e52546cd1315c9]['events'] = $events;
$this->functionData['cal_date_cell'][$count_a5f9e7abd3d13fa169e52546cd1315c9]['cal_date_queued'] = $cal_date_queued;
$this->functionData['cal_date_cell'][$count_a5f9e7abd3d13fa169e52546cd1315c9]['queued'] = $queued;
$this->functionData['cal_date_cell'][$count_a5f9e7abd3d13fa169e52546cd1315c9]['js_id'] = $js_id;
}
$IPBHTML .= "<!--Day-->
...
{
$count_f032624248447ee2873fc3593d27212c = is_array($this->functionData['cal_date_cell_today']) ? count($this->functionData['cal_date_cell_today']) : 0;
$this->functionData['cal_date_cell_today'][$count_f032624248447ee2873fc3593d27212c]['day'] = $day;
$this->functionData['cal_date_cell_today'][$count_f032624248447ee2873fc3593d27212c]['events'] = $events;
$this->functionData['cal_date_cell_today'][$count_f032624248447ee2873fc3593d27212c]['cal_date_queued'] = $cal_date_queued;
$this->functionData['cal_date_cell_today'][$count_f032624248447ee2873fc3593d27212c]['queued'] = $queued;
$this->functionData['cal_date_cell_today'][$count_f032624248447ee2873fc3593d27212c]['js_id'] = $js_id;
}
$IPBHTML .= "<!--Day-->
...
{
$count_fde6af573cdd3507c8d045093ffba066 = is_array($this->functionData['cal_week_dayentry']) ? count($this->functionData['cal_week_dayentry']) : 0;
$this->functionData['cal_week_dayentry'][$count_fde6af573cdd3507c8d045093ffba066]['wday'] = $wday;
$this->functionData['cal_week_dayentry'][$count_fde6af573cdd3507c8d045093ffba066]['date'] = $date;
$this->functionData['cal_week_dayentry'][$count_fde6af573cdd3507c8d045093ffba066]['month'] = $month;
$this->functionData['cal_week_dayentry'][$count_fde6af573cdd3507c8d045093ffba066]['mid'] = $mid;
$this->functionData['cal_week_dayentry'][$count_fde6af573cdd3507c8d045093ffba066]['year'] = $year;
$this->functionData['cal_week_dayentry'][$count_fde6af573cdd3507c8d045093ffba066]['events'] = $events;
$this->functionData['cal_week_dayentry'][$count_fde6af573cdd3507c8d045093ffba066]['queued'] = $queued;
}
...
{
$count_3ba65fde547a6c9e77b78448056ad03d = is_array($this->functionData['calendar_likeSummaryContents']) ? count($this->functionData['calendar_likeSummaryContents']) : 0;
$this->functionData['calendar_likeSummaryContents'][$count_3ba65fde547a6c9e77b78448056ad03d]['data'] = $data;
$this->functionData['calendar_likeSummaryContents'][$count_3ba65fde547a6c9e77b78448056ad03d]['relId'] = $relId;
$this->functionData['calendar_likeSummaryContents'][$count_3ba65fde547a6c9e77b78448056ad03d]['opts'] = $opts;
}
...
{
$count_3fdd1df479ac1c3f0cf9088b8d2d8a2f = is_array($this->functionData['calendarBirthdayList']) ? count($this->functionData['calendarBirthdayList']) : 0;
$this->functionData['calendarBirthdayList'][$count_3fdd1df479ac1c3f0cf9088b8d2d8a2f]['rows'] = $rows;
}
$IPBHTML .= "<h2 class='ipsType_subtitle'>{$this->lang->words['celebrating_bday']}</h2>
<br />
" . ((is_array( $rows ) and count( $rows )) ? ("
	".$this->__f__61d13e2a216b2cc473dbe04aab77b727($rows)."") : ("
	<br />
...
function __f__61d13e2a216b2cc473dbe04aab77b727($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e67814325d323b6c0c82194a54c45cd6 = is_array($this->functionData['calendarEventForm']) ? count($this->functionData['calendarEventForm']) : 0;
$this->functionData['calendarEventForm'][$count_e67814325d323b6c0c82194a54c45cd6]['data'] = $data;
}
...
{
$count_f58a5b892e628bacff0100b26ecdfee6 = is_array($this->functionData['calendarEventsList']) ? count($this->functionData['calendarEventsList']) : 0;
$this->functionData['calendarEventsList'][$count_f58a5b892e628bacff0100b26ecdfee6]['data'] = $data;
}
...
{
$count_ef386b08dea8a74f4b584ddab6ce289b = is_array($this->functionData['calendarJump']) ? count($this->functionData['calendarJump']) : 0;
$this->functionData['calendarJump'][$count_ef386b08dea8a74f4b584ddab6ce289b]['calendars'] = $calendars;
$this->functionData['calendarJump'][$count_ef386b08dea8a74f4b584ddab6ce289b]['calendar'] = $calendar;
$this->functionData['calendarJump'][$count_ef386b08dea8a74f4b584ddab6ce289b]['chosen_date'] = $chosen_date;
}
$IPBHTML .= "" . ((is_array( $calendars ) && count( $calendars ) > 1) ? ("
	...
	<ul class='ipbmenu_content' style='display: none' id='calendar_chooser_menucontent'>
		".$this->__f__07e200a98a94f1afd2469e8deb5aa255($calendars,$calendar,$chosen_date)."	</ul>
	<script type='text/javascript'>
...
function __f__07e200a98a94f1afd2469e8deb5aa255($calendars, $calendar, $chosen_date=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_00c04c9e2b4f7b70298dd4b5d0084596 = is_array($this->functionData['calendarMainContent']) ? count($this->functionData['calendarMainContent']) : 0;
$this->functionData['calendarMainContent'][$count_00c04c9e2b4f7b70298dd4b5d0084596]['data'] = $data;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("calendar", "0" ) . "
<script type='text/javascript'>
	ipb.vars['month_url'] = \"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&module=calendar&section=view&cal_id={$data['calendar']['cal_id']}", "public",'' ), "", "" ) . "\";
...
<div class='ipsBox'>
	<div class='ipsBox_container'>
		<table id='calendar_table' class='ipsCalendar ipb_table vcalendar' summary=\"{$this->lang->words['calendar_for']} {$data['month_title']} {$data['chosen_date']['year']}\">
			<tr class='header'>
				".$this->__f__4fe7fdac529e5814c899b0f6818e67b5($data)."				{$data['events']}
			</tr>
		</table>
	</div>
</div>
...
function __f__4fe7fdac529e5814c899b0f6818e67b5($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c1299f9bc0fbfb778b414dcf428919fe = is_array($this->functionData['calendarWeekView']) ? count($this->functionData['calendarWeekView']) : 0;
$this->functionData['calendarWeekView'][$count_c1299f9bc0fbfb778b414dcf428919fe]['data'] = $data;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("calendar", "0" ) . "
<script type='text/javascript'>
	ipb.vars['month_url'] = \"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&module=calendar&section=view&cal_id={$data['calendar']['cal_id']}", "public",'' ), "", "" ) . "\";
...
{
$count_97b9b8e840df38bf824d2609512f240d = is_array($this->functionData['calEventFollowedWrapper']) ? count($this->functionData['calEventFollowedWrapper']) : 0;
$this->functionData['calEventFollowedWrapper'][$count_97b9b8e840df38bf824d2609512f240d]['rows'] = $rows;
}
...
$IPBHTML .= "<div id='search_results'>
	<ol>
		" . ((is_array($rows) && count($rows)) ? ("
			".$this->__f__d259c84cbbba29c23f8a82c5627c6886($rows)."		") : ("")) . "
	</ol>
</div>";
return $IPBHTML;
}
...
function __f__d259c84cbbba29c23f8a82c5627c6886($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_408c33937acf0c34f4f4095a07d83b1b = is_array($this->functionData['calEventSearchResult']) ? count($this->functionData['calEventSearchResult']) : 0;
$this->functionData['calEventSearchResult'][$count_408c33937acf0c34f4f4095a07d83b1b]['r'] = $r;
$this->functionData['calEventSearchResult'][$count_408c33937acf0c34f4f4095a07d83b1b]['resultAsTitle'] = $resultAsTitle;
$this->functionData['calEventSearchResult'][$count_408c33937acf0c34f4f4095a07d83b1b]['type'] = $type;
$this->functionData['calEventSearchResult'][$count_408c33937acf0c34f4f4095a07d83b1b]['ends'] = $ends;
}
...
{
$count_a260e1a21d6baf76191346aa55543be8 = is_array($this->functionData['event_likeSummaryContents']) ? count($this->functionData['event_likeSummaryContents']) : 0;
$this->functionData['event_likeSummaryContents'][$count_a260e1a21d6baf76191346aa55543be8]['data'] = $data;
$this->functionData['event_likeSummaryContents'][$count_a260e1a21d6baf76191346aa55543be8]['relId'] = $relId;
$this->functionData['event_likeSummaryContents'][$count_a260e1a21d6baf76191346aa55543be8]['opts'] = $opts;
}
$IPBHTML .= "<span class='ipsButton_extra right " . (($data['totalCount']) ? ("_fmore clickable") : ("")) . "' title='" . sprintf( $this->lang->words['like_totalcount_' . $data['vernacular'] ], $data['totalCount'] ) . "' data-tooltip=\"" . sprintf( $this->lang->words['like_totalcount_' . $data['vernacular'] ], $data['totalCount'] ) . "\"><img src='{$this->settings['img_url']}/icon_users.png' /> <strong>{$data['totalCount']}</strong></span>
" . (($this->memberData['member_id']) ? ("<a href='#' title=\"" . (($data['iLike']) ? ("" . sprintf( $this->lang->words['fave_tt_on'], $this->lang->words['like_ucfirst_un' . $data['vernacular'] ]) . "") : ("" . sprintf( $this->lang->words['fave_tt_off'], $this->lang->words['like_ucfirst_' . $data['vernacular'] ]) . "")) . "\" class='ftoggle ipsButton_secondary'>" . (($data['iLike']) ? ("" . sprintf( $this->lang->words['unset_fave_button'], $this->lang->words['like_ucfirst_un' . $data['vernacular'] ]) . "") : ("" . sprintf( $this->lang->words['set_fave_button'], $this->lang->words['like_ucfirst_' . $data['vernacular'] ]) . "")) . "</a>") : ("")) . "";
return $IPBHTML;
...
{
$count_37892dd85c53dc935fb6c567a4857fad = is_array($this->functionData['eventAttendee']) ? count($this->functionData['eventAttendee']) : 0;
$this->functionData['eventAttendee'][$count_37892dd85c53dc935fb6c567a4857fad]['member'] = $member;
$this->functionData['eventAttendee'][$count_37892dd85c53dc935fb6c567a4857fad]['event'] = $event;
}
...
{
$count_9cf9387a7075926d462cf51368a586ad = is_array($this->functionData['followedContentCalendars']) ? count($this->functionData['followedContentCalendars']) : 0;
$this->functionData['followedContentCalendars'][$count_9cf9387a7075926d462cf51368a586ad]['rows'] = $rows;
}
$IPBHTML .= "<div id='search_results'>
	<ol>
		".$this->__f__54a86d81935f5184ab71a72fb629537c($rows)."	</ol>
</div>";
return $IPBHTML;
}


function __f__54a86d81935f5184ab71a72fb629537c($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $r )
...
{
$count_fde948eda33a901bdff0c7bceec76640 = is_array($this->functionData['mini_cal_date_cell']) ? count($this->functionData['mini_cal_date_cell']) : 0;
$this->functionData['mini_cal_date_cell'][$count_fde948eda33a901bdff0c7bceec76640]['day'] = $day;
}
$IPBHTML .= "<td>
...
{
$count_abf3d36dda81e09190eb5ea9003b8967 = is_array($this->functionData['mini_cal_date_cell_today']) ? count($this->functionData['mini_cal_date_cell_today']) : 0;
$this->functionData['mini_cal_date_cell_today'][$count_abf3d36dda81e09190eb5ea9003b8967]['day'] = $day;
}
...
{
$count_732b57da8e5a81d6250f68fcbafc8e24 = is_array($this->functionData['miniCalendarWrapper']) ? count($this->functionData['miniCalendarWrapper']) : 0;
$this->functionData['miniCalendarWrapper'][$count_732b57da8e5a81d6250f68fcbafc8e24]['data'] = $data;
}
$IPBHTML .= "<div class='mini_cal_wrap ipsBox'>
	<div class='ipsBox_container'>
		...
		<table class='mini_cal vcalendar'>
			<tr>
				".$this->__f__74de5c6aff80b1d32a3cb2bedc23cc85($data)."			
				{$data['events']}
			</tr>
		</table>
	</div>
...
function __f__74de5c6aff80b1d32a3cb2bedc23cc85($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data['day_words'] as $day )
...
{
$count_3f5bb0674ebf6dbe6904d9f631d288dc = is_array($this->functionData['modEventsWrapper']) ? count($this->functionData['modEventsWrapper']) : 0;
$this->functionData['modEventsWrapper'][$count_3f5bb0674ebf6dbe6904d9f631d288dc]['events'] = $events;
$this->functionData['modEventsWrapper'][$count_3f5bb0674ebf6dbe6904d9f631d288dc]['pages'] = $pages;
}
...
<div class='clearfix'>
	" . ((count($events)) ? ("
		".$this->__f__02e0038a022a9536e68a3273f36b8017($events,$pages)."	") : ("
...
function __f__02e0038a022a9536e68a3273f36b8017($events, $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $events as $event )
...
{
$count_dc2f8f70e781c3897e8b1cf96e8023e9 = is_array($this->functionData['showEvent']) ? count($this->functionData['showEvent']) : 0;
$this->functionData['showEvent'][$count_dc2f8f70e781c3897e8b1cf96e8023e9]['event'] = $event;
$this->functionData['showEvent'][$count_dc2f8f70e781c3897e8b1cf96e8023e9]['member'] = $member;
$this->functionData['showEvent'][$count_dc2f8f70e781c3897e8b1cf96e8023e9]['typeInfo'] = $typeInfo;
$this->functionData['showEvent'][$count_dc2f8f70e781c3897e8b1cf96e8023e9]['like'] = $like;
}
	...
	" . (($event['event_rsvp']) ? ("<div class='ipsBox_container ipsLayout_right'>
			<div id='event_rsvp' class='ipsPad'>
				...
				" . ((count($event['_rsvp_attendees_short'])) ? ("
					...
					".$this->__f__4592b5a558dfd5e82798bf105637abcc($event,$member,$typeInfo,$like)."					</ul>
				") : ("
		...
		" . (($event['_rsvp_count'] > count( $event['_rsvp_attendees_short'] )) ? ("
			<div id='see_all_attendees_popup' style='display: none'>
				...
				<div class='fixed_inner'>
					...
					".$this->__f__5b08746362f3e1431330fe38c8cfa522($event,$member,$typeInfo,$like)."					</ul>
				</div>
			</div>
			<script type='text/javascript'>
...
function __f__4592b5a558dfd5e82798bf105637abcc($event, $member, $typeInfo, $like='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5b08746362f3e1431330fe38c8cfa522($event, $member, $typeInfo, $like='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_6df6b3dc82a639d34cc229b0da013f39 = is_array($this->functionData['showEventSimple']) ? count($this->functionData['showEventSimple']) : 0;
$this->functionData['showEventSimple'][$count_6df6b3dc82a639d34cc229b0da013f39]['event'] = $event;
}
		...
		<div class='post_body'>
			...
			" . (($event['event_rsvp']) ? ("<div class='rsvp'>
					" . ((count( $event['_rsvp_attendees'] )) ? ("
						...
						<div class='clearfix'>
							".$this->__f__9c6114c31ea8813db06e3ca4a558ca12($event)."						</div>
					") : ("
...
function __f__9c6114c31ea8813db06e3ca4a558ca12($event)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;

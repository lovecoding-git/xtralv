...
{
$count_1713e6d68f864f25eb99c39bb14c368d = is_array($this->functionData['ajaxSharePost']) ? count($this->functionData['ajaxSharePost']) : 0;
$this->functionData['ajaxSharePost'][$count_1713e6d68f864f25eb99c39bb14c368d]['topic'] = $topic;
$this->functionData['ajaxSharePost'][$count_1713e6d68f864f25eb99c39bb14c368d]['post'] = $post;
$this->functionData['ajaxSharePost'][$count_1713e6d68f864f25eb99c39bb14c368d]['url'] = $url;
$this->functionData['ajaxSharePost'][$count_1713e6d68f864f25eb99c39bb14c368d]['sharelinks'] = $sharelinks;
}
...
{
$count_e1db035ca92066b3d14bcab6d7c4d13a = is_array($this->functionData['announcement_show']) ? count($this->functionData['announcement_show']) : 0;
$this->functionData['announcement_show'][$count_e1db035ca92066b3d14bcab6d7c4d13a]['announce'] = $announce;
$this->functionData['announcement_show'][$count_e1db035ca92066b3d14bcab6d7c4d13a]['author'] = $author;
}
...
{
$count_4aefb611e8f80bc5c33a134676637dce = is_array($this->functionData['archiveStatusMessage']) ? count($this->functionData['archiveStatusMessage']) : 0;
$this->functionData['archiveStatusMessage'][$count_4aefb611e8f80bc5c33a134676637dce]['topic'] = $topic;
$this->functionData['archiveStatusMessage'][$count_4aefb611e8f80bc5c33a134676637dce]['forum'] = $forum;
}
...
{
$count_0cea6469772e3ed7c9f49e2d1d348209 = is_array($this->functionData['hookdp3similarTopics']) ? count($this->functionData['hookdp3similarTopics']) : 0;
$this->functionData['hookdp3similarTopics'][$count_0cea6469772e3ed7c9f49e2d1d348209]['topics_data'] = $topics_data;
$this->functionData['hookdp3similarTopics'][$count_0cea6469772e3ed7c9f49e2d1d348209]['toggle'] = $toggle;
}
...
<div class='ipsBox'>
	<div class='ipsBox_container'>
			...
			<!-- BEGIN TOPICS -->
			" . ((is_array( $topics_data ) AND count( $topics_data )) ? ("".$this->__f__13c2313f994195dbfb3943a2e492667a($topics_data,$toggle)."			") : ("")) . "	
		</table>
	</div>
</div>
</div>";
...
function __f__18a2d0eb419763ca12011ae75a24f995($topics_data, $toggle,$tid='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__13c2313f994195dbfb3943a2e492667a($topics_data, $toggle)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
					...
					") : ("<tr class='" .  IPSLib::next( $this->registry->templateStriping["forumTable"] ) . " __topic " . ((!$data['folder_img']['is_read']) ? ("unread") : ("")) . " expandable' id='trow_{$data['tid']}' data-tid=\"{$data['tid']}\">")) . "					
						...
						<td>
							...
							" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
								...
								".$this->__f__18a2d0eb419763ca12011ae75a24f995($topics_data,$toggle,$tid,$data)."								</ul>
							") : ("")) . "
...
{
$count_fed01d61e70c3259ca5d0eac78f29d19 = is_array($this->functionData['hookFacebookLike']) ? count($this->functionData['hookFacebookLike']) : 0;
}
...
{
$count_3baef987435576cecd2e197b56608eb0 = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_3baef987435576cecd2e197b56608eb0]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_3baef987435576cecd2e197b56608eb0]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_3baef987435576cecd2e197b56608eb0]['opts'] = $opts;
}
...
{
$count_552db66dada6f08abd3338ce128f8662 = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_552db66dada6f08abd3338ce128f8662]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_552db66dada6f08abd3338ce128f8662]['topicData'] = $topicData;
$this->functionData['pollDisplay'][$count_552db66dada6f08abd3338ce128f8662]['forumData'] = $forumData;
$this->functionData['pollDisplay'][$count_552db66dada6f08abd3338ce128f8662]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_552db66dada6f08abd3338ce128f8662]['showResults'] = $showResults;
$this->functionData['pollDisplay'][$count_552db66dada6f08abd3338ce128f8662]['editPoll'] = $editPoll;
}
$IPBHTML .= "<script type='text/javascript'>
//<![CDATA[
...
<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=extras&amp;section=vote&amp;t={$topicData['tid']}&amp;page={$this->request['page']}&amp;do=add&amp;secure_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" name='pollForm' method=\"post\">
		...
		") : ("")) . "
		".$this->__f__ae76d740b80cf6180df515edcec54709($poll,$topicData,$forumData,$pollData,$showResults,$editPoll)."		<fieldset class='submit'>
...
function __f__bef0f25680e02684430cdc2c875ac481($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='',$choiceID='',$choiceData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__aa946d35054d804c909c57da23084839($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
							...
							" . (($showResults) ? ("<li>
									...
									" . (($poll['poll_view_voters'] AND is_array( $choiceData['voters'] ) AND $this->settings['poll_allow_public'] AND $choiceData['votes']) ? ("
										<script type='text/javascript'>
											...
											".$this->__f__bef0f25680e02684430cdc2c875ac481($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData,$choiceID,$choiceData)."											ipb.topic.poll[ $questionID ][ $choiceID ] = { name: \"{$choiceData['choice']}\", users: users};
										</script>
									") : ("")) . "
...
function __f__ae76d740b80cf6180df515edcec54709($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='poll_question" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__aa946d35054d804c909c57da23084839($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_058478e5d6855e8daf524194612adeca = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_058478e5d6855e8daf524194612adeca]['post'] = $post;
$this->functionData['post'][$count_058478e5d6855e8daf524194612adeca]['displayData'] = $displayData;
$this->functionData['post'][$count_058478e5d6855e8daf524194612adeca]['topic'] = $topic;
$this->functionData['post'][$count_058478e5d6855e8daf524194612adeca]['forum'] = $forum;
}
...
{
$count_f780231862922ec7078abfce3cdf55dc = is_array($this->functionData['quickEditPost']) ? count($this->functionData['quickEditPost']) : 0;
$this->functionData['quickEditPost'][$count_f780231862922ec7078abfce3cdf55dc]['post'] = $post;
}
$IPBHTML .= "{$post['post']}
    {$post['attachmentHtml']}
	<br />
...
{
$count_68a6f06adf3c79e8b0291e5cde772df8 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_68a6f06adf3c79e8b0291e5cde772df8]['title'] = $title;
$this->functionData['show_attachment_title'][$count_68a6f06adf3c79e8b0291e5cde772df8]['data'] = $data;
$this->functionData['show_attachment_title'][$count_68a6f06adf3c79e8b0291e5cde772df8]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__ba3cb9b0fca63a8c5d13531b79ffc440($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__ba3cb9b0fca63a8c5d13531b79ffc440($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_98d593119e5e22bdbc0aa1591cd58d36 = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_98d593119e5e22bdbc0aa1591cd58d36]['data'] = $data;
}
...
{
$count_27bdad07977abb5ab6d741a8773ac632 = is_array($this->functionData['softDeletedPostBit']) ? count($this->functionData['softDeletedPostBit']) : 0;
$this->functionData['softDeletedPostBit'][$count_27bdad07977abb5ab6d741a8773ac632]['post'] = $post;
$this->functionData['softDeletedPostBit'][$count_27bdad07977abb5ab6d741a8773ac632]['sdData'] = $sdData;
$this->functionData['softDeletedPostBit'][$count_27bdad07977abb5ab6d741a8773ac632]['topic'] = $topic;
}
...
<div id='topic_led_by' class='active_users' style=\"margin-top: 50px;\">
	...
	<ul class='ipsList_inline'>
		".$this->__f__673a49b62eaab79fd7a8d8f6a804141b($mods)."";
return $IPBHTML;
}


function __f__673a49b62eaab79fd7a8d8f6a804141b($mods=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $mods as $p => $r )
...
$IPBHTML .= "<div id='topic_stats' class='statistics clear clearfix'>
	<div id='topic_active_users' class='active_users'>
		<h4 class='statistics_head'>{$this->lang->words['topic_led_by']}</h4>
		<ul class='ipsList_inline'>
			".$this->__f__5dae218c6e5ddcc1218d60a331a14ada($mods)."		</ul>
	</div>
</div>";
return $IPBHTML;
}
...
function __f__5dae218c6e5ddcc1218d60a331a14ada($mods=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $mods as $p => $r )
...
$IPBHTML = "";
$IPBHTML .= "".$this->__f__99133a64f0e2fb5b590a73ede72989f4($topic,$posts)."<br class='clear' />
...
function __f__99133a64f0e2fb5b590a73ede72989f4($topic, $posts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_52fc1b6cb7d4bbadfe9f993cb6f6fa3b = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_52fc1b6cb7d4bbadfe9f993cb6f6fa3b]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_52fc1b6cb7d4bbadfe9f993cb6f6fa3b]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_52fc1b6cb7d4bbadfe9f993cb6f6fa3b]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_52fc1b6cb7d4bbadfe9f993cb6f6fa3b]['displayData'] = $displayData;
}
...
" . (($displayData['mod_links'] AND ( $this->memberData['is_mod'] OR $this->memberData['member_id'] == $topic['starter_id'] )) ? ("<ul class='ipbmenu_content' id='topic_mod_options_menucontent'  style='display:none'>
	".$this->__f__34634c2b3f2b00b789a6e8477477492d($forum,$topic,$post_data,$displayData)."	" . (($topic['topic_queuedposts'] AND $this->registry->class_forums->canQueuePosts( $forum['id'] )) ? ("
	...
	" . ((is_array( $displayData['multi_mod'] ) AND count( $displayData['multi_mod'] )) ? ("
		".$this->__f__e9557e27f7987e74967b1c43c2a6fca0($forum,$topic,$post_data,$displayData)."	") : ("")) . "
</ul>
<script type='text/javascript'>
...
" . (($this->settings['reputation_enabled'] && $this->settings['reputation_point_types'] != 'like' && $this->settings['reputation_show_content'] && $this->memberData['member_id'] != 0 && is_array($this->caches['reputation_levels'])) ? ("<ul id='rep_filter_menucontent' class='ipbmenu_content with_checks' style='display: none'>
		...
		" . ((is_array($this->caches['reputation_levels'])) ? ("
			".$this->__f__a7e91decba1bacad0b21412c8585bb6a($forum,$topic,$post_data,$displayData)."		") : ("")) . "
	</ul>
	<script type='text/javascript'>
...
" . ((is_array( $post_data ) AND count( $post_data )) ? ("
	<div class='ipsBox'>
		<div class='ipsBox_container' id='ips_Posts'>
			".$this->__f__6e38143893d3b4631adfe16550179195($forum,$topic,$post_data,$displayData)."		</div>
	</div>
") : ("")) . "
<hr />
...
" . ((is_array( $displayData['same_tagged'] ) and count( $displayData['same_tagged'] )) ? ("
	...
	<div class='ipsBox'>
		...
		<div class='ipsBox_container'>
			...
			".$this->__f__34f98ab88974d80016ed8bbfcbe4e9ca($forum,$topic,$post_data,$displayData)."			</table>
		</div>
	</div>
") : ("")) . "
<!-- ACTIVE USERS -->
...
function __f__34634c2b3f2b00b789a6e8477477492d($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e9557e27f7987e74967b1c43c2a6fca0($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a7e91decba1bacad0b21412c8585bb6a($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__6e38143893d3b4631adfe16550179195($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__34f98ab88974d80016ed8bbfcbe4e9ca($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;

...
{
$count_5e7f1adca1263d90982112ebe3fea52c = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_5e7f1adca1263d90982112ebe3fea52c]['r'] = $r;
$this->functionData['comment'][$count_5e7f1adca1263d90982112ebe3fea52c]['parent'] = $parent;
$this->functionData['comment'][$count_5e7f1adca1263d90982112ebe3fea52c]['settings'] = $settings;
}
...
{
$count_cada7dcee354c113f43cf5921bbaa6e5 = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_cada7dcee354c113f43cf5921bbaa6e5]['r'] = $r;
$this->functionData['commentHidden'][$count_cada7dcee354c113f43cf5921bbaa6e5]['parent'] = $parent;
$this->functionData['commentHidden'][$count_cada7dcee354c113f43cf5921bbaa6e5]['settings'] = $settings;
}
...
{
$count_55ac90fb046d4d02cae7720db28ed99f = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_55ac90fb046d4d02cae7720db28ed99f]['comments'] = $comments;
$this->functionData['commentsList'][$count_55ac90fb046d4d02cae7720db28ed99f]['settings'] = $settings;
$this->functionData['commentsList'][$count_55ac90fb046d4d02cae7720db28ed99f]['pages'] = $pages;
$this->functionData['commentsList'][$count_55ac90fb046d4d02cae7720db28ed99f]['parent'] = $parent;
$this->functionData['commentsList'][$count_55ac90fb046d4d02cae7720db28ed99f]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__16bf048d32297f4ea400bc1ecb601017($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($pages) ? ("
	<div class='topic_controls'>
		{$pages}
	</div>
...
function __f__16bf048d32297f4ea400bc1ecb601017($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_00ab071546bbde50eb11130c29179e9f = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_00ab071546bbde50eb11130c29179e9f]['comment'] = $comment;
$this->functionData['form'][$count_00ab071546bbde50eb11130c29179e9f]['parent'] = $parent;
$this->functionData['form'][$count_00ab071546bbde50eb11130c29179e9f]['editor'] = $editor;
$this->functionData['form'][$count_00ab071546bbde50eb11130c29179e9f]['settings'] = $settings;
$this->functionData['form'][$count_00ab071546bbde50eb11130c29179e9f]['errors'] = $errors;
$this->functionData['form'][$count_00ab071546bbde50eb11130c29179e9f]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("

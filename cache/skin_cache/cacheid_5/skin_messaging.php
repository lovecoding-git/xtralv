...
{
$count_5310e018cb92bdb78399088da858eee3 = is_array($this->functionData['sendReplyForm']) ? count($this->functionData['sendReplyForm']) : 0;
$this->functionData['sendReplyForm'][$count_5310e018cb92bdb78399088da858eee3]['displayData'] = $displayData;
}
$IPBHTML .= "<postingForm>
...
{
$count_3ebc0e6a73f6b6b0a003fb4edeffd17d = is_array($this->functionData['showConversation']) ? count($this->functionData['showConversation']) : 0;
$this->functionData['showConversation'][$count_3ebc0e6a73f6b6b0a003fb4edeffd17d]['topic'] = $topic;
$this->functionData['showConversation'][$count_3ebc0e6a73f6b6b0a003fb4edeffd17d]['replies'] = $replies;
$this->functionData['showConversation'][$count_3ebc0e6a73f6b6b0a003fb4edeffd17d]['members'] = $members;
$this->functionData['showConversation'][$count_3ebc0e6a73f6b6b0a003fb4edeffd17d]['jump'] = $jump;
}
...
<message>
	...
	".$this->__f__3e9f1d0d58ed9feb9df1d465adb1d22e($topic,$replies,$members,$jump)."</message>";
return $IPBHTML;
}


function __f__3e9f1d0d58ed9feb9df1d465adb1d22e($topic, $replies, $members, $jump="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0eee35b284fdf538402c58e6ccb62b84 = is_array($this->functionData['showFolder']) ? count($this->functionData['showFolder']) : 0;
$this->functionData['showFolder'][$count_0eee35b284fdf538402c58e6ccb62b84]['messages'] = $messages;
$this->functionData['showFolder'][$count_0eee35b284fdf538402c58e6ccb62b84]['dirname'] = $dirname;
$this->functionData['showFolder'][$count_0eee35b284fdf538402c58e6ccb62b84]['pages'] = $pages;
$this->functionData['showFolder'][$count_0eee35b284fdf538402c58e6ccb62b84]['currentFolderID'] = $currentFolderID;
$this->functionData['showFolder'][$count_0eee35b284fdf538402c58e6ccb62b84]['jumpFolderHTML'] = $jumpFolderHTML;
}
$IPBHTML .= "<template>popoverMessages</template>
<messages>
	".$this->__f__2a262ae81e733dbdafb854dd9a836785($messages,$dirname,$pages,$currentFolderID,$jumpFolderHTML)."</messages>";
return $IPBHTML;
}


function __f__2a262ae81e733dbdafb854dd9a836785($messages, $dirname, $pages, $currentFolderID, $jumpFolderHTML)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;

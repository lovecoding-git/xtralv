...
{
$count_d7320396bafe5080b86f09b58b084440 = is_array($this->functionData['asForumTopics']) ? count($this->functionData['asForumTopics']) : 0;
$this->functionData['asForumTopics'][$count_d7320396bafe5080b86f09b58b084440]['data'] = $data;
}
$IPBHTML .= "<searchResult>
	...
	".$this->__f__dcc696b9326c4ccff6d5e3a6dd828625($data)."</searchResult>";
return $IPBHTML;
}


function __f__dcc696b9326c4ccff6d5e3a6dd828625($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_57577057149b0d4a99133cd6eacac202 = is_array($this->functionData['searchResults']) ? count($this->functionData['searchResults']) : 0;
$this->functionData['searchResults'][$count_57577057149b0d4a99133cd6eacac202]['results'] = $results;
$this->functionData['searchResults'][$count_57577057149b0d4a99133cd6eacac202]['titlesOnly'] = $titlesOnly;
}
$IPBHTML .= "" . ((is_array( $results )) ? ("".$this->__f__07aa5aa7a898e9e199cd75e8405d30ec($results,$titlesOnly)."		") : ("")) . "";
return $IPBHTML;
}


function __f__07aa5aa7a898e9e199cd75e8405d30ec($results, $titlesOnly)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;

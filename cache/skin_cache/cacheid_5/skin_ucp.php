...
{
$count_e03d55ffd482c59d219a272b2b7160a2 = is_array($this->functionData['notificationsLog']) ? count($this->functionData['notificationsLog']) : 0;
$this->functionData['notificationsLog'][$count_e03d55ffd482c59d219a272b2b7160a2]['notifications'] = $notifications;
$this->functionData['notificationsLog'][$count_e03d55ffd482c59d219a272b2b7160a2]['error'] = $error;
$this->functionData['notificationsLog'][$count_e03d55ffd482c59d219a272b2b7160a2]['pages'] = $pages;
}
$IPBHTML .= "<template>popoverNotifications</template>
<notifications>
	".$this->__f__9757697f6fd2d6cae746894b9c83ea47($notifications,$error,$pages)."</notifications>";
return $IPBHTML;
}


function __f__9757697f6fd2d6cae746894b9c83ea47($notifications, $error='', $pages='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;

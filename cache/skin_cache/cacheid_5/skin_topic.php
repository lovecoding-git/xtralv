...
{
$count_addfc30a0d9c8c75b6f268db0c76a63a = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_addfc30a0d9c8c75b6f268db0c76a63a]['post'] = $post;
$this->functionData['post'][$count_addfc30a0d9c8c75b6f268db0c76a63a]['displayData'] = $displayData;
$this->functionData['post'][$count_addfc30a0d9c8c75b6f268db0c76a63a]['topic'] = $topic;
$this->functionData['post'][$count_addfc30a0d9c8c75b6f268db0c76a63a]['forum'] = $forum;
}
$IPBHTML .= "<post>
					<id>{$post['post']['pid']}</id>
...
{
$count_f595fbad23de94dd11bfefde7f789c64 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_f595fbad23de94dd11bfefde7f789c64]['title'] = $title;
$this->functionData['show_attachment_title'][$count_f595fbad23de94dd11bfefde7f789c64]['data'] = $data;
$this->functionData['show_attachment_title'][$count_f595fbad23de94dd11bfefde7f789c64]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__79f15ec395d9386b6dae3edd241de041($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__79f15ec395d9386b6dae3edd241de041($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_7762eb16b98c114501da2323296345c6 = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_7762eb16b98c114501da2323296345c6]['data'] = $data;
}
...
{
$count_1a3563b97b341ac87374968c2d2ebcce = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_1a3563b97b341ac87374968c2d2ebcce]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_1a3563b97b341ac87374968c2d2ebcce]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_1a3563b97b341ac87374968c2d2ebcce]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_1a3563b97b341ac87374968c2d2ebcce]['displayData'] = $displayData;
}
...
") : ("")) . "
		...
		<topic>
			...
			<posts>				
" . ((is_array( $post_data ) AND count( $post_data )) ? ("".$this->__f__3f6a89f4a3e7bbf14c1a2f5bca2dce37($forum,$topic,$post_data,$displayData)."") : ("")) . "
			</posts>
		</topic>
	</forum>";
return $IPBHTML;
...
function __f__3f6a89f4a3e7bbf14c1a2f5bca2dce37($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;

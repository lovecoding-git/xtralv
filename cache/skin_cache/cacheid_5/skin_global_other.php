...
{
$count_dd0fedbd379f1112e212a7df7e36b08d = is_array($this->functionData['notificationsList']) ? count($this->functionData['notificationsList']) : 0;
$this->functionData['notificationsList'][$count_dd0fedbd379f1112e212a7df7e36b08d]['notifications'] = $notifications;
}
$IPBHTML .= "<template>popoverNotifications</template>
<notifications>
	".$this->__f__90e2b8e04055b928bd9f0542878cd246($notifications)."</notifications>";
return $IPBHTML;
}


function __f__90e2b8e04055b928bd9f0542878cd246($notifications)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_60f21e04512ad353d7df7d3693b859ea = is_array($this->functionData['repButtons']) ? count($this->functionData['repButtons']) : 0;
$this->functionData['repButtons'][$count_60f21e04512ad353d7df7d3693b859ea]['member'] = $member;
$this->functionData['repButtons'][$count_60f21e04512ad353d7df7d3693b859ea]['data'] = $data;
}

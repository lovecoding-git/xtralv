...
class skin_classifieds_hooks_4 extends skinMaster{
...
{
$count_2cac4755f20fad4786e8e9a45e356023 = is_array($this->functionData['randomAd']) ? count($this->functionData['randomAd']) : 0;
$this->functionData['randomAd'][$count_2cac4755f20fad4786e8e9a45e356023]['item'] = $item;
}
$IPBHTML .= "<br />
...
{
$count_0fdd0e8ffd5b49b91cfe96f67992f565 = is_array($this->functionData['sidebar_hook_latest']) ? count($this->functionData['sidebar_hook_latest']) : 0;
$this->functionData['sidebar_hook_latest'][$count_0fdd0e8ffd5b49b91cfe96f67992f565]['items'] = $items;
}
...
$IPBHTML .= "<div class='ipsSideBlock clearfix'>
		...
		<ul class='ipsList_withminiphoto'>
			" . ((is_array( $items ) && count( $items )) ? ("
								".$this->__f__31cbd2b8b68fabcf141734bd1e74fc6f($items)."			") : ("
...
function __f__31cbd2b8b68fabcf141734bd1e74fc6f($items)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;

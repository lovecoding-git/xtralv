...
$IPBHTML = "";
$IPBHTML .= "<a href='http://xtra.lv/index.php' title='{$this->lang->words['go_home']}' rel=\"home\" accesskey='1'><img src='" . $this->registry->getClass('output')->getReplacement("logo_img") . "' alt='{$this->lang->words['logo']}' /></a>";
return $IPBHTML;
}
...
{
$count_428c94d2d468c97a7e105a1ccf037f64 = is_array($this->functionData['globalTemplate']) ? count($this->functionData['globalTemplate']) : 0;
$this->functionData['globalTemplate'][$count_428c94d2d468c97a7e105a1ccf037f64]['html'] = $html;
$this->functionData['globalTemplate'][$count_428c94d2d468c97a7e105a1ccf037f64]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplate'][$count_428c94d2d468c97a7e105a1ccf037f64]['css'] = $css;
$this->functionData['globalTemplate'][$count_428c94d2d468c97a7e105a1ccf037f64]['jsModules'] = $jsModules;
$this->functionData['globalTemplate'][$count_428c94d2d468c97a7e105a1ccf037f64]['metaTags'] = $metaTags;
$this->functionData['globalTemplate'][$count_428c94d2d468c97a7e105a1ccf037f64]['header_items'] = $header_items;
$this->functionData['globalTemplate'][$count_428c94d2d468c97a7e105a1ccf037f64]['items'] = $items;
$this->functionData['globalTemplate'][$count_428c94d2d468c97a7e105a1ccf037f64]['footer_items'] = $footer_items;
$this->functionData['globalTemplate'][$count_428c94d2d468c97a7e105a1ccf037f64]['stats'] = $stats;
}
				...
				<div class='main_width'>
					...
					" . (($this->memberData['member_id']) ? ("<div id='user_navigation' class='logged_in'>
						...
						<div id='user_link_menucontent' class='ipsHeaderMenu clearfix boxShadow' style='display: none'>
							...
							<div class='left'>
								" . (($this->registry->getClass('memberStatus')->canCreate( $this->memberData ) && !($this->settings['board_offline'] && !$this->memberData['g_access_offline'])) ? ("<form id='statusForm' action='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=members&amp;module=profile&amp;section=status&amp;do=new&amp;k={$this->member->form_hash}&amp;id={$this->memberData['member_id']}", "preferHttps",'' ), "", "" ) . "' method='post'>
				...
				<div class='main_width'>
					<ul class='ipsList_inline' id='community_app_menu'>
						...
						") : ("" . ((is_array($header_items['applications']) AND count($header_items['applications'])) ? ("
								".$this->__f__22cba139e0ef3205fd99276957c41093($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."							") : ("")) . "")) . "
			...
			<div id='content' class='clearfix'>
				...
				" . ((count( $items['navigation'] )) ? ("<div id='secondary_navigation' class='clearfix'>
						<ol class='breadcrumb top ipsList_inline left'>
								...
								" . (($this->did_first=1) ? ("") : ("")) . "") : ("")) . "
							".$this->__f__d76570d951c570594dee4b7208d88bf0($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."						</ol>
					</div>
					<br />") : ("")) . "
				<noscript>
				...
				<ol class='breadcrumb bottom ipsList_inline left clearfix clear'>
					" . ((count( $items['navigation'] )) ? ("						" . ((!$this->settings['remove_forums_nav'] OR ipsRegistry::$current_application == 'forums') ? ("<li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "act=idx", "public",'' ), "false", "" ) . "'>{$this->settings['board_name']}</a></li>
						...
						".$this->__f__ba0563181e9ed30c253ba1e7b1adac98($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."") : ("
						<li>&nbsp;</li>
					")) . "
							...
							" . ((count($footer_items['skin_chooser']) > 1) ? ("
								<li>
									...
									<ul id='new_skin_menucontent' class='ipbmenu_content with_checks' style='display: none'>
										".$this->__f__f24f90717d19cfd00383ebeeba261a40($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."									</ul>
								</li>
							") : ("")) . "")) . "") : ("")) . "
					" . ((! $this->member->is_not_human && count( $footer_items['lang_chooser']['options'] ) > 1) ? ("
						<li>
							...
							<ul id='new_language_menucontent' class='ipbmenu_content with_checks' style='display: none'>
								".$this->__f__df6d13c85e68364fc876e2477f8170e0($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."							</ul>
						</li>
					") : ("")) . "
					" . ((( ! $this->member->is_not_human ) && ( $this->memberData['member_id'] || $this->settings['topic_marking_guests'] )) ? ("
						<li>
							...
							<ul id='mark_all_read_menucontent' class='ipbmenu_content' style='display: none'>
								".$this->__f__650ad7eb1881180796b47a44ac4b1e64($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								<li>
...
function __f__22cba139e0ef3205fd99276957c41093($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__d76570d951c570594dee4b7208d88bf0($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__ba0563181e9ed30c253ba1e7b1adac98($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $items['navigation'] as $idx => $data )
...
function __f__f24f90717d19cfd00383ebeeba261a40($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__df6d13c85e68364fc876e2477f8170e0($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__650ad7eb1881180796b47a44ac4b1e64($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_7159c38ce4857212876df2ef3f90c0bd = is_array($this->functionData['includeCSS']) ? count($this->functionData['includeCSS']) : 0;
$this->functionData['includeCSS'][$count_7159c38ce4857212876df2ef3f90c0bd]['css'] = $css;
}

$this->minify = array();
$IPBHTML .= "" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
	".$this->__f__6c483907980d8023fce2c501ff0995d7($css)."	" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
...
" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
	".$this->__f__b2c9e14b6a93847d94a74993a14ff551($css)."") : ("")) . "
<!--[if lte IE 7]>
...
function __f__6c483907980d8023fce2c501ff0995d7($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b2c9e14b6a93847d94a74993a14ff551($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_067a02fb6c329923e8388356033da6a9 = is_array($this->functionData['includeFeeds']) ? count($this->functionData['includeFeeds']) : 0;
$this->functionData['includeFeeds'][$count_067a02fb6c329923e8388356033da6a9]['documentHeadItems'] = $documentHeadItems;
}
$IPBHTML .= "" . ((count($documentHeadItems)) ? ("
	".$this->__f__9a504ccdf801962d3631b204b14cf551($documentHeadItems)."") : ("")) . "";
return $IPBHTML;
}


function __f__a17418e39ed1433a3bc4850299168ebc($documentHeadItems,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__9a504ccdf801962d3631b204b14cf551($documentHeadItems)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__a17418e39ed1433a3bc4850299168ebc($documentHeadItems,$type,$idx)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_3364a7fc7466f2ac8fc44a1d4661a45e = is_array($this->functionData['includeJS']) ? count($this->functionData['includeJS']) : 0;
$this->functionData['includeJS'][$count_3364a7fc7466f2ac8fc44a1d4661a45e]['jsModules'] = $jsModules;
}
...
{
$count_27c77e685b3883e649cdfbf6b24c68d7 = is_array($this->functionData['includeMeta']) ? count($this->functionData['includeMeta']) : 0;
$this->functionData['includeMeta'][$count_27c77e685b3883e649cdfbf6b24c68d7]['metaTags'] = $metaTags;
}
$IPBHTML .= "" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
	".$this->__f__26759efe98a57eef4ca5ca930f26d5de($metaTags)."") : ("")) . "
<meta property=\"og:image\" content=\"{$this->settings['meta_imagesrc']}\"/>";
return $IPBHTML;
}


function __f__ea4b2cb25710c49783d3ec6efe755f63($metaTags,$tag='',$id='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__26759efe98a57eef4ca5ca930f26d5de($metaTags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $metaTags as $tag => $id )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__ea4b2cb25710c49783d3ec6efe755f63($metaTags,$tag,$id)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_5e4a6d0a0662342d6909635acff0faa3 = is_array($this->functionData['includeRTL']) ? count($this->functionData['includeRTL']) : 0;
}

$this->isRtlLang	= false;
$IPBHTML .= "".$this->__f__210077f7feff4aa1e688e878a4508b6e()."" . (($this->isRtlLang AND is_file( DOC_IPS_ROOT_PATH . '/' . PUBLIC_DIRECTORY . '/style_css/' . $this->registry->output->skin['_csscacheid'] . '/ipb_rtl.css' )) ? ("
...
function __f__210077f7feff4aa1e688e878a4508b6e()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ecee6ba8e2fab4242e3cdd4c2733f918 = is_array($this->functionData['includeVars']) ? count($this->functionData['includeVars']) : 0;
$this->functionData['includeVars'][$count_ecee6ba8e2fab4242e3cdd4c2733f918]['header_items'] = $header_items;
}
...
{
$count_730776a48c1eaf16b7c695dcf1a99a83 = is_array($this->functionData['inlineLogin']) ? count($this->functionData['inlineLogin']) : 0;
}
				...
				" . ((IPSLib::loginMethod_enabled('facebook') || IPSLib::loginMethod_enabled('twitter') || IPSLib::loginMethod_enabled('live')) ? ("<div class='ipsBox_notice'>
						<ul class='ipsList_inline'>
							...
							" . ((is_array($this->_formFields) AND count($this->_formFields)) ? ("
								".$this->__f__9c28bf01c15abed0021a9cf5fe78edc5()."							") : ("")) . "
						</ul>
					</div>") : ("")) . "
				<br />
...
function __f__9c28bf01c15abed0021a9cf5fe78edc5()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4e30c4040a777205316ba5928c02c8b1 = is_array($this->functionData['liveEditJs']) ? count($this->functionData['liveEditJs']) : 0;
}
...
<div class='ipsBox ipsPad'>
	...
	<form action='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&module=global&section=meta&do=save", "public",'' ), "", "" ) . "' method='post'>
		...
		<table class='ipb_table'>
			".$this->__f__fcb32a4d4e2241930cbb4bbb000403ac($tags,$url)."		</table>
		</div>
		<table class='ipb_table'>
			<tr>
...
function __f__fcb32a4d4e2241930cbb4bbb000403ac($tags, $url)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tags as $k => $v )
...
{
$count_57d7fa5f0ce69f70143b22181b0c6b4f = is_array($this->functionData['nextPreviousTemplate']) ? count($this->functionData['nextPreviousTemplate']) : 0;
$this->functionData['nextPreviousTemplate'][$count_57d7fa5f0ce69f70143b22181b0c6b4f]['data'] = $data;
}
...
{
$count_fec8b6fc3d6b35672c4b62f563461b2c = is_array($this->functionData['paginationTemplate']) ? count($this->functionData['paginationTemplate']) : 0;
$this->functionData['paginationTemplate'][$count_fec8b6fc3d6b35672c4b62f563461b2c]['work'] = $work;
$this->functionData['paginationTemplate'][$count_fec8b6fc3d6b35672c4b62f563461b2c]['data'] = $data;
}
$IPBHTML .= "" . (($work['pages'] > 1) ? ("<div class='pagination clearfix left " . ((!$data['showNumbers']) ? ("no_numbers") : ("")) . "'>
		...
		<ul class='ipsList_inline left pages'>
			...
			" . ((is_array( $work['_pageNumbers'] ) && count( $work['_pageNumbers'] )) ? ("
				".$this->__f__0524c188c65699ae0567ccef0e4fcd8f($work,$data)."			") : ("")) . "
		</ul>
...
function __f__0524c188c65699ae0567ccef0e4fcd8f($work, $data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_6daa4171966888406a7cfb56df043766 = is_array($this->functionData['quickSearch']) ? count($this->functionData['quickSearch']) : 0;
}
		...
		<fieldset>
			...
			<span id='search_wrap' class='right'>
				...
				<ul id='search_options_menucontent' class='ipbmenu_content ipsPad' style='display: none'>
					...
					".$this->__f__092b6df53862122a44da0d99344f0cb0()."				</ul>
...
function __f__092b6df53862122a44da0d99344f0cb0()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_3eed443c30380ae21e6076390cab9ae4 = is_array($this->functionData['shareLinks']) ? count($this->functionData['shareLinks']) : 0;
$this->functionData['shareLinks'][$count_3eed443c30380ae21e6076390cab9ae4]['links'] = $links;
$this->functionData['shareLinks'][$count_3eed443c30380ae21e6076390cab9ae4]['title'] = $title;
$this->functionData['shareLinks'][$count_3eed443c30380ae21e6076390cab9ae4]['url'] = $url;
$this->functionData['shareLinks'][$count_3eed443c30380ae21e6076390cab9ae4]['cssClass'] = $cssClass;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("sharelinks", "0" ) . "
" . ((is_array( $links )) ? ("
	<ul class='{$cssClass} shareButtons ipsList_inline'>
	".$this->__f__aeba5e2bf55e4a98eddf69127aaf362e($links,$title,$url,$cssClass)."	</ul>
	<script type=\"text/javascript\">
...
function __f__aeba5e2bf55e4a98eddf69127aaf362e($links, $title='', $url='', $cssClass='topic_share left')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b5d83878c8a5c2dd46722235fa032822 = is_array($this->functionData['signature_separator']) ? count($this->functionData['signature_separator']) : 0;
$this->functionData['signature_separator'][$count_b5d83878c8a5c2dd46722235fa032822]['sig'] = $sig;
$this->functionData['signature_separator'][$count_b5d83878c8a5c2dd46722235fa032822]['author_id'] = $author_id;
$this->functionData['signature_separator'][$count_b5d83878c8a5c2dd46722235fa032822]['can_ignore'] = $can_ignore;
}
...
{
$count_27cc6493b6954a93d029c4b08d88cfdb = is_array($this->functionData['userHoverCard']) ? count($this->functionData['userHoverCard']) : 0;
$this->functionData['userHoverCard'][$count_27cc6493b6954a93d029c4b08d88cfdb]['member'] = $member;
}
...
{
$count_4176b19a4f2ae90292984906a7b1ee51 = is_array($this->functionData['userInfoPane']) ? count($this->functionData['userInfoPane']) : 0;
$this->functionData['userInfoPane'][$count_4176b19a4f2ae90292984906a7b1ee51]['author'] = $author;
$this->functionData['userInfoPane'][$count_4176b19a4f2ae90292984906a7b1ee51]['contentid'] = $contentid;
$this->functionData['userInfoPane'][$count_4176b19a4f2ae90292984906a7b1ee51]['options'] = $options;
}
$IPBHTML .= "<div itemscope itemtype=\"http://schema.org/Person\" class='user_details'>
	...
	" . (($author['custom_fields'] != "") ? ("
		<ul class='custom_fields'>
			".$this->__f__1e0379ac53341dc00fff985cee6f606d($author,$contentid,$options)."		</ul>
...
function __f__f22c109ed4b7204c30abf1ae136fdd4d($author, $contentid, $options,$group='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__1e0379ac53341dc00fff985cee6f606d($author, $contentid, $options)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $author['custom_fields'] as $group => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__f22c109ed4b7204c30abf1ae136fdd4d($author,$contentid,$options,$group,$data)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_9cbfc64f7b8bad2af3151544c522c951 = is_array($this->functionData['userSmallPhoto']) ? count($this->functionData['userSmallPhoto']) : 0;
$this->functionData['userSmallPhoto'][$count_9cbfc64f7b8bad2af3151544c522c951]['member'] = $member;
}
...
{
$count_e7bdd52961c70943d2999af2bbdb4041 = is_array($this->functionData['warnDetails']) ? count($this->functionData['warnDetails']) : 0;
$this->functionData['warnDetails'][$count_e7bdd52961c70943d2999af2bbdb4041]['warning'] = $warning;
$this->functionData['warnDetails'][$count_e7bdd52961c70943d2999af2bbdb4041]['canSeeModNote'] = $canSeeModNote;
}
...
<div class='ipsBox'>
	<p class='message unspecific'>
		...
		") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
				...
				")) . "") : ("")) . "
			".$this->__f__ca9231476db0a243d3977fc9c05079d3($warning,$canSeeModNote)."")) . "
	</p>
...
function __f__ca9231476db0a243d3977fc9c05079d3($warning, $canSeeModNote)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;

...
class skin_classifieds_manage_4 extends skinMaster{
...
{
$count_8ab6a8b7e86c93870c588f20436d22bb = is_array($this->functionData['item_row']) ? count($this->functionData['item_row']) : 0;
$this->functionData['item_row'][$count_8ab6a8b7e86c93870c588f20436d22bb]['item'] = $item;
}
$IPBHTML .= "<div class='cfds_category_row " .  IPSLib::next( $this->registry->templateStriping["items"] ) . "" . ((!$item['open']) ? (" moderated") : ("")) . "' id='itemrow_{$item['item_id']}'>
						...
						<h3 class='ipsType_subtitle'>
								...
								<span class='ipsBadge ipsBadge_green priceBadge'>
										    " . ipsRegistry::getClass('class_localization')->formatMoney( $item['price'], false ) . "
								</span>
...
{
$count_3c4de199b783868ce6da90e52dcfdbf7 = is_array($this->functionData['items']) ? count($this->functionData['items']) : 0;
$this->functionData['items'][$count_3c4de199b783868ce6da90e52dcfdbf7]['items'] = $items;
$this->functionData['items'][$count_3c4de199b783868ce6da90e52dcfdbf7]['pages'] = $pages;
}
		...
		<div class='ipsPad'>{$pages}</div>
			<div class='ipsPad clear'>
				...
				<div id='cfds_category' class='ipsBox_container'>
		            " . ((count($items)) ? (" 		                ".$this->__f__666427c175b7a986e25c3b6ebb86e447($items,$pages)."		                ") : ("
...
function __f__666427c175b7a986e25c3b6ebb86e447($items, $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d35f8329ac8ce99f1fa1c6f197622951 = is_array($this->functionData['menu']) ? count($this->functionData['menu']) : 0;
}

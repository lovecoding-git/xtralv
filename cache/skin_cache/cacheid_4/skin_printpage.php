...
class skin_printpage_4 extends skinMaster{
...
{
$count_772e540cf1043e55a737b871d97bd65b = is_array($this->functionData['pp_end']) ? count($this->functionData['pp_end']) : 0;
}
$IPBHTML .= "<!--Copyright-->
...
{
$count_83301dd9140dbab1697d60a43a6d221a = is_array($this->functionData['pp_postentry']) ? count($this->functionData['pp_postentry']) : 0;
$this->functionData['pp_postentry'][$count_83301dd9140dbab1697d60a43a6d221a]['poster'] = $poster;
$this->functionData['pp_postentry'][$count_83301dd9140dbab1697d60a43a6d221a]['entry'] = $entry;
}

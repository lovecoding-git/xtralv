...
{
$count_215e9dd91d0922ebd51df7579e0a6c17 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_215e9dd91d0922ebd51df7579e0a6c17]['data'] = $data;
}
...
{
$count_179b06091823b440524a1432dfc2befa = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_179b06091823b440524a1432dfc2befa]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_179b06091823b440524a1432dfc2befa]['form'] = $form;
}
...
{
$count_fd8e66164176e5769c5bdf3d733dd8c3 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_fd8e66164176e5769c5bdf3d733dd8c3]['data'] = $data;
}
...
{
$count_7645ccfc2e5701060214d2b0f3d4e65e = is_array($this->functionData['similarTopicsAjax']) ? count($this->functionData['similarTopicsAjax']) : 0;
$this->functionData['similarTopicsAjax'][$count_7645ccfc2e5701060214d2b0f3d4e65e]['topic_data'] = $topic_data;
}
$IPBHTML .= "<fieldset>
...
<div class='ipsBox table_wrap' style='margin-bottom: 10px;'><div class='ipsBox_container'>
  <table class='ipb_table topic_list hover_rows'>
   ...
   " . ((is_array( $topic_data ) AND count( $topic_data )) ? ("
    ".$this->__f__9010986d196f998ee224724e75a7b593($topic_data)."   ") : ("")) . "
  </table></div></div>
</fieldset>";
return $IPBHTML;
}
...
function __f__656deeec698b92c9bd328d5188b7ba6c($topic_data=array(),$tid='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b3f59e5a34a4370e978df2ea57251d9b($topic_data=array(),$tid='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__9010986d196f998ee224724e75a7b593($topic_data=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
                 ...
                 <tr class='__topic " . ((!$data['topic_data']['folder_img']['is_read']) ? ("unread") : ("")) . " expandable' id='trow_{$data['topic_data']['tid']}' data-tid=\"{$data['topic_data']['tid']}\">
                  ...
                  <td class='col_f_content " . (($this->memberData['is_mod'] == 1 || $data['forum_data']['permissions']['TopicSoftDelete']) ? (" with_mod_links") : ("")) . "'>
                   ...
                   <span class='desc lighter blend_links'>
                    ...
                    ".$this->__f__656deeec698b92c9bd328d5188b7ba6c($topic_data,$tid,$data)."                    " . ((isset($data['topic_data']['tags']) AND $data['topic_data']['tags']) ? ("
                   ...
                   " . ((isset( $data['topic_data']['pages'] ) AND is_array( $data['topic_data']['pages'] ) AND count( $data['topic_data']['pages'] )) ? ("
                    ...
                    ".$this->__f__b3f59e5a34a4370e978df2ea57251d9b($topic_data,$tid,$data)."                    </ul>
                   ") : ("")) . "
                  </td>
...
{
$count_d41575eeb50f49187629f3cbbc280499 = is_array($this->functionData['similarTopicsAjax_resumed']) ? count($this->functionData['similarTopicsAjax_resumed']) : 0;
$this->functionData['similarTopicsAjax_resumed'][$count_d41575eeb50f49187629f3cbbc280499]['topic_data'] = $topic_data;
}
$IPBHTML .= "<fieldset>
  <h3 class='maintitle' style='margin-bottom: 0px;'>{$this->lang->words['similar_topics']}</h3>
<div class='ipsBox table_wrap' style='margin-bottom: 10px;'><div class='ipsBox_container'>
  <table class='ipb_table topic_list hover_rows'>
   ...
   " . ((is_array( $topic_data ) AND count( $topic_data )) ? ("
        ".$this->__f__e15e483e3337fee6f18cb89a14a5be5f($topic_data)."   ") : ("")) . "
  </table></div></div>
</fieldset>";
return $IPBHTML;
}
...
function __f__e15e483e3337fee6f18cb89a14a5be5f($topic_data=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $topic_data as $tid => $data )
...
{
$count_d101058a96ea610e4ecf37d132631fd8 = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_d101058a96ea610e4ecf37d132631fd8]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__4cbf667a2393c01895e262723319ba43($posts)."") : ("")) . "
<p class='submit'>
...
function __f__4cbf667a2393c01895e262723319ba43($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ea3c2602eb32e4803b080e76b8c27bf8 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_ea3c2602eb32e4803b080e76b8c27bf8]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_ea3c2602eb32e4803b080e76b8c27bf8]['type'] = $type;
$this->functionData['uploadForm'][$count_ea3c2602eb32e4803b080e76b8c27bf8]['stats'] = $stats;
$this->functionData['uploadForm'][$count_ea3c2602eb32e4803b080e76b8c27bf8]['id'] = $id;
$this->functionData['uploadForm'][$count_ea3c2602eb32e4803b080e76b8c27bf8]['forum_id'] = $forum_id;
}

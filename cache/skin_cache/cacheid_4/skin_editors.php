...
{
$count_2a638b69097be998a0a97e1df297f3ea = is_array($this->functionData['ajaxEditBox']) ? count($this->functionData['ajaxEditBox']) : 0;
$this->functionData['ajaxEditBox'][$count_2a638b69097be998a0a97e1df297f3ea]['post'] = $post;
$this->functionData['ajaxEditBox'][$count_2a638b69097be998a0a97e1df297f3ea]['pid'] = $pid;
$this->functionData['ajaxEditBox'][$count_2a638b69097be998a0a97e1df297f3ea]['error_msg'] = $error_msg;
$this->functionData['ajaxEditBox'][$count_2a638b69097be998a0a97e1df297f3ea]['extraData'] = $extraData;
}
...
<div class='ipsBox clearfix'>
	<div class='ipsBox_container'>
		<div class='ips_editor' id='editor_e{$pid}'>
			...
			") : ("
				" . $editor->show('Post', array( 'editorName' => 'edit-' . $pid, 'type' => 'full', 'minimize' => 0, 'legacyMode' => 'off', 'autoSaveKey' => 'edit-' . $pid ), "$post")  . "
			")) . "
...
{
$count_5b652ae4da244771dc194e071754a768 = is_array($this->functionData['editor']) ? count($this->functionData['editor']) : 0;
$this->functionData['editor'][$count_5b652ae4da244771dc194e071754a768]['formField'] = $formField;
$this->functionData['editor'][$count_5b652ae4da244771dc194e071754a768]['content'] = $content;
$this->functionData['editor'][$count_5b652ae4da244771dc194e071754a768]['options'] = $options;
$this->functionData['editor'][$count_5b652ae4da244771dc194e071754a768]['autoSaveData'] = $autoSaveData;
$this->functionData['editor'][$count_5b652ae4da244771dc194e071754a768]['warningInfo'] = $warningInfo;
$this->functionData['editor'][$count_5b652ae4da244771dc194e071754a768]['acknowledge'] = $acknowledge;
$this->functionData['editor'][$count_5b652ae4da244771dc194e071754a768]['bbcodeVersion'] = $bbcodeVersion;
$this->functionData['editor'][$count_5b652ae4da244771dc194e071754a768]['showEditor'] = $showEditor;
}
...
{
$count_deee0e389d59abd374ec244864608cbe = is_array($this->functionData['editorLoadJs']) ? count($this->functionData['editorLoadJs']) : 0;
$this->functionData['editorLoadJs'][$count_deee0e389d59abd374ec244864608cbe]['options'] = $options;
$this->functionData['editorLoadJs'][$count_deee0e389d59abd374ec244864608cbe]['inlineLoad'] = $inlineLoad;
}
...
{
$count_08c0164d9f0f4bf15fd4151bc5726145 = is_array($this->functionData['mediaGenericWrapper']) ? count($this->functionData['mediaGenericWrapper']) : 0;
$this->functionData['mediaGenericWrapper'][$count_08c0164d9f0f4bf15fd4151bc5726145]['rows'] = $rows;
$this->functionData['mediaGenericWrapper'][$count_08c0164d9f0f4bf15fd4151bc5726145]['pages'] = $pages;
$this->functionData['mediaGenericWrapper'][$count_08c0164d9f0f4bf15fd4151bc5726145]['app'] = $app;
$this->functionData['mediaGenericWrapper'][$count_08c0164d9f0f4bf15fd4151bc5726145]['plugin'] = $plugin;
}
...
<div>
	<ul class='media_results'>
		" . ((count($rows)) ? ("
			".$this->__f__73a7c0c0a2bcee4223bc0c22adc59e27($rows,$pages,$app,$plugin)."		") : ("
...
function __f__73a7c0c0a2bcee4223bc0c22adc59e27($rows, $pages, $app, $plugin)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_53813ebcb8d5489e87d5c9f5ba79d05b = is_array($this->functionData['sharedMedia']) ? count($this->functionData['sharedMedia']) : 0;
$this->functionData['sharedMedia'][$count_53813ebcb8d5489e87d5c9f5ba79d05b]['tabs'] = $tabs;
}
...
<div class='fixed_inner ipsBox'>
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>
			<ul id='mymedia_tabs'>
				".$this->__f__a8b64e949162c4408a95408506756312($tabs)."			</ul>
		</div>
...
function __f__a8b64e949162c4408a95408506756312($tabs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )

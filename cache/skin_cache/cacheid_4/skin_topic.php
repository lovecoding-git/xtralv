...
$this->_funcHooks['hookdp3similarTopics'] = array('pages','topics');
...
{
$count_33ed6d54ff703a5f5d41bcd5814ed181 = is_array($this->functionData['ajaxSharePost']) ? count($this->functionData['ajaxSharePost']) : 0;
$this->functionData['ajaxSharePost'][$count_33ed6d54ff703a5f5d41bcd5814ed181]['topic'] = $topic;
$this->functionData['ajaxSharePost'][$count_33ed6d54ff703a5f5d41bcd5814ed181]['post'] = $post;
$this->functionData['ajaxSharePost'][$count_33ed6d54ff703a5f5d41bcd5814ed181]['url'] = $url;
$this->functionData['ajaxSharePost'][$count_33ed6d54ff703a5f5d41bcd5814ed181]['sharelinks'] = $sharelinks;
}
...
{
$count_777c54643e130ff5fc96404bd41fcbbb = is_array($this->functionData['announcement_show']) ? count($this->functionData['announcement_show']) : 0;
$this->functionData['announcement_show'][$count_777c54643e130ff5fc96404bd41fcbbb]['announce'] = $announce;
$this->functionData['announcement_show'][$count_777c54643e130ff5fc96404bd41fcbbb]['author'] = $author;
}
...
{
$count_771ae95ea1be1648e727c1613ac8a020 = is_array($this->functionData['archiveStatusMessage']) ? count($this->functionData['archiveStatusMessage']) : 0;
$this->functionData['archiveStatusMessage'][$count_771ae95ea1be1648e727c1613ac8a020]['topic'] = $topic;
$this->functionData['archiveStatusMessage'][$count_771ae95ea1be1648e727c1613ac8a020]['forum'] = $forum;
}
...
/* -- hookdp3similarTopics --*/
function hookdp3similarTopics($topics_data, $toggle) {
$IPBHTML = "";
if( IPSLib::locationHasHooks( 'skin_topic', $this->_funcHooks['hookdp3similarTopics'] ) )
{
$count_ed0f4dfc61f1f2f43295e250e655b85a = is_array($this->functionData['hookdp3similarTopics']) ? count($this->functionData['hookdp3similarTopics']) : 0;
$this->functionData['hookdp3similarTopics'][$count_ed0f4dfc61f1f2f43295e250e655b85a]['topics_data'] = $topics_data;
$this->functionData['hookdp3similarTopics'][$count_ed0f4dfc61f1f2f43295e250e655b85a]['toggle'] = $toggle;
}
...
<br />
		<h3 id='similartopics' class='maintitle'>{$this->lang->words['dp3_st_header']} <span id='sim_expand' style='float:right; width:25px;display: " . (($toggle == 'collapsed') ? ("inline") : ("none")) . ";'><a href='javascript:toggleSimilar()' title='{$this->lang->words['dp3_st_exp']}' ><img src='{$this->settings['img_url']}/cat_maximize.png' alt='{$this->lang->words['dp3_st_exp']}' /></a></span> 
				<span id='sim_collapse' style='float:right;width:25px;display: " . (($toggle == 'collapsed') ? ("none") : ("inline")) . ";'> <a href='javascript:toggleSimilar()' title='{$this->lang->words['dp3_st_col']}' ><img src='{$this->settings['img_url']}/cat_minimize.png' alt='{$this->lang->words['dp3_st_col']}' /></a> </span></h3>	
<div id=\"sim_body\"" . (($toggle == 'collapsed') ? (" class='collapsedSim' style='display: none;'") : ("")) . ">	
<div class='ipsBox'>
	<div class='ipsBox_container'>
			...
			<tr class='header'>
				...
				<th scope='col' class='col_f_starter short'>{$this->lang->words['cat_name']}</th>				
			...
			<!-- BEGIN TOPICS -->
			" . ((is_array( $topics_data ) AND count( $topics_data )) ? ("".$this->__f__dfbd40e5129340f1bd4dfbf8966f5a63($topics_data,$toggle)."			") : ("")) . "	
		</table>
	</div>
</div>
</div>";
...
function __f__0db19971ca55c2b05b9a55451c9aa4c3($topics_data, $toggle,$tid='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__dfbd40e5129340f1bd4dfbf8966f5a63($topics_data, $toggle)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $topics_data as $tid => $data )
	{
		
		$__iteratorCount++;
		$_ips___x_retval .= "
					" . ((($this->memberData['is_mod'] AND ! $data['approved']) OR $data['_isDeleted']) ? ("
					<tr class='" .  IPSLib::next( $this->registry->templateStriping["forumTable"] ) . " __topic expandable moderated' id='trow_{$data['tid']}' data-tid=\"{$data['tid']}\">
					") : ("<tr class='" .  IPSLib::next( $this->registry->templateStriping["forumTable"] ) . " __topic " . ((!$data['folder_img']['is_read']) ? ("unread") : ("")) . " expandable' id='trow_{$data['tid']}' data-tid=\"{$data['tid']}\">")) . "					
						<td class='short altrow'>
							" . $this->registry->getClass('output')->getReplacement("{$data['folder_img']}") . "
						</td>						
						<td>
							...
							") : ("")) . "												
							<h4>{$data['prefix']}<a id=\"tid-link-{$data['tid']}\" href=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showtopic={$data['tid']}", "public",'' ), "{$data['title_seo']}", "showtopic" ) . "\" title='{$this->lang->words['topic_started_on']} {$data['start_date']}' class='topic_title'>{$data['title']}</a></h4>
							<br />
							...
							" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
								...
								".$this->__f__0db19971ca55c2b05b9a55451c9aa4c3($topics_data,$toggle,$tid,$data)."								</ul>
							") : ("")) . "
						" . (($data['description']) ? ("<br /><span class='desc'>{$data['description']}</span>") : ("")) . "					
						</td>						
						<td>
						<a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "showforum={$data['forum_id']}", "public",'' ), "{$data['name_seo']}", "showforum" ) . "' title='{$this->lang->words['return_to']} {$data['forum_name']}'>{$data['forum_name']}</a>
						</td>											
						<td class='short altrow'>
							{$data['starter']}" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'user_popup' ) ? $this->registry->getClass('output')->getTemplate('global')->user_popup($data['starter_id'], $data['seo_first_name']) : '' ) . "
						</td>	
...
{
$count_2d005379f32735a3ca5ce9015cee01c6 = is_array($this->functionData['hookFacebookLike']) ? count($this->functionData['hookFacebookLike']) : 0;
}
...
{
$count_38585ef6b6442a0adf752e3697f9b2e0 = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_38585ef6b6442a0adf752e3697f9b2e0]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_38585ef6b6442a0adf752e3697f9b2e0]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_38585ef6b6442a0adf752e3697f9b2e0]['opts'] = $opts;
}
...
{
$count_98ed600caf4aeb50e077cca3ba978cb5 = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_98ed600caf4aeb50e077cca3ba978cb5]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_98ed600caf4aeb50e077cca3ba978cb5]['topicData'] = $topicData;
$this->functionData['pollDisplay'][$count_98ed600caf4aeb50e077cca3ba978cb5]['forumData'] = $forumData;
$this->functionData['pollDisplay'][$count_98ed600caf4aeb50e077cca3ba978cb5]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_98ed600caf4aeb50e077cca3ba978cb5]['showResults'] = $showResults;
$this->functionData['pollDisplay'][$count_98ed600caf4aeb50e077cca3ba978cb5]['editPoll'] = $editPoll;
}
$IPBHTML .= "<script type='text/javascript'>
//<![CDATA[
...
<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=extras&amp;section=vote&amp;t={$topicData['tid']}&amp;page={$this->request['page']}&amp;do=add&amp;secure_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" name='pollForm' method=\"post\">
		...
		") : ("")) . "
		".$this->__f__ac5eb7ea90fc5f2b54edc6391185c7a9($poll,$topicData,$forumData,$pollData,$showResults,$editPoll)."		<fieldset class='submit'>
...
function __f__364079c64257e7ab5202fdc9d7336148($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='',$choiceID='',$choiceData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__48698cc3bea0e80c72b6da05c6051ff5($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
							...
							" . (($showResults) ? ("<li>
									...
									" . (($poll['poll_view_voters'] AND is_array( $choiceData['voters'] ) AND $this->settings['poll_allow_public'] AND $choiceData['votes']) ? ("
										<script type='text/javascript'>
											...
											".$this->__f__364079c64257e7ab5202fdc9d7336148($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData,$choiceID,$choiceData)."											ipb.topic.poll[ $questionID ][ $choiceID ] = { name: \"{$choiceData['choice']}\", users: users};
										</script>
									") : ("")) . "
...
function __f__ac5eb7ea90fc5f2b54edc6391185c7a9($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='poll_question" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__48698cc3bea0e80c72b6da05c6051ff5($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_c036761de5c242ff35c0539d217e766b = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_c036761de5c242ff35c0539d217e766b]['post'] = $post;
$this->functionData['post'][$count_c036761de5c242ff35c0539d217e766b]['displayData'] = $displayData;
$this->functionData['post'][$count_c036761de5c242ff35c0539d217e766b]['topic'] = $topic;
$this->functionData['post'][$count_c036761de5c242ff35c0539d217e766b]['forum'] = $forum;
}
...
{
$count_20a13e4c42c392b168cd8043e67603ee = is_array($this->functionData['quickEditPost']) ? count($this->functionData['quickEditPost']) : 0;
$this->functionData['quickEditPost'][$count_20a13e4c42c392b168cd8043e67603ee]['post'] = $post;
}
$IPBHTML .= "{$post['post']}
    {$post['attachmentHtml']}
	<br />
...
{
$count_300ba05a62571ddfed07192f33246a34 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_300ba05a62571ddfed07192f33246a34]['title'] = $title;
$this->functionData['show_attachment_title'][$count_300ba05a62571ddfed07192f33246a34]['data'] = $data;
$this->functionData['show_attachment_title'][$count_300ba05a62571ddfed07192f33246a34]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__1a5bb9a9eeb5f1b3ae00a3a05c1eae82($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__1a5bb9a9eeb5f1b3ae00a3a05c1eae82($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_7a368d6a53e28a18ce4667d8bc8852ac = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_7a368d6a53e28a18ce4667d8bc8852ac]['data'] = $data;
}
...
{
$count_3f0bff7f74adf91fe68edad09c86d2c3 = is_array($this->functionData['softDeletedPostBit']) ? count($this->functionData['softDeletedPostBit']) : 0;
$this->functionData['softDeletedPostBit'][$count_3f0bff7f74adf91fe68edad09c86d2c3]['post'] = $post;
$this->functionData['softDeletedPostBit'][$count_3f0bff7f74adf91fe68edad09c86d2c3]['sdData'] = $sdData;
$this->functionData['softDeletedPostBit'][$count_3f0bff7f74adf91fe68edad09c86d2c3]['topic'] = $topic;
}
...
/* -- startNewTopic --*/
function startNewTopic($canPost) {
$IPBHTML = "";
$IPBHTML .= "" . (($canPost) ? ("
				<li><a href='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "module=post&amp;section=post&amp;do=new_post&amp;f={$this->request['f']}", "publicWithApp",'' ), "", "" ) . "' title='{$this->lang->words['topic_start']}' accesskey='s'>{$this->lang->words['topic_start']}</a></li>
			") : ("
...
/* -- topicLedByWithActiveUsers --*/
function topicLedByWithActiveUsers($mods=array()) {
$IPBHTML = "";
$IPBHTML .= "</ul>
</div>
<div id='topic_led_by' class='active_users' style=\"margin-top: 50px;\">
	...
	<ul class='ipsList_inline'>
		".$this->__f__b288dbb29579702fe98a18219bd699d3($mods)."";
return $IPBHTML;
}


function __f__b288dbb29579702fe98a18219bd699d3($mods=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $mods as $p => $r )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
			<li><a href='{$r[0]}' title='{$this->lang->words['view_profile']}'>{$r[1]}</a>" . (($r[2]) ? ("" . ( method_exists( $this->registry->getClass('output')->getTemplate('global'), 'user_popup' ) ? $this->registry->getClass('output')->getTemplate('global')->user_popup($r[2], IPSText::makeSeoTitle( $r[1] )) : '' ) . "") : ("")) . "" . (($p + 1 != count( $mods )) ? (",") : ("")) . "</li>
...
/* -- topicLedByWithoutActiveUsers --*/
function topicLedByWithoutActiveUsers($mods=array()) {
$IPBHTML = "";
$IPBHTML .= "<div id='topic_stats' class='statistics clear clearfix'>
	<div id='topic_active_users' class='active_users'>
		<h4 class='statistics_head'>{$this->lang->words['topic_led_by']}</h4>
		<ul class='ipsList_inline'>
			".$this->__f__310d0a27fd93d71ca5ab27a6d4be023f($mods)."		</ul>
	</div>
</div>";
return $IPBHTML;
}
...
function __f__310d0a27fd93d71ca5ab27a6d4be023f($mods=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $mods as $p => $r )
...
$IPBHTML = "";
$IPBHTML .= "".$this->__f__81b47c702509fe58f476c0b04ee32d18($topic,$posts)."<br class='clear' />
...
function __f__81b47c702509fe58f476c0b04ee32d18($topic, $posts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1934c43901d2860b1b546aad00e0188c = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_1934c43901d2860b1b546aad00e0188c]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_1934c43901d2860b1b546aad00e0188c]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_1934c43901d2860b1b546aad00e0188c]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_1934c43901d2860b1b546aad00e0188c]['displayData'] = $displayData;
}
...
" . (($displayData['mod_links'] AND ( $this->memberData['is_mod'] OR $this->memberData['member_id'] == $topic['starter_id'] )) ? ("<ul class='ipbmenu_content' id='topic_mod_options_menucontent'  style='display:none'>
	".$this->__f__0a5ed1d0661fa833c7b019e86ee0e31d($forum,$topic,$post_data,$displayData)."	" . (($topic['topic_queuedposts'] AND $this->registry->class_forums->canQueuePosts( $forum['id'] )) ? ("
	...
	" . ((is_array( $displayData['multi_mod'] ) AND count( $displayData['multi_mod'] )) ? ("
		".$this->__f__27db5edf40083c039fc73cf2a14c48d4($forum,$topic,$post_data,$displayData)."	") : ("")) . "
</ul>
<script type='text/javascript'>
...
" . (($this->settings['reputation_enabled'] && $this->settings['reputation_point_types'] != 'like' && $this->settings['reputation_show_content'] && $this->memberData['member_id'] != 0 && is_array($this->caches['reputation_levels'])) ? ("<ul id='rep_filter_menucontent' class='ipbmenu_content with_checks' style='display: none'>
		...
		" . ((is_array($this->caches['reputation_levels'])) ? ("
			".$this->__f__6280e4d5dbcbc977432d8988c064faa1($forum,$topic,$post_data,$displayData)."		") : ("")) . "
	</ul>
	<script type='text/javascript'>
...
" . ((is_array( $post_data ) AND count( $post_data )) ? ("
	<div class='ipsBox'>
		<div class='ipsBox_container' id='ips_Posts'>
			".$this->__f__2cd7748d82345fae7b8f69567621d3b8($forum,$topic,$post_data,$displayData)."		</div>
	</div>
") : ("")) . "
<hr />
...
<!--hook.if.skin_topic.topicViewTemplate.fastReply.pre.startif-->" . (($displayData['fast_reply'] && $displayData['reply_button']['url']) ? ("<hr />
...
" . ((!$forum['disable_sharelinks'] AND $this->settings['sl_enable']) ? ("
	...
	<br />
") : ("")) . "<!--hook.if.skin_topic.topicViewTemplate.canShare.post.endif-->
<!-- SAME TAGGED -->
" . ((is_array( $displayData['same_tagged'] ) and count( $displayData['same_tagged'] )) ? ("
	...
	<div class='ipsBox'>
		...
		<div class='ipsBox_container'>
			...
			".$this->__f__c8f00f1687e6660ed2534e4c2d581bb4($forum,$topic,$post_data,$displayData)."			</table>
		</div>
	</div>
") : ("")) . "
<!-- ACTIVE USERS -->
" . ((is_array( $displayData['active_users'] ) AND count( $displayData['active_users'] )) ? ("<div id='topic_stats' class='statistics clear clearfix'>
		<div id='topic_active_users' class='active_users'>
			...
			") : ("")) . "<!--hook.if.skin_topic.topicViewTemplate.auNames.post.endif-->
		</div>
	</div>") : ("")) . "<!--hook.if.skin_topic.topicViewTemplate.topicActiveUsers.post.endif-->
" . (($this->request['gopid']) ? ("
<script type='text/javascript'>
...
function __f__0a5ed1d0661fa833c7b019e86ee0e31d($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__27db5edf40083c039fc73cf2a14c48d4($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__6280e4d5dbcbc977432d8988c064faa1($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__2cd7748d82345fae7b8f69567621d3b8($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c8f00f1687e6660ed2534e4c2d581bb4($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;

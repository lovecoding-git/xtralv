...
{
$count_00e9c011c1d107c2b866ce3d5d852d4b = is_array($this->functionData['bbCodeEvent']) ? count($this->functionData['bbCodeEvent']) : 0;
$this->functionData['bbCodeEvent'][$count_00e9c011c1d107c2b866ce3d5d852d4b]['event'] = $event;
$this->functionData['bbCodeEvent'][$count_00e9c011c1d107c2b866ce3d5d852d4b]['type'] = $type;
$this->functionData['bbCodeEvent'][$count_00e9c011c1d107c2b866ce3d5d852d4b]['ends'] = $ends;
}
...
{
$count_64bacea2c6c6b9a456d11cc7513b7415 = is_array($this->functionData['boardIndexBirthdays']) ? count($this->functionData['boardIndexBirthdays']) : 0;
$this->functionData['boardIndexBirthdays'][$count_64bacea2c6c6b9a456d11cc7513b7415]['birthdays'] = $birthdays;
$this->functionData['boardIndexBirthdays'][$count_64bacea2c6c6b9a456d11cc7513b7415]['data'] = $data;
}
		...
		<div class='_sbcollapsable'>
			" . ((count( $birthdays )) ? ("
				<ul class='ipsList_withminiphoto'>
					".$this->__f__c0b1c42c5ff1a09ade4fb45947530415($birthdays,$data)."				</ul>
			") : ("
...
function __f__c0b1c42c5ff1a09ade4fb45947530415($birthdays, $data=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_43202fc8305c1ec2049d9a8535447be1 = is_array($this->functionData['boardIndexCalEvents']) ? count($this->functionData['boardIndexCalEvents']) : 0;
$this->functionData['boardIndexCalEvents'][$count_43202fc8305c1ec2049d9a8535447be1]['events'] = $events;
}
		...
		<div class='_sbcollapsable'>
			" . ((is_array( $events )) ? ("
				<ul itemscope itemtype=\"http://schema.org/Event\" class='ipsList_withminiphoto'>
					".$this->__f__d14117cdf177c060377613058a784de2($events)."				</ul>
			") : ("
...
function __f__d14117cdf177c060377613058a784de2($events)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c430bb4d278105bbc444b83ee3d3ece3 = is_array($this->functionData['cal_date_cell']) ? count($this->functionData['cal_date_cell']) : 0;
$this->functionData['cal_date_cell'][$count_c430bb4d278105bbc444b83ee3d3ece3]['day'] = $day;
$this->functionData['cal_date_cell'][$count_c430bb4d278105bbc444b83ee3d3ece3]['events'] = $events;
$this->functionData['cal_date_cell'][$count_c430bb4d278105bbc444b83ee3d3ece3]['cal_date_queued'] = $cal_date_queued;
$this->functionData['cal_date_cell'][$count_c430bb4d278105bbc444b83ee3d3ece3]['queued'] = $queued;
$this->functionData['cal_date_cell'][$count_c430bb4d278105bbc444b83ee3d3ece3]['js_id'] = $js_id;
}
$IPBHTML .= "<!--Day-->
...
{
$count_8e93d09edd0435a26ce4e85b0585fe43 = is_array($this->functionData['cal_date_cell_today']) ? count($this->functionData['cal_date_cell_today']) : 0;
$this->functionData['cal_date_cell_today'][$count_8e93d09edd0435a26ce4e85b0585fe43]['day'] = $day;
$this->functionData['cal_date_cell_today'][$count_8e93d09edd0435a26ce4e85b0585fe43]['events'] = $events;
$this->functionData['cal_date_cell_today'][$count_8e93d09edd0435a26ce4e85b0585fe43]['cal_date_queued'] = $cal_date_queued;
$this->functionData['cal_date_cell_today'][$count_8e93d09edd0435a26ce4e85b0585fe43]['queued'] = $queued;
$this->functionData['cal_date_cell_today'][$count_8e93d09edd0435a26ce4e85b0585fe43]['js_id'] = $js_id;
}
$IPBHTML .= "<!--Day-->
...
{
$count_598d3261803ea321f44176a9136f36d0 = is_array($this->functionData['cal_week_dayentry']) ? count($this->functionData['cal_week_dayentry']) : 0;
$this->functionData['cal_week_dayentry'][$count_598d3261803ea321f44176a9136f36d0]['wday'] = $wday;
$this->functionData['cal_week_dayentry'][$count_598d3261803ea321f44176a9136f36d0]['date'] = $date;
$this->functionData['cal_week_dayentry'][$count_598d3261803ea321f44176a9136f36d0]['month'] = $month;
$this->functionData['cal_week_dayentry'][$count_598d3261803ea321f44176a9136f36d0]['mid'] = $mid;
$this->functionData['cal_week_dayentry'][$count_598d3261803ea321f44176a9136f36d0]['year'] = $year;
$this->functionData['cal_week_dayentry'][$count_598d3261803ea321f44176a9136f36d0]['events'] = $events;
$this->functionData['cal_week_dayentry'][$count_598d3261803ea321f44176a9136f36d0]['queued'] = $queued;
}
...
{
$count_7098899d6289a9e6164e45b12bffe479 = is_array($this->functionData['calendar_likeSummaryContents']) ? count($this->functionData['calendar_likeSummaryContents']) : 0;
$this->functionData['calendar_likeSummaryContents'][$count_7098899d6289a9e6164e45b12bffe479]['data'] = $data;
$this->functionData['calendar_likeSummaryContents'][$count_7098899d6289a9e6164e45b12bffe479]['relId'] = $relId;
$this->functionData['calendar_likeSummaryContents'][$count_7098899d6289a9e6164e45b12bffe479]['opts'] = $opts;
}
...
{
$count_d947efd9a8bff135b3525cd1e7661d9b = is_array($this->functionData['calendarBirthdayList']) ? count($this->functionData['calendarBirthdayList']) : 0;
$this->functionData['calendarBirthdayList'][$count_d947efd9a8bff135b3525cd1e7661d9b]['rows'] = $rows;
}
$IPBHTML .= "<h2 class='ipsType_subtitle'>{$this->lang->words['celebrating_bday']}</h2>
<br />
" . ((is_array( $rows ) and count( $rows )) ? ("
	".$this->__f__fbab428d82ff178bccf617935834cef9($rows)."") : ("
	<br />
...
function __f__fbab428d82ff178bccf617935834cef9($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_23a8d606c7d0f97f0362c40f5fbbd4c9 = is_array($this->functionData['calendarEventForm']) ? count($this->functionData['calendarEventForm']) : 0;
$this->functionData['calendarEventForm'][$count_23a8d606c7d0f97f0362c40f5fbbd4c9]['data'] = $data;
}
...
{
$count_e2e0758b8bac3b719fd05d1df367ab51 = is_array($this->functionData['calendarEventsList']) ? count($this->functionData['calendarEventsList']) : 0;
$this->functionData['calendarEventsList'][$count_e2e0758b8bac3b719fd05d1df367ab51]['data'] = $data;
}
...
{
$count_f5f6cc707004eace77b16d3f3a832328 = is_array($this->functionData['calendarJump']) ? count($this->functionData['calendarJump']) : 0;
$this->functionData['calendarJump'][$count_f5f6cc707004eace77b16d3f3a832328]['calendars'] = $calendars;
$this->functionData['calendarJump'][$count_f5f6cc707004eace77b16d3f3a832328]['calendar'] = $calendar;
$this->functionData['calendarJump'][$count_f5f6cc707004eace77b16d3f3a832328]['chosen_date'] = $chosen_date;
}
$IPBHTML .= "" . ((is_array( $calendars ) && count( $calendars ) > 1) ? ("
	...
	<ul class='ipbmenu_content' style='display: none' id='calendar_chooser_menucontent'>
		".$this->__f__adfb163349da677ad7400c6e74bdc894($calendars,$calendar,$chosen_date)."	</ul>
	<script type='text/javascript'>
...
function __f__adfb163349da677ad7400c6e74bdc894($calendars, $calendar, $chosen_date=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c4369f04789dc1e9ff81568e726ba71c = is_array($this->functionData['calendarMainContent']) ? count($this->functionData['calendarMainContent']) : 0;
$this->functionData['calendarMainContent'][$count_c4369f04789dc1e9ff81568e726ba71c]['data'] = $data;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("calendar", "0" ) . "
<script type='text/javascript'>
	ipb.vars['month_url'] = \"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&module=calendar&section=view&cal_id={$data['calendar']['cal_id']}", "public",'' ), "", "" ) . "\";
...
<div class='ipsBox'>
	<div class='ipsBox_container'>
		<table id='calendar_table' class='ipsCalendar ipb_table vcalendar' summary=\"{$this->lang->words['calendar_for']} {$data['month_title']} {$data['chosen_date']['year']}\">
			<tr class='header'>
				".$this->__f__8beb2d3201094e50afeb4556a6bb9719($data)."				{$data['events']}
			</tr>
		</table>
	</div>
</div>
...
function __f__8beb2d3201094e50afeb4556a6bb9719($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_7fb659dc7e96ae5da0c224f4283f2747 = is_array($this->functionData['calendarWeekView']) ? count($this->functionData['calendarWeekView']) : 0;
$this->functionData['calendarWeekView'][$count_7fb659dc7e96ae5da0c224f4283f2747]['data'] = $data;
}
$IPBHTML .= "" . $this->registry->getClass('output')->addJSModule("calendar", "0" ) . "
<script type='text/javascript'>
	ipb.vars['month_url'] = \"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=calendar&module=calendar&section=view&cal_id={$data['calendar']['cal_id']}", "public",'' ), "", "" ) . "\";
...
{
$count_96d0f75f839ce11404162d9a86af30d1 = is_array($this->functionData['calEventFollowedWrapper']) ? count($this->functionData['calEventFollowedWrapper']) : 0;
$this->functionData['calEventFollowedWrapper'][$count_96d0f75f839ce11404162d9a86af30d1]['rows'] = $rows;
}
...
$IPBHTML .= "<div id='search_results'>
	<ol>
		" . ((is_array($rows) && count($rows)) ? ("
			".$this->__f__535120cb67a33510e5a6c178931f5eec($rows)."		") : ("")) . "
	</ol>
</div>";
return $IPBHTML;
}
...
function __f__535120cb67a33510e5a6c178931f5eec($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_e7cfa7bf6b748da2d827cfb81a070fe5 = is_array($this->functionData['calEventSearchResult']) ? count($this->functionData['calEventSearchResult']) : 0;
$this->functionData['calEventSearchResult'][$count_e7cfa7bf6b748da2d827cfb81a070fe5]['r'] = $r;
$this->functionData['calEventSearchResult'][$count_e7cfa7bf6b748da2d827cfb81a070fe5]['resultAsTitle'] = $resultAsTitle;
$this->functionData['calEventSearchResult'][$count_e7cfa7bf6b748da2d827cfb81a070fe5]['type'] = $type;
$this->functionData['calEventSearchResult'][$count_e7cfa7bf6b748da2d827cfb81a070fe5]['ends'] = $ends;
}
...
{
$count_d4a6c5ced9766533bfccca23602639dc = is_array($this->functionData['event_likeSummaryContents']) ? count($this->functionData['event_likeSummaryContents']) : 0;
$this->functionData['event_likeSummaryContents'][$count_d4a6c5ced9766533bfccca23602639dc]['data'] = $data;
$this->functionData['event_likeSummaryContents'][$count_d4a6c5ced9766533bfccca23602639dc]['relId'] = $relId;
$this->functionData['event_likeSummaryContents'][$count_d4a6c5ced9766533bfccca23602639dc]['opts'] = $opts;
}
$IPBHTML .= "<span class='ipsButton_extra right " . (($data['totalCount']) ? ("_fmore clickable") : ("")) . "' title='" . sprintf( $this->lang->words['like_totalcount_' . $data['vernacular'] ], $data['totalCount'] ) . "' data-tooltip=\"" . sprintf( $this->lang->words['like_totalcount_' . $data['vernacular'] ], $data['totalCount'] ) . "\"><img src='{$this->settings['img_url']}/icon_users.png' /> <strong>{$data['totalCount']}</strong></span>
" . (($this->memberData['member_id']) ? ("<a href='#' title=\"" . (($data['iLike']) ? ("" . sprintf( $this->lang->words['fave_tt_on'], $this->lang->words['like_ucfirst_un' . $data['vernacular'] ]) . "") : ("" . sprintf( $this->lang->words['fave_tt_off'], $this->lang->words['like_ucfirst_' . $data['vernacular'] ]) . "")) . "\" class='ftoggle ipsButton_secondary'>" . (($data['iLike']) ? ("" . sprintf( $this->lang->words['unset_fave_button'], $this->lang->words['like_ucfirst_un' . $data['vernacular'] ]) . "") : ("" . sprintf( $this->lang->words['set_fave_button'], $this->lang->words['like_ucfirst_' . $data['vernacular'] ]) . "")) . "</a>") : ("")) . "";
return $IPBHTML;
...
{
$count_9b10ddbdd0f8952f14c80108e5520e5f = is_array($this->functionData['eventAttendee']) ? count($this->functionData['eventAttendee']) : 0;
$this->functionData['eventAttendee'][$count_9b10ddbdd0f8952f14c80108e5520e5f]['member'] = $member;
$this->functionData['eventAttendee'][$count_9b10ddbdd0f8952f14c80108e5520e5f]['event'] = $event;
}
...
{
$count_71e95c78b6e07ef4a87e7fda56a9b7ed = is_array($this->functionData['followedContentCalendars']) ? count($this->functionData['followedContentCalendars']) : 0;
$this->functionData['followedContentCalendars'][$count_71e95c78b6e07ef4a87e7fda56a9b7ed]['rows'] = $rows;
}
$IPBHTML .= "<div id='search_results'>
	<ol>
		".$this->__f__26b73d6c9a0e280bef09f19ef2dd1a6a($rows)."	</ol>
</div>";
return $IPBHTML;
}


function __f__26b73d6c9a0e280bef09f19ef2dd1a6a($rows)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $r )
...
{
$count_d66f0f635ee0dcd9d67691b36e8c7224 = is_array($this->functionData['mini_cal_date_cell']) ? count($this->functionData['mini_cal_date_cell']) : 0;
$this->functionData['mini_cal_date_cell'][$count_d66f0f635ee0dcd9d67691b36e8c7224]['day'] = $day;
}
$IPBHTML .= "<td>
...
{
$count_37525df557cb9e8ed5ac419618f8a8d5 = is_array($this->functionData['mini_cal_date_cell_today']) ? count($this->functionData['mini_cal_date_cell_today']) : 0;
$this->functionData['mini_cal_date_cell_today'][$count_37525df557cb9e8ed5ac419618f8a8d5]['day'] = $day;
}
...
{
$count_00ee3e2e1c3f0effd79dab310700904b = is_array($this->functionData['miniCalendarWrapper']) ? count($this->functionData['miniCalendarWrapper']) : 0;
$this->functionData['miniCalendarWrapper'][$count_00ee3e2e1c3f0effd79dab310700904b]['data'] = $data;
}
$IPBHTML .= "<div class='mini_cal_wrap ipsBox'>
	<div class='ipsBox_container'>
		...
		<table class='mini_cal vcalendar'>
			<tr>
				".$this->__f__83c2a09afc3a877cc688a91abef9b935($data)."			
				{$data['events']}
			</tr>
		</table>
	</div>
...
function __f__83c2a09afc3a877cc688a91abef9b935($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data['day_words'] as $day )
...
{
$count_0f8dfcd71b4e7fd1c57e2aabff464ba1 = is_array($this->functionData['modEventsWrapper']) ? count($this->functionData['modEventsWrapper']) : 0;
$this->functionData['modEventsWrapper'][$count_0f8dfcd71b4e7fd1c57e2aabff464ba1]['events'] = $events;
$this->functionData['modEventsWrapper'][$count_0f8dfcd71b4e7fd1c57e2aabff464ba1]['pages'] = $pages;
}
...
<div class='clearfix'>
	" . ((count($events)) ? ("
		".$this->__f__b205dc661a74c9033e4f10280b0e5c08($events,$pages)."	") : ("
...
function __f__b205dc661a74c9033e4f10280b0e5c08($events, $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $events as $event )
...
{
$count_f899134aa89c4ed722e241df0187ed9d = is_array($this->functionData['showEvent']) ? count($this->functionData['showEvent']) : 0;
$this->functionData['showEvent'][$count_f899134aa89c4ed722e241df0187ed9d]['event'] = $event;
$this->functionData['showEvent'][$count_f899134aa89c4ed722e241df0187ed9d]['member'] = $member;
$this->functionData['showEvent'][$count_f899134aa89c4ed722e241df0187ed9d]['typeInfo'] = $typeInfo;
$this->functionData['showEvent'][$count_f899134aa89c4ed722e241df0187ed9d]['like'] = $like;
}
	...
	" . (($event['event_rsvp']) ? ("<div class='ipsBox_container ipsLayout_right'>
			<div id='event_rsvp' class='ipsPad'>
				...
				" . ((count($event['_rsvp_attendees_short'])) ? ("
					...
					".$this->__f__d75206b7d221b89f35b8c5c080700b8c($event,$member,$typeInfo,$like)."					</ul>
				") : ("
		...
		" . (($event['_rsvp_count'] > count( $event['_rsvp_attendees_short'] )) ? ("
			<div id='see_all_attendees_popup' style='display: none'>
				...
				<div class='fixed_inner'>
					...
					".$this->__f__e59ce7ba15881023389ccfe77067e42c($event,$member,$typeInfo,$like)."					</ul>
				</div>
			</div>
			<script type='text/javascript'>
...
function __f__d75206b7d221b89f35b8c5c080700b8c($event, $member, $typeInfo, $like='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e59ce7ba15881023389ccfe77067e42c($event, $member, $typeInfo, $like='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_3f347d5183a4270bb4893ff6cc0f326c = is_array($this->functionData['showEventSimple']) ? count($this->functionData['showEventSimple']) : 0;
$this->functionData['showEventSimple'][$count_3f347d5183a4270bb4893ff6cc0f326c]['event'] = $event;
}
		...
		<div class='post_body'>
			...
			" . (($event['event_rsvp']) ? ("<div class='rsvp'>
					" . ((count( $event['_rsvp_attendees'] )) ? ("
						...
						<div class='clearfix'>
							".$this->__f__0aea8d5785c6798f3aea1f9a0707acba($event)."						</div>
					") : ("
...
function __f__0aea8d5785c6798f3aea1f9a0707acba($event)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;

...
{
$count_127b27103ac3bf5e1d72e8b00269cd03 = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_127b27103ac3bf5e1d72e8b00269cd03]['r'] = $r;
$this->functionData['comment'][$count_127b27103ac3bf5e1d72e8b00269cd03]['parent'] = $parent;
$this->functionData['comment'][$count_127b27103ac3bf5e1d72e8b00269cd03]['settings'] = $settings;
}
...
{
$count_c8257fd9f2b5c3822c89070255398e05 = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_c8257fd9f2b5c3822c89070255398e05]['r'] = $r;
$this->functionData['commentHidden'][$count_c8257fd9f2b5c3822c89070255398e05]['parent'] = $parent;
$this->functionData['commentHidden'][$count_c8257fd9f2b5c3822c89070255398e05]['settings'] = $settings;
}
...
{
$count_1f239bbc20ed8520405bd50f20c35500 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_1f239bbc20ed8520405bd50f20c35500]['comments'] = $comments;
$this->functionData['commentsList'][$count_1f239bbc20ed8520405bd50f20c35500]['settings'] = $settings;
$this->functionData['commentsList'][$count_1f239bbc20ed8520405bd50f20c35500]['pages'] = $pages;
$this->functionData['commentsList'][$count_1f239bbc20ed8520405bd50f20c35500]['parent'] = $parent;
$this->functionData['commentsList'][$count_1f239bbc20ed8520405bd50f20c35500]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__91a2dda57c0611dc702486cacd565339($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($pages) ? ("
	<div class='topic_controls'>
		{$pages}
	</div>
...
function __f__91a2dda57c0611dc702486cacd565339($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_855e7550327169aa81f9410bc4c40dd8 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_855e7550327169aa81f9410bc4c40dd8]['comment'] = $comment;
$this->functionData['form'][$count_855e7550327169aa81f9410bc4c40dd8]['parent'] = $parent;
$this->functionData['form'][$count_855e7550327169aa81f9410bc4c40dd8]['editor'] = $editor;
$this->functionData['form'][$count_855e7550327169aa81f9410bc4c40dd8]['settings'] = $settings;
$this->functionData['form'][$count_855e7550327169aa81f9410bc4c40dd8]['errors'] = $errors;
$this->functionData['form'][$count_855e7550327169aa81f9410bc4c40dd8]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("

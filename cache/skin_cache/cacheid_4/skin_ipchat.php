...
class skin_ipchat_4 extends skinMaster{
...
{
$count_795e2126107ed17f77b8035183616d58 = is_array($this->functionData['ajaxNewUser']) ? count($this->functionData['ajaxNewUser']) : 0;
$this->functionData['ajaxNewUser'][$count_795e2126107ed17f77b8035183616d58]['data'] = $data;
}
...
{
$count_29ea368dfc93ad0c707878d37fb55149 = is_array($this->functionData['chatRoom']) ? count($this->functionData['chatRoom']) : 0;
$this->functionData['chatRoom'][$count_29ea368dfc93ad0c707878d37fb55149]['options'] = $options;
$this->functionData['chatRoom'][$count_29ea368dfc93ad0c707878d37fb55149]['chatters'] = $chatters;
}
...
<script type='text/javascript'>
	...
	".$this->__f__1a0046c0ab45fb232f7f80a41518e3a7($options,$chatters)."	// Ignore private chats from..
	".$this->__f__535b5144af2ac30e2c7e45c9430d2f73($options,$chatters)."	" . ((isset( $this->memberData['_ignoredUsers'] ) AND count( $this->memberData['_ignoredUsers'] )) ? ("
		".$this->__f__37f6f785b18564e3d0fb997f1ba16019($options,$chatters)."	") : ("")) . "
	
	// Badwords
	" . ((is_array($this->caches['badwords']) AND count($this->caches['badwords'])) ? ("
		".$this->__f__576ec8f4fa0ee69704ab86a2c8d25a4d($options,$chatters)."	") : ("")) . "
	
	// Groups
	".$this->__f__e3fe028efc11f27bc303b5c5778307df($options,$chatters)."</script>
	...
	<div class='ipsBox_container ipsLayout_right ipsPostForm_sidebar'>
		...
		<div class='ipsPad' id='chatters-online-wrap'>
			<ul id='chatters-online'>
				".$this->__f__7ec19ea6abef8c6b4bf223997b38a72c($options,$chatters)."			</ul>
		</div>
...
<div id='mod-menu-container'>
	".$this->__f__8e09c246d93b6bcdb8c7d51a59efd442($options,$chatters)."</div>
...
function __f__1a0046c0ab45fb232f7f80a41518e3a7($options=array(), $chatters=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__535b5144af2ac30e2c7e45c9430d2f73($options=array(), $chatters=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $chatters as $data )
...
function __f__37f6f785b18564e3d0fb997f1ba16019($options=array(), $chatters=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__576ec8f4fa0ee69704ab86a2c8d25a4d($options=array(), $chatters=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e3fe028efc11f27bc303b5c5778307df($options=array(), $chatters=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__7ec19ea6abef8c6b4bf223997b38a72c($options=array(), $chatters=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $chatters as $data )
...
function __f__8e09c246d93b6bcdb8c7d51a59efd442($options=array(), $chatters=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $chatters as $data )
...
{
$count_504c5d5fd003caf83a9870319b4303a6 = is_array($this->functionData['chatRules']) ? count($this->functionData['chatRules']) : 0;
$this->functionData['chatRules'][$count_504c5d5fd003caf83a9870319b4303a6]['rules'] = $rules;
}
...
{
$count_51be5209783c277b96a24f129d5cce97 = is_array($this->functionData['chatUnbanModcp']) ? count($this->functionData['chatUnbanModcp']) : 0;
$this->functionData['chatUnbanModcp'][$count_51be5209783c277b96a24f129d5cce97]['member'] = $member;
}

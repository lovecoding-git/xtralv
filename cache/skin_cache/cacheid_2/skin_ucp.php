...
{
$count_243f510a142856a5dc0cdeed5defc688 = is_array($this->functionData['coreAttachments']) ? count($this->functionData['coreAttachments']) : 0;
$this->functionData['coreAttachments'][$count_243f510a142856a5dc0cdeed5defc688]['info'] = $info;
$this->functionData['coreAttachments'][$count_243f510a142856a5dc0cdeed5defc688]['pages'] = $pages;
$this->functionData['coreAttachments'][$count_243f510a142856a5dc0cdeed5defc688]['attachments'] = $attachments;
}
...
$IPBHTML .= "<div class='row1'>	
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_user_attach']}\">
		<tr class='header'>
			...
			" . ((count($attachments)) ? ("
								".$this->__f__1477bda1ba218c983bd7d5fad28a68f3($info,$pages,$attachments)."			") : ("
				<tr>
...
function __f__1477bda1ba218c983bd7d5fad28a68f3($info="",$pages="",$attachments)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a9c973a26bca67cbcf9bd6a30712d6ee = is_array($this->functionData['displayNameForm']) ? count($this->functionData['displayNameForm']) : 0;
$this->functionData['displayNameForm'][$count_a9c973a26bca67cbcf9bd6a30712d6ee]['form'] = $form;
$this->functionData['displayNameForm'][$count_a9c973a26bca67cbcf9bd6a30712d6ee]['error'] = $error;
$this->functionData['displayNameForm'][$count_a9c973a26bca67cbcf9bd6a30712d6ee]['okmessage'] = $okmessage;
$this->functionData['displayNameForm'][$count_a9c973a26bca67cbcf9bd6a30712d6ee]['isFB'] = $isFB;
}
$IPBHTML .= "" . (($okmessage != "") ? ("
...
{
$count_c3be2e2ecdebf9d83a0b07d6f31e7fa4 = is_array($this->functionData['emailPasswordChangeForm']) ? count($this->functionData['emailPasswordChangeForm']) : 0;
$this->functionData['emailPasswordChangeForm'][$count_c3be2e2ecdebf9d83a0b07d6f31e7fa4]['txt'] = $txt;
$this->functionData['emailPasswordChangeForm'][$count_c3be2e2ecdebf9d83a0b07d6f31e7fa4]['_message'] = $_message;
$this->functionData['emailPasswordChangeForm'][$count_c3be2e2ecdebf9d83a0b07d6f31e7fa4]['isFB'] = $isFB;
}
...
{
$count_8ea82b7804e8e6408a139486f41f972e = is_array($this->functionData['field_entry']) ? count($this->functionData['field_entry']) : 0;
$this->functionData['field_entry'][$count_8ea82b7804e8e6408a139486f41f972e]['title'] = $title;
$this->functionData['field_entry'][$count_8ea82b7804e8e6408a139486f41f972e]['desc'] = $desc;
$this->functionData['field_entry'][$count_8ea82b7804e8e6408a139486f41f972e]['content'] = $content;
$this->functionData['field_entry'][$count_8ea82b7804e8e6408a139486f41f972e]['id'] = $id;
}
...
{
$count_0bd7eebd8916cca762fc24aaa3239462 = is_array($this->functionData['membersFacebookConnect']) ? count($this->functionData['membersFacebookConnect']) : 0;
$this->functionData['membersFacebookConnect'][$count_0bd7eebd8916cca762fc24aaa3239462]['fbuid'] = $fbuid;
$this->functionData['membersFacebookConnect'][$count_0bd7eebd8916cca762fc24aaa3239462]['fbUserData'] = $fbUserData;
$this->functionData['membersFacebookConnect'][$count_0bd7eebd8916cca762fc24aaa3239462]['linkedMemberData'] = $linkedMemberData;
$this->functionData['membersFacebookConnect'][$count_0bd7eebd8916cca762fc24aaa3239462]['perms'] = $perms;
}
...
{
$count_b73d8e32b710786c7697c75871320cb2 = is_array($this->functionData['membersIgnoredUsersForm']) ? count($this->functionData['membersIgnoredUsersForm']) : 0;
$this->functionData['membersIgnoredUsersForm'][$count_b73d8e32b710786c7697c75871320cb2]['members'] = $members;
$this->functionData['membersIgnoredUsersForm'][$count_b73d8e32b710786c7697c75871320cb2]['pagination'] = $pagination;
}
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_ignored_users']}\">
		<tr class='header'>
			...
			<th scope='col' width=\"10%\">&nbsp;</th>
				...
				".$this->__f__eba6e69639e9b85a53fdd9fd7a11c0e0($members,$pagination)."	</table>
    " . (($pagination) ? ("
	    <br />
	    {$pagination}
	    <br class='clear' />
...
function __f__eba6e69639e9b85a53fdd9fd7a11c0e0($members, $pagination)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8a0b57a4c14f3166ee94aa791f3f9794 = is_array($this->functionData['membersProfileForm']) ? count($this->functionData['membersProfileForm']) : 0;
$this->functionData['membersProfileForm'][$count_8a0b57a4c14f3166ee94aa791f3f9794]['custom_fields'] = $custom_fields;
$this->functionData['membersProfileForm'][$count_8a0b57a4c14f3166ee94aa791f3f9794]['group_titles'] = $group_titles;
$this->functionData['membersProfileForm'][$count_8a0b57a4c14f3166ee94aa791f3f9794]['day'] = $day;
$this->functionData['membersProfileForm'][$count_8a0b57a4c14f3166ee94aa791f3f9794]['mon'] = $mon;
$this->functionData['membersProfileForm'][$count_8a0b57a4c14f3166ee94aa791f3f9794]['year'] = $year;
$this->functionData['membersProfileForm'][$count_8a0b57a4c14f3166ee94aa791f3f9794]['amEditor'] = $amEditor;
$this->functionData['membersProfileForm'][$count_8a0b57a4c14f3166ee94aa791f3f9794]['times'] = $times;
}
	...
	<ul>
		...
		" . (($day AND $mon AND $year) ? ("
			<li class='field'>
				...
				<select name=\"month\">&nbsp;
					".$this->__f__ef4fa45ab95561dbdea9f167b528b2a9($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."				</select>			
				<select name=\"day\">&nbsp;
					".$this->__f__741c15c7d0933088f09dd21a31705199($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."				</select> 
				<select name=\"year\">&nbsp;
					".$this->__f__3a2b459cddec89546c91316b236149a9($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times)."				</select> <br />
...
function __f__ef4fa45ab95561dbdea9f167b528b2a9($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $mon as $m )
...
function __f__741c15c7d0933088f09dd21a31705199($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $day as $d )
...
function __f__3a2b459cddec89546c91316b236149a9($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $year as $y )
...
{
$count_2acfd3a3321eff951d02ab6f6afa82bb = is_array($this->functionData['membersSignatureForm']) ? count($this->functionData['membersSignatureForm']) : 0;
$this->functionData['membersSignatureForm'][$count_2acfd3a3321eff951d02ab6f6afa82bb]['editor_html'] = $editor_html;
$this->functionData['membersSignatureForm'][$count_2acfd3a3321eff951d02ab6f6afa82bb]['sig_restrictions'] = $sig_restrictions;
$this->functionData['membersSignatureForm'][$count_2acfd3a3321eff951d02ab6f6afa82bb]['signature'] = $signature;
}
...
{
$count_7ce9eae010a0266ff506fdd0b6f8cbf5 = is_array($this->functionData['notificationsForm']) ? count($this->functionData['notificationsForm']) : 0;
$this->functionData['notificationsForm'][$count_7ce9eae010a0266ff506fdd0b6f8cbf5]['config'] = $config;
$this->functionData['notificationsForm'][$count_7ce9eae010a0266ff506fdd0b6f8cbf5]['emailData'] = $emailData;
}
...
<fieldset class='row1'>
	<span class='desc'><strong>{$this->lang->words['notifications_info_acp']}</strong></span>
		...
		".$this->__f__b74c5aa7a618ee92f9121facdca422dc($config,$emailData)."		".$this->__f__f3977990a94226415a1dcdf2d0237a69($config,$emailData)."	</table>
</fieldset>";
return $IPBHTML;
}


function __f__c6265fceac8407ba2fd24946076130ad($config, $emailData,$groupKey='',$group='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b74c5aa7a618ee92f9121facdca422dc($config, $emailData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $this->notifyGroups as $groupKey => $group )
	{
		...
		$_ips___x_retval .= "
			...
			".$this->__f__c6265fceac8407ba2fd24946076130ad($config,$emailData,$groupKey,$group)."							
...
function __f__f3977990a94226415a1dcdf2d0237a69($config, $emailData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_d5d080cb9f03e67a83f7ba58f26b53a3 = is_array($this->functionData['notificationsLog']) ? count($this->functionData['notificationsLog']) : 0;
$this->functionData['notificationsLog'][$count_d5d080cb9f03e67a83f7ba58f26b53a3]['notifications'] = $notifications;
$this->functionData['notificationsLog'][$count_d5d080cb9f03e67a83f7ba58f26b53a3]['error'] = $error;
$this->functionData['notificationsLog'][$count_d5d080cb9f03e67a83f7ba58f26b53a3]['pages'] = $pages;
}
...
$IPBHTML .= "<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=usercp&amp;tab=core&amp;area=removeNotifications&amp;do=remove", "public",'' ), "", "" ) . "\" id=\"checkBoxForm\" method=\"post\">
	...
	<div class='master_list' id='notifications'>
		...
		") : ("" . (($this->request['confirm']) ? ("
			...
			") : ("")) . "")) . "
		".$this->__f__c7a07c21c132743ede7347cf03dc4d58($notifications,$error,$pages)."	</div>
	" . ((count($notifications)) ? ("
		<div class='submit'>
...
function __f__c7a07c21c132743ede7347cf03dc4d58($notifications, $error='', $pages='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;

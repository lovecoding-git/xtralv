...
{
$count_442b3a90c93951116739809a1193f594 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_442b3a90c93951116739809a1193f594]['data'] = $data;
}
...
{
$count_76681efce34bfb59e20c3e3f9f63e20e = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_76681efce34bfb59e20c3e3f9f63e20e]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_76681efce34bfb59e20c3e3f9f63e20e]['form'] = $form;
}
...
{
$count_f930d2c47990c356c4621e0da2998983 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_f930d2c47990c356c4621e0da2998983]['data'] = $data;
}
...
{
$count_03d3148be35cebe3c9a5d9b512681f6b = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_03d3148be35cebe3c9a5d9b512681f6b]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__4000ae6bcd50a406ae2eb25aeeb86040($posts)."") : ("")) . "
<p class='submit'>
...
function __f__4000ae6bcd50a406ae2eb25aeeb86040($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_907f1a52148e27087ba2afa4a2a44617 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_907f1a52148e27087ba2afa4a2a44617]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_907f1a52148e27087ba2afa4a2a44617]['type'] = $type;
$this->functionData['uploadForm'][$count_907f1a52148e27087ba2afa4a2a44617]['stats'] = $stats;
$this->functionData['uploadForm'][$count_907f1a52148e27087ba2afa4a2a44617]['id'] = $id;
$this->functionData['uploadForm'][$count_907f1a52148e27087ba2afa4a2a44617]['forum_id'] = $forum_id;
}

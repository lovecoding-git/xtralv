...
{
$count_500b7160b0e34401c8ac14aa034f121c = is_array($this->functionData['member_list_show']) ? count($this->functionData['member_list_show']) : 0;
$this->functionData['member_list_show'][$count_500b7160b0e34401c8ac14aa034f121c]['members'] = $members;
$this->functionData['member_list_show'][$count_500b7160b0e34401c8ac14aa034f121c]['pages'] = $pages;
$this->functionData['member_list_show'][$count_500b7160b0e34401c8ac14aa034f121c]['dropdowns'] = $dropdowns;
$this->functionData['member_list_show'][$count_500b7160b0e34401c8ac14aa034f121c]['defaults'] = $defaults;
$this->functionData['member_list_show'][$count_500b7160b0e34401c8ac14aa034f121c]['custom_fields'] = $custom_fields;
$this->functionData['member_list_show'][$count_500b7160b0e34401c8ac14aa034f121c]['url'] = $url;
}
...
<div id=\"filter-letters\">
		".$this->__f__55390193216cd5c998edec22ee488528($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."</div>
</div>
	" . ((is_array( $members ) and count( $members )) ? ("
				".$this->__f__5deb0e56077d2eb9a95732531eb05bff($members,$pages,$dropdowns,$defaults,$custom_fields,$url)."	") : ("
...
function __f__55390193216cd5c998edec22ee488528($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5deb0e56077d2eb9a95732531eb05bff($members, $pages="", $dropdowns=array(), $defaults=array(), $custom_fields=null, $url='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;

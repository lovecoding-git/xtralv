...
class skin_printpage_2 extends skinMaster{
...
{
$count_dcb61c6105f8a29b41cb23420678456e = is_array($this->functionData['pp_end']) ? count($this->functionData['pp_end']) : 0;
}
$IPBHTML .= "<!--Copyright-->
...
{
$count_cb38feefb22461a9ff902fb246e3d6d4 = is_array($this->functionData['pp_postentry']) ? count($this->functionData['pp_postentry']) : 0;
$this->functionData['pp_postentry'][$count_cb38feefb22461a9ff902fb246e3d6d4]['poster'] = $poster;
$this->functionData['pp_postentry'][$count_cb38feefb22461a9ff902fb246e3d6d4]['entry'] = $entry;
}

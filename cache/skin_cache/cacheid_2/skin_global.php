...
{
$count_479e10513ab7ad944481e691aebb93eb = is_array($this->functionData['globalTemplate']) ? count($this->functionData['globalTemplate']) : 0;
$this->functionData['globalTemplate'][$count_479e10513ab7ad944481e691aebb93eb]['html'] = $html;
$this->functionData['globalTemplate'][$count_479e10513ab7ad944481e691aebb93eb]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplate'][$count_479e10513ab7ad944481e691aebb93eb]['css'] = $css;
$this->functionData['globalTemplate'][$count_479e10513ab7ad944481e691aebb93eb]['jsModules'] = $jsModules;
$this->functionData['globalTemplate'][$count_479e10513ab7ad944481e691aebb93eb]['metaTags'] = $metaTags;
$this->functionData['globalTemplate'][$count_479e10513ab7ad944481e691aebb93eb]['header_items'] = $header_items;
$this->functionData['globalTemplate'][$count_479e10513ab7ad944481e691aebb93eb]['items'] = $items;
$this->functionData['globalTemplate'][$count_479e10513ab7ad944481e691aebb93eb]['footer_items'] = $footer_items;
$this->functionData['globalTemplate'][$count_479e10513ab7ad944481e691aebb93eb]['stats'] = $stats;
}
						...
						<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "{$this->settings['query_string_formatted']}", "public",'' ), "", "" ) . "\" method=\"post\">
							<fieldset>
								...
								<select name=\"langid\" id='newLang'>
									".$this->__f__5f5d7ac50066fd21e01b179ed6084fe4($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								</select>
...
function __f__5f5d7ac50066fd21e01b179ed6084fe4($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_3b6ec65bbd15970fd84a8d731f432b51 = is_array($this->functionData['includeCSS']) ? count($this->functionData['includeCSS']) : 0;
$this->functionData['includeCSS'][$count_3b6ec65bbd15970fd84a8d731f432b51]['css'] = $css;
}

$this->minify = array();
$IPBHTML .= "" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
	".$this->__f__c38e14684824779d14bcb4e59999e7ad($css)."	" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
...
" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
	".$this->__f__c378ed2ed71dbc546664d8dd8152ffed($css)."") : ("")) . "";
return $IPBHTML;
}


function __f__c38e14684824779d14bcb4e59999e7ad($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c378ed2ed71dbc546664d8dd8152ffed($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a688d16dca48af4188758c646205dad3 = is_array($this->functionData['includeFeeds']) ? count($this->functionData['includeFeeds']) : 0;
$this->functionData['includeFeeds'][$count_a688d16dca48af4188758c646205dad3]['documentHeadItems'] = $documentHeadItems;
}
$IPBHTML .= "" . ((count($documentHeadItems)) ? ("
	".$this->__f__e6aee932785e7a09c7670d17ab9d1f3c($documentHeadItems)."") : ("")) . "";
return $IPBHTML;
}


function __f__1c0356ac2f59f496ef4c4ccccce02425($documentHeadItems,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e6aee932785e7a09c7670d17ab9d1f3c($documentHeadItems)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__1c0356ac2f59f496ef4c4ccccce02425($documentHeadItems,$type,$idx)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_a6823694c4aae16b3c74af52c88aa031 = is_array($this->functionData['includeJS']) ? count($this->functionData['includeJS']) : 0;
$this->functionData['includeJS'][$count_a6823694c4aae16b3c74af52c88aa031]['jsModules'] = $jsModules;
}
...
{
$count_9a4ec7be343166c469a5ef3726059135 = is_array($this->functionData['includeMeta']) ? count($this->functionData['includeMeta']) : 0;
$this->functionData['includeMeta'][$count_9a4ec7be343166c469a5ef3726059135]['metaTags'] = $metaTags;
}
$IPBHTML .= "" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
	".$this->__f__3b3ea948ba56ac585092bbba09ff1b94($metaTags)."") : ("")) . "
<meta property=\"og:image\" content=\"{$this->settings['meta_imagesrc']}\"/>";
return $IPBHTML;
}


function __f__4f83254859ef4cb0146a7d0272ccec78($metaTags,$tag='',$id='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__3b3ea948ba56ac585092bbba09ff1b94($metaTags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $metaTags as $tag => $id )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__4f83254859ef4cb0146a7d0272ccec78($metaTags,$tag,$id)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_69eb9d6348edb27a2acc20d7d0de7e1a = is_array($this->functionData['includeRTL']) ? count($this->functionData['includeRTL']) : 0;
}

$this->isRtlLang	= false;
$IPBHTML .= "".$this->__f__7f86794a8f55d3e9ea58dcf7b086a505()."<script type='text/javascript'>
	var isRTL	= false;
	var rtlIe	= '';
	var rtlFull	= '';
</script>
...
function __f__7f86794a8f55d3e9ea58dcf7b086a505()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_2353eb435e75816289c80dd18715b43c = is_array($this->functionData['nextPreviousTemplate']) ? count($this->functionData['nextPreviousTemplate']) : 0;
$this->functionData['nextPreviousTemplate'][$count_2353eb435e75816289c80dd18715b43c]['data'] = $data;
}
...
{
$count_80517a948217316773553157591d2272 = is_array($this->functionData['paginationTemplate']) ? count($this->functionData['paginationTemplate']) : 0;
$this->functionData['paginationTemplate'][$count_80517a948217316773553157591d2272]['work'] = $work;
$this->functionData['paginationTemplate'][$count_80517a948217316773553157591d2272]['data'] = $data;
}
...
$IPBHTML = "";
$IPBHTML .= "<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=search&amp;do=search", "preferHttps",'' ), "", "" ) . "\" method=\"post\" id='search-box' >
...
{
$count_a533b0c9a85ee441301b0a25baef9e5c = is_array($this->functionData['userHoverCard']) ? count($this->functionData['userHoverCard']) : 0;
$this->functionData['userHoverCard'][$count_a533b0c9a85ee441301b0a25baef9e5c]['member'] = $member;
}
...
{
$count_d5cba35952c749526fbc0fb21a39761f = is_array($this->functionData['userInfoPane']) ? count($this->functionData['userInfoPane']) : 0;
$this->functionData['userInfoPane'][$count_d5cba35952c749526fbc0fb21a39761f]['author'] = $author;
$this->functionData['userInfoPane'][$count_d5cba35952c749526fbc0fb21a39761f]['contentid'] = $contentid;
$this->functionData['userInfoPane'][$count_d5cba35952c749526fbc0fb21a39761f]['options'] = $options;
}
$IPBHTML .= "<ul class='user_details'>
	...
	<ul class='user_fields'>
		...
		" . (($author['custom_fields'] != "") ? ("
			".$this->__f__b16b558a81c8eb661a7724facdb5b0cb($author,$contentid,$options)."		") : ("")) . "<!--hook.if.skin_global.userInfoPane.authorcfields.post.endif-->
	</ul>
...
function __f__5a23350143fc9992ee35c8392fa7eb2d($author, $contentid, $options,$group='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b16b558a81c8eb661a7724facdb5b0cb($author, $contentid, $options)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $author['custom_fields'] as $group => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__5a23350143fc9992ee35c8392fa7eb2d($author,$contentid,$options,$group,$data)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_a8bbaf186d303ff3639e9be553a4081f = is_array($this->functionData['userSmallPhoto']) ? count($this->functionData['userSmallPhoto']) : 0;
$this->functionData['userSmallPhoto'][$count_a8bbaf186d303ff3639e9be553a4081f]['member'] = $member;
}
...
{
$count_f997867f5dab8d78c5fe82d4e5dd4dde = is_array($this->functionData['warnDetails']) ? count($this->functionData['warnDetails']) : 0;
$this->functionData['warnDetails'][$count_f997867f5dab8d78c5fe82d4e5dd4dde]['warning'] = $warning;
$this->functionData['warnDetails'][$count_f997867f5dab8d78c5fe82d4e5dd4dde]['canSeeModNote'] = $canSeeModNote;
}
...
<div class='ipsBox'>
	<p class='message unspecific'>
		...
		") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
				...
				")) . "") : ("")) . "
			".$this->__f__0455f80ee8be5f04617a472e614dbb9e($warning,$canSeeModNote)."")) . "
	</p>
...
function __f__0455f80ee8be5f04617a472e614dbb9e($warning, $canSeeModNote)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;

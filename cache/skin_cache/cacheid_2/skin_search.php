...
{
$count_a5d3f75c9ba551b33e37f71cf516a460 = is_array($this->functionData['asForumPosts']) ? count($this->functionData['asForumPosts']) : 0;
$this->functionData['asForumPosts'][$count_a5d3f75c9ba551b33e37f71cf516a460]['data'] = $data;
}
$IPBHTML .= "<div class='row'>
	...
	{$this->lang->words['in']}
	".$this->__f__6a34b03989f77d2e633c9ec542a9fc16($data)."	
	" . ((isset( $data['pages'] ) AND is_array( $data['pages'] ) AND count( $data['pages'] )) ? ("
		<span class='mini_pagination'>
			".$this->__f__9a826893ced47a8c189135c6620aa935($data)."		</span>
	") : ("")) . "
	<br />
...
function __f__6a34b03989f77d2e633c9ec542a9fc16($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__9a826893ced47a8c189135c6620aa935($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8bf536d70ffaaaa088666f25af2388a4 = is_array($this->functionData['asForumTopics']) ? count($this->functionData['asForumTopics']) : 0;
$this->functionData['asForumTopics'][$count_8bf536d70ffaaaa088666f25af2388a4]['data'] = $data;
}
$IPBHTML .= "<div class='row touch-row " . ((!empty( $data['_unreadUrl'] )) ? ("unread") : ("")) . "' id=\"sr-{$data['type_id_2']}\">
	...
	<div class='rowContent'>
		...
		") : ("")) . "
		<div>
			" . ucfirst($this->lang->words['in']) . "".$this->__f__13a45303f3fab79d0138ca28d5e9043d($data)."		</div>
...
function __f__13a45303f3fab79d0138ca28d5e9043d($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $data['_forum_trail'] as $i => $f )
...
{
$count_ac88060a2f00c8bea5f88fba5165d224 = is_array($this->functionData['followData']) ? count($this->functionData['followData']) : 0;
$this->functionData['followData'][$count_ac88060a2f00c8bea5f88fba5165d224]['followData'] = $followData;
}
...
{
$count_eea88533981948645cd62f373ad455e6 = is_array($this->functionData['followedContentForumsWrapper']) ? count($this->functionData['followedContentForumsWrapper']) : 0;
$this->functionData['followedContentForumsWrapper'][$count_eea88533981948645cd62f373ad455e6]['results'] = $results;
}
$IPBHTML .= "" . ((count($results)) ? ("".$this->__f__1984b62e4a5c6f83afd86fac3f0529fa($results)."") : ("")) . "";
return $IPBHTML;
}


function __f__1984b62e4a5c6f83afd86fac3f0529fa($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_b5a48b52167517eaa345464d4d5b3336 = is_array($this->functionData['followedContentForumsWrapperForums']) ? count($this->functionData['followedContentForumsWrapperForums']) : 0;
$this->functionData['followedContentForumsWrapperForums'][$count_b5a48b52167517eaa345464d4d5b3336]['results'] = $results;
}
...
<div class='master_list'>
	".$this->__f__f723208d864b3a504e1b94e10b9c721c($results)."</div>";
return $IPBHTML;
}


function __f__f723208d864b3a504e1b94e10b9c721c($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9b1d52c4b4330970479a70ad9cf67365 = is_array($this->functionData['followedContentView']) ? count($this->functionData['followedContentView']) : 0;
$this->functionData['followedContentView'][$count_9b1d52c4b4330970479a70ad9cf67365]['results'] = $results;
$this->functionData['followedContentView'][$count_9b1d52c4b4330970479a70ad9cf67365]['pagination'] = $pagination;
$this->functionData['followedContentView'][$count_9b1d52c4b4330970479a70ad9cf67365]['total'] = $total;
$this->functionData['followedContentView'][$count_9b1d52c4b4330970479a70ad9cf67365]['error'] = $error;
$this->functionData['followedContentView'][$count_9b1d52c4b4330970479a70ad9cf67365]['contentTypes'] = $contentTypes;
}
$IPBHTML .= "" . (($pagination) ? ("
<div class='controls'>
...
<div class='master_list'>
	...
	<div class='ipsPad'>
		...
		".$this->__f__bf4e888ec73668df1d199e1fb0b0aad6($results,$pagination,$total,$error,$contentTypes)."		</ul>
	</div>
</div>
<div class='master_list'>
	...
	<div class='ipsPad'>
		<ul>
			".$this->__f__900b87e2d0c17e7e31f3c88ae0a0412b($results,$pagination,$total,$error,$contentTypes)."		</ul>
	</div>
</div>";
return $IPBHTML;
}
...
function __f__bf4e888ec73668df1d199e1fb0b0aad6($results, $pagination, $total, $error, $contentTypes)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__900b87e2d0c17e7e31f3c88ae0a0412b($results, $pagination, $total, $error, $contentTypes)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_6bbcd68011fdf80f7504c30f51e77896 = is_array($this->functionData['forumAdvancedSearchFilters']) ? count($this->functionData['forumAdvancedSearchFilters']) : 0;
$this->functionData['forumAdvancedSearchFilters'][$count_6bbcd68011fdf80f7504c30f51e77896]['forums'] = $forums;
$this->functionData['forumAdvancedSearchFilters'][$count_6bbcd68011fdf80f7504c30f51e77896]['archivedPostCount'] = $archivedPostCount;
$this->functionData['forumAdvancedSearchFilters'][$count_6bbcd68011fdf80f7504c30f51e77896]['topic'] = $topic;
}
...
{
$count_52c676c01f748008e69a14e5339550b5 = is_array($this->functionData['helpSearchResult']) ? count($this->functionData['helpSearchResult']) : 0;
$this->functionData['helpSearchResult'][$count_52c676c01f748008e69a14e5339550b5]['r'] = $r;
$this->functionData['helpSearchResult'][$count_52c676c01f748008e69a14e5339550b5]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_a6d47b7f7b253dce65c095d7bfce4165 = is_array($this->functionData['memberCommentsSearchResult']) ? count($this->functionData['memberCommentsSearchResult']) : 0;
$this->functionData['memberCommentsSearchResult'][$count_a6d47b7f7b253dce65c095d7bfce4165]['r'] = $r;
$this->functionData['memberCommentsSearchResult'][$count_a6d47b7f7b253dce65c095d7bfce4165]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_6c61b47f215c02fc0e39b124d400247b = is_array($this->functionData['newContentView']) ? count($this->functionData['newContentView']) : 0;
$this->functionData['newContentView'][$count_6c61b47f215c02fc0e39b124d400247b]['results'] = $results;
$this->functionData['newContentView'][$count_6c61b47f215c02fc0e39b124d400247b]['pagination'] = $pagination;
$this->functionData['newContentView'][$count_6c61b47f215c02fc0e39b124d400247b]['total'] = $total;
$this->functionData['newContentView'][$count_6c61b47f215c02fc0e39b124d400247b]['sortDropDown'] = $sortDropDown;
$this->functionData['newContentView'][$count_6c61b47f215c02fc0e39b124d400247b]['sortIn'] = $sortIn;
$this->functionData['newContentView'][$count_6c61b47f215c02fc0e39b124d400247b]['dateCutSet'] = $dateCutSet;
}
...
" . ((is_array($sortIn) AND count( $sortIn )) ? ("
	<div class='ipsFilterPane' id='filter_section_pane' style='display: none'>
		...
		<div>
			...
			<ul>
				".$this->__f__65ed09f240874a4a46cd7e0103a367b6($results,$pagination,$total,$sortDropDown,$sortIn,$dateCutSet)."			</ul>
		</div>
	</div>
") : ("")) . "
...
function __f__c9f057d5dbff2bf605084ff48f4f06a8($results, $pagination, $total, $sortDropDown, $sortIn, $dateCutSet=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $this->registry->getApplications() as $app )
...
function __f__65ed09f240874a4a46cd7e0103a367b6($results, $pagination, $total, $sortDropDown, $sortIn, $dateCutSet=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_5110a761337e467405c49a854c3a47fa = is_array($this->functionData['searchAdvancedForm']) ? count($this->functionData['searchAdvancedForm']) : 0;
$this->functionData['searchAdvancedForm'][$count_5110a761337e467405c49a854c3a47fa]['filters'] = $filters;
$this->functionData['searchAdvancedForm'][$count_5110a761337e467405c49a854c3a47fa]['msg'] = $msg;
$this->functionData['searchAdvancedForm'][$count_5110a761337e467405c49a854c3a47fa]['current_app'] = $current_app;
$this->functionData['searchAdvancedForm'][$count_5110a761337e467405c49a854c3a47fa]['removed_search_terms'] = $removed_search_terms;
$this->functionData['searchAdvancedForm'][$count_5110a761337e467405c49a854c3a47fa]['isFT'] = $isFT;
$this->functionData['searchAdvancedForm'][$count_5110a761337e467405c49a854c3a47fa]['canTag'] = $canTag;
}
...
<div class='master_list ipsForm_vertical'>
	...
	" . ((count($filters)) ? ("".$this->__f__14ff5e3f59e1fdfbe050625fb5e4046c($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag)."		") : ("")) . "
	<div class='submit'>
...
function __f__9b3302ec4cfe99f61678f7de43736c0b($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array(),$app='',$data='',$id='',$_data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__c5f11a4833fda6e2280dc6372884e2f6($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array(),$app='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
							<ul>
								<li>
									...
									".$this->__f__9b3302ec4cfe99f61678f7de43736c0b($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag,$app,$data,$id,$_data)."									</select>
...
function __f__dc86f9a27ec50c42a5c83fb44cb6c0f4($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array(),$app='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__14ff5e3f59e1fdfbe050625fb5e4046c($filters='', $msg='', $current_app, $removed_search_terms=array(), $isFT=false, $canTag=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
			" . (($app == 'forums') ? ("<div id='app_filter_{$app}'>
				...
				" . ((count($data['sortDropDown'])) ? ("" . ((is_array($data['sortDropIn']) AND count( $data['sortDropIn'] )) ? ("
						".$this->__f__c5f11a4833fda6e2280dc6372884e2f6($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag,$app,$data)."					") : ("<div class='ipsField'>
							...
							<select name='search_app_filters[$app][sortKey]' id='search_sort_by_{$app}' class='input_select' style='width:auto'>
								".$this->__f__dc86f9a27ec50c42a5c83fb44cb6c0f4($filters,$msg,$current_app,$removed_search_terms,$isFT,$canTag,$app,$data)."							</select>
...
{
$count_5831307394ec32245a05dcbebcc61290 = is_array($this->functionData['searchResults']) ? count($this->functionData['searchResults']) : 0;
$this->functionData['searchResults'][$count_5831307394ec32245a05dcbebcc61290]['results'] = $results;
$this->functionData['searchResults'][$count_5831307394ec32245a05dcbebcc61290]['titlesOnly'] = $titlesOnly;
}
...
$IPBHTML .= "<div id='search_results'>
	<ol>
		" . ((is_array($results) && count($results)) ? ("
			".$this->__f__7987086df53ce4315161a550362c40b2($results,$titlesOnly)."		") : ("")) . "
	</ol>
</div>";
return $IPBHTML;
}
...
function __f__7987086df53ce4315161a550362c40b2($results, $titlesOnly)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $results as $result )
...
{
$count_a29be71439e79fb256d4cbd134638a89 = is_array($this->functionData['searchResultsWrapper']) ? count($this->functionData['searchResultsWrapper']) : 0;
$this->functionData['searchResultsWrapper'][$count_a29be71439e79fb256d4cbd134638a89]['results'] = $results;
$this->functionData['searchResultsWrapper'][$count_a29be71439e79fb256d4cbd134638a89]['sortDropDown'] = $sortDropDown;
$this->functionData['searchResultsWrapper'][$count_a29be71439e79fb256d4cbd134638a89]['sortIn'] = $sortIn;
$this->functionData['searchResultsWrapper'][$count_a29be71439e79fb256d4cbd134638a89]['pagination'] = $pagination;
$this->functionData['searchResultsWrapper'][$count_a29be71439e79fb256d4cbd134638a89]['total'] = $total;
$this->functionData['searchResultsWrapper'][$count_a29be71439e79fb256d4cbd134638a89]['showing'] = $showing;
$this->functionData['searchResultsWrapper'][$count_a29be71439e79fb256d4cbd134638a89]['search_term'] = $search_term;
$this->functionData['searchResultsWrapper'][$count_a29be71439e79fb256d4cbd134638a89]['url_string'] = $url_string;
$this->functionData['searchResultsWrapper'][$count_a29be71439e79fb256d4cbd134638a89]['current_key'] = $current_key;
$this->functionData['searchResultsWrapper'][$count_a29be71439e79fb256d4cbd134638a89]['removed_search_terms'] = $removed_search_terms;
$this->functionData['searchResultsWrapper'][$count_a29be71439e79fb256d4cbd134638a89]['limited'] = $limited;
$this->functionData['searchResultsWrapper'][$count_a29be71439e79fb256d4cbd134638a89]['wasLimited'] = $wasLimited;
$this->functionData['searchResultsWrapper'][$count_a29be71439e79fb256d4cbd134638a89]['search_tags'] = $search_tags;
}
...
{
$count_b7c1099718c7cf00f1da57e3613ad2f8 = is_array($this->functionData['searchRowGenericFormat']) ? count($this->functionData['searchRowGenericFormat']) : 0;
$this->functionData['searchRowGenericFormat'][$count_b7c1099718c7cf00f1da57e3613ad2f8]['r'] = $r;
$this->functionData['searchRowGenericFormat'][$count_b7c1099718c7cf00f1da57e3613ad2f8]['resultAsTitle'] = $resultAsTitle;
}
$IPBHTML .= "<div class='result_info'>
...
{
$count_c36c65946c7d0532ec2b64837042686b = is_array($this->functionData['topicPostSearchResultAsForum']) ? count($this->functionData['topicPostSearchResultAsForum']) : 0;
$this->functionData['topicPostSearchResultAsForum'][$count_c36c65946c7d0532ec2b64837042686b]['data'] = $data;
$this->functionData['topicPostSearchResultAsForum'][$count_c36c65946c7d0532ec2b64837042686b]['resultAsTitle'] = $resultAsTitle;
}
...
{
$count_b876bea0d3494fea1c62245131ec80ad = is_array($this->functionData['userPostsView']) ? count($this->functionData['userPostsView']) : 0;
$this->functionData['userPostsView'][$count_b876bea0d3494fea1c62245131ec80ad]['results'] = $results;
$this->functionData['userPostsView'][$count_b876bea0d3494fea1c62245131ec80ad]['pagination'] = $pagination;
$this->functionData['userPostsView'][$count_b876bea0d3494fea1c62245131ec80ad]['total'] = $total;
$this->functionData['userPostsView'][$count_b876bea0d3494fea1c62245131ec80ad]['member'] = $member;
$this->functionData['userPostsView'][$count_b876bea0d3494fea1c62245131ec80ad]['limited'] = $limited;
$this->functionData['userPostsView'][$count_b876bea0d3494fea1c62245131ec80ad]['wasLimited'] = $wasLimited;
$this->functionData['userPostsView'][$count_b876bea0d3494fea1c62245131ec80ad]['beginTime'] = $beginTime;
$this->functionData['userPostsView'][$count_b876bea0d3494fea1c62245131ec80ad]['sortIn'] = $sortIn;
$this->functionData['userPostsView'][$count_b876bea0d3494fea1c62245131ec80ad]['sortDropDown'] = $sortDropDown;
}

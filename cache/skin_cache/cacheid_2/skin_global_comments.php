...
{
$count_0101b9455b78b60e24549ef137036193 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_0101b9455b78b60e24549ef137036193]['comments'] = $comments;
$this->functionData['commentsList'][$count_0101b9455b78b60e24549ef137036193]['settings'] = $settings;
$this->functionData['commentsList'][$count_0101b9455b78b60e24549ef137036193]['pages'] = $pages;
$this->functionData['commentsList'][$count_0101b9455b78b60e24549ef137036193]['parent'] = $parent;
$this->functionData['commentsList'][$count_0101b9455b78b60e24549ef137036193]['preReply'] = $preReply;
}
...
<div class='comment_wrap' id='comment_wrap'>
	".$this->__f__d800811799a6cbf8bfb5296e01ecd7dc($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($parent['_canComment']) ? ("
...
function __f__d800811799a6cbf8bfb5296e01ecd7dc($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c95a13ba8d98096b5d4f2a6616493db0 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_c95a13ba8d98096b5d4f2a6616493db0]['comment'] = $comment;
$this->functionData['form'][$count_c95a13ba8d98096b5d4f2a6616493db0]['parent'] = $parent;
$this->functionData['form'][$count_c95a13ba8d98096b5d4f2a6616493db0]['editor'] = $editor;
$this->functionData['form'][$count_c95a13ba8d98096b5d4f2a6616493db0]['settings'] = $settings;
$this->functionData['form'][$count_c95a13ba8d98096b5d4f2a6616493db0]['errors'] = $errors;
$this->functionData['form'][$count_c95a13ba8d98096b5d4f2a6616493db0]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("

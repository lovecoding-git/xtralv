...
{
$count_f3dafb37e812a68348fe47f9755f6759 = is_array($this->functionData['acknowledgeWarning']) ? count($this->functionData['acknowledgeWarning']) : 0;
$this->functionData['acknowledgeWarning'][$count_f3dafb37e812a68348fe47f9755f6759]['warning'] = $warning;
}
	...
	<div class='master_list'>
		...
		<div class='row'>
			...
			") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
					...
					")) . "") : ("")) . "
				".$this->__f__b9846d6d0bce4219100142e47639dea2($warning)."")) . "
		</div>
	</div>
	" . (($this->settings['warnings_acknowledge'] and !$warning['wl_acknowledged']) ? ("
		<div class='controls'>
...
function __f__b9846d6d0bce4219100142e47639dea2($warning)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a068a8109dd9785ba1d7054cc8da9643 = is_array($this->functionData['addWarning']) ? count($this->functionData['addWarning']) : 0;
$this->functionData['addWarning'][$count_a068a8109dd9785ba1d7054cc8da9643]['member'] = $member;
$this->functionData['addWarning'][$count_a068a8109dd9785ba1d7054cc8da9643]['reasons'] = $reasons;
$this->functionData['addWarning'][$count_a068a8109dd9785ba1d7054cc8da9643]['errors'] = $errors;
$this->functionData['addWarning'][$count_a068a8109dd9785ba1d7054cc8da9643]['editor'] = $editor;
$this->functionData['addWarning'][$count_a068a8109dd9785ba1d7054cc8da9643]['currentPunishments'] = $currentPunishments;
}
			...
			<ul class='ipsForm ipsForm_vertical'>
				<li class='ipsField ipsField_select'>
					...
					<div class='ipsField_content'>
						<select name='reason' id='reason-select'>
							...
							".$this->__f__ec9a21e7a6fa7d087e3b068a27894f2b($member,$reasons,$errors,$editor,$currentPunishments)."							" . (($this->settings['warnings_enable_other'] or $this->memberData['g_access_cp']) ? ("
				...
				<li class='ipsField' style='display:none' id='suspend_li'>
					...
					<div class='ipsField_content'>
						...
						".$this->__f__08500f23aaf7a228f9a6837df3881f57($member,$reasons,$errors,$editor,$currentPunishments)."						</select>
					</div>
				</li>
...
function __f__ec9a21e7a6fa7d087e3b068a27894f2b($member, $reasons, $errors, $editor, $currentPunishments)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__08500f23aaf7a228f9a6837df3881f57($member, $reasons, $errors, $editor, $currentPunishments)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_7922775392bb340764da506ba64445bd = is_array($this->functionData['customField__gender']) ? count($this->functionData['customField__gender']) : 0;
$this->functionData['customField__gender'][$count_7922775392bb340764da506ba64445bd]['f'] = $f;
}
...
{
$count_d70ce4cc3c410a49e1e31a5b727c580f = is_array($this->functionData['customField__generic']) ? count($this->functionData['customField__generic']) : 0;
$this->functionData['customField__generic'][$count_d70ce4cc3c410a49e1e31a5b727c580f]['f'] = $f;
}
...
{
$count_0dbc58c58708739a7ecbc0a7e9e4124b = is_array($this->functionData['customFieldGroup__contact']) ? count($this->functionData['customFieldGroup__contact']) : 0;
$this->functionData['customFieldGroup__contact'][$count_0dbc58c58708739a7ecbc0a7e9e4124b]['f'] = $f;
}
$IPBHTML .= "" . (($f->parsed) ? ("<dt>{$f->raw_data['pf_title']}:</dt>
<dd>
	" . (($f->raw_data['pf_icon']) ? ("<img src='{$this->settings['public_dir']}{$f->raw_data['pf_icon']}' alt='{$f->raw_data['pf_title']}' />&nbsp;") : ("")) . "
	" . ((is_array( $f->parsed )) ? ("
		".$this->__f__a465845a0ddd1b02d36a750d55eefba9($f)."	") : ("" . (($f->raw_data['pf_key'] == 'aim') ? ("
...
function __f__a465845a0ddd1b02d36a750d55eefba9($f)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_81ff8ebb0f210b32f1b18d5131270864 = is_array($this->functionData['customizeProfile']) ? count($this->functionData['customizeProfile']) : 0;
$this->functionData['customizeProfile'][$count_81ff8ebb0f210b32f1b18d5131270864]['member'] = $member;
}
...
{
$count_0bbc5f3c659b8b4d4262bf88e79a59da = is_array($this->functionData['dnameWrapper']) ? count($this->functionData['dnameWrapper']) : 0;
$this->functionData['dnameWrapper'][$count_0bbc5f3c659b8b4d4262bf88e79a59da]['member_name'] = $member_name;
$this->functionData['dnameWrapper'][$count_0bbc5f3c659b8b4d4262bf88e79a59da]['records'] = $records;
}
...
<table class='ipb_table'>
	...
	" . ((is_array($records) AND count($records)) ? ("
		    	".$this->__f__fe9420e7bd8262a1773e2ffcf1c11072($member_name,$records)."	") : ("
		<tr>
...
function __f__fe9420e7bd8262a1773e2ffcf1c11072($member_name="",$records=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4ea21c332369cee7aafab866f512e38a = is_array($this->functionData['explainPoints']) ? count($this->functionData['explainPoints']) : 0;
$this->functionData['explainPoints'][$count_4ea21c332369cee7aafab866f512e38a]['reasons'] = $reasons;
$this->functionData['explainPoints'][$count_4ea21c332369cee7aafab866f512e38a]['actions'] = $actions;
}
...
<table class='ipb_table'>
	...
	".$this->__f__e564812aa21b1ed119fa4404b60d52fa($reasons,$actions)."</table>
" . ((!empty( $actions )) ? ("
	<div class='ipsPad'>
	...
	<table class='ipb_table'>
		...
		".$this->__f__dcc63bfaead8e32aee663e2d7d1c2270($reasons,$actions)."	</table>
") : ("")) . "";
return $IPBHTML;
}


function __f__e564812aa21b1ed119fa4404b60d52fa($reasons, $actions)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $reasons as $r )
...
function __f__969233f761f70022a4f6c3ff60a5ab72($reasons, $actions,$a='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( array( 'mq', 'rpa', 'suspend' ) as $k )
...
function __f__dcc63bfaead8e32aee663e2d7d1c2270($reasons, $actions)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $actions as $a )
	{
		...
		$_ips___x_retval .= "
			<tr>
				<td>{$a['wa_points']}</td>
				<td>
					".$this->__f__969233f761f70022a4f6c3ff60a5ab72($reasons,$actions,$a)."				</td>
			</tr>
...
{
$count_a7b5c15edef7584c784198de79a8e14f = is_array($this->functionData['friendsList']) ? count($this->functionData['friendsList']) : 0;
$this->functionData['friendsList'][$count_a7b5c15edef7584c784198de79a8e14f]['friends'] = $friends;
$this->functionData['friendsList'][$count_a7b5c15edef7584c784198de79a8e14f]['pages'] = $pages;
}
...
" . ((is_array($friends) and count($friends) && $this->settings['friends_enabled']) ? ("
		<ul class='members'>
	".$this->__f__49219452845bfbd65409023eb56bb960($friends,$pages)."	</ul>
") : ("<p class='no_messages'>
		" . (($this->request['tab'] == 'pending') ? ("
...
function __f__49219452845bfbd65409023eb56bb960($friends, $pages)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_83e0dca82ac87716afcaae3da59a66fe = is_array($this->functionData['listWarnings']) ? count($this->functionData['listWarnings']) : 0;
$this->functionData['listWarnings'][$count_83e0dca82ac87716afcaae3da59a66fe]['member'] = $member;
$this->functionData['listWarnings'][$count_83e0dca82ac87716afcaae3da59a66fe]['warnings'] = $warnings;
$this->functionData['listWarnings'][$count_83e0dca82ac87716afcaae3da59a66fe]['pagination'] = $pagination;
$this->functionData['listWarnings'][$count_83e0dca82ac87716afcaae3da59a66fe]['reasons'] = $reasons;
$this->functionData['listWarnings'][$count_83e0dca82ac87716afcaae3da59a66fe]['canWarn'] = $canWarn;
}
...
") : ("
	<div class='ipsBox'>
		<div class='ipsBox_container'>
			<table class='ipb_table'>
				<tbody>
					".$this->__f__ac58e5d35d25d9d0ab7db4ca0babe79c($member,$warnings,$pagination,$reasons,$canWarn)."				</tbody>
			</table>
		</div>
	</div>
")) . "
...
function __f__ac58e5d35d25d9d0ab7db4ca0babe79c($member, $warnings, $pagination, $reasons, $canWarn)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_56b700c620c60054f0534d9203ee7299 = is_array($this->functionData['profileModern']) ? count($this->functionData['profileModern']) : 0;
$this->functionData['profileModern'][$count_56b700c620c60054f0534d9203ee7299]['tabs'] = $tabs;
$this->functionData['profileModern'][$count_56b700c620c60054f0534d9203ee7299]['member'] = $member;
$this->functionData['profileModern'][$count_56b700c620c60054f0534d9203ee7299]['visitors'] = $visitors;
$this->functionData['profileModern'][$count_56b700c620c60054f0534d9203ee7299]['default_tab'] = $default_tab;
$this->functionData['profileModern'][$count_56b700c620c60054f0534d9203ee7299]['default_tab_content'] = $default_tab_content;
$this->functionData['profileModern'][$count_56b700c620c60054f0534d9203ee7299]['friends'] = $friends;
$this->functionData['profileModern'][$count_56b700c620c60054f0534d9203ee7299]['status'] = $status;
$this->functionData['profileModern'][$count_56b700c620c60054f0534d9203ee7299]['warns'] = $warns;
}
$IPBHTML .= "<div class='master_list'>
...
{
$count_5cef1739e2bd02967698eda822acb543 = is_array($this->functionData['reputationPage']) ? count($this->functionData['reputationPage']) : 0;
$this->functionData['reputationPage'][$count_5cef1739e2bd02967698eda822acb543]['langBit'] = $langBit;
$this->functionData['reputationPage'][$count_5cef1739e2bd02967698eda822acb543]['currentApp'] = $currentApp;
$this->functionData['reputationPage'][$count_5cef1739e2bd02967698eda822acb543]['supportedApps'] = $supportedApps;
$this->functionData['reputationPage'][$count_5cef1739e2bd02967698eda822acb543]['processedResults'] = $processedResults;
}
	...
	" . ((count( $supportedApps ) > 1) ? ("
		<div class='maintitle ipsFilterbar clearfix'>
			<ul class='ipsList_inline ipsType_smaller left'>
				".$this->__f__5f85491d3ac03dc22b071c2b621c0824($langBit,$currentApp,$supportedApps,$processedResults)."			</ul>
		</div>
	") : ("")) . "
	" . (($processedResults) ? ("
		{$processedResults}
...
function __f__5f85491d3ac03dc22b071c2b621c0824($langBit, $currentApp='', $supportedApps=array(), $processedResults='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_5ac628393cf85d09e54a78f96beaa907 = is_array($this->functionData['showCard']) ? count($this->functionData['showCard']) : 0;
$this->functionData['showCard'][$count_5ac628393cf85d09e54a78f96beaa907]['member'] = $member;
$this->functionData['showCard'][$count_5ac628393cf85d09e54a78f96beaa907]['download'] = $download;
}
...
{
$count_7b55631631fb222814153a357aab81d5 = is_array($this->functionData['statusReplies']) ? count($this->functionData['statusReplies']) : 0;
$this->functionData['statusReplies'][$count_7b55631631fb222814153a357aab81d5]['replies'] = $replies;
$this->functionData['statusReplies'][$count_7b55631631fb222814153a357aab81d5]['no_wrapper'] = $no_wrapper;
}
$IPBHTML .= "".$this->__f__d58f5b61b126a8caf8c2de5068b22c02($replies,$no_wrapper)."";
return $IPBHTML;
}


function __f__d58f5b61b126a8caf8c2de5068b22c02($replies=array(), $no_wrapper=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_23d8546ae291251f1f7ff117f52ae214 = is_array($this->functionData['statusUpdates']) ? count($this->functionData['statusUpdates']) : 0;
$this->functionData['statusUpdates'][$count_23d8546ae291251f1f7ff117f52ae214]['updates'] = $updates;
$this->functionData['statusUpdates'][$count_23d8546ae291251f1f7ff117f52ae214]['smallSpace'] = $smallSpace;
$this->functionData['statusUpdates'][$count_23d8546ae291251f1f7ff117f52ae214]['latestOnly'] = $latestOnly;
}
$IPBHTML .= "".$this->__f__3b725196434ccf16bb3540f326f0e132($updates,$smallSpace,$latestOnly)."";
return $IPBHTML;
}


function __f__3b725196434ccf16bb3540f326f0e132($updates=array(), $smallSpace=0, $latestOnly=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_66c81cf370ce5c5510573cb49bb3a9b2 = is_array($this->functionData['statusUpdatesPage']) ? count($this->functionData['statusUpdatesPage']) : 0;
$this->functionData['statusUpdatesPage'][$count_66c81cf370ce5c5510573cb49bb3a9b2]['updates'] = $updates;
$this->functionData['statusUpdatesPage'][$count_66c81cf370ce5c5510573cb49bb3a9b2]['pages'] = $pages;
}
...
{
$count_f9a3ee6cb03fa69efa092e60992b2131 = is_array($this->functionData['tabFriends']) ? count($this->functionData['tabFriends']) : 0;
$this->functionData['tabFriends'][$count_f9a3ee6cb03fa69efa092e60992b2131]['friends'] = $friends;
$this->functionData['tabFriends'][$count_f9a3ee6cb03fa69efa092e60992b2131]['member'] = $member;
$this->functionData['tabFriends'][$count_f9a3ee6cb03fa69efa092e60992b2131]['pagination'] = $pagination;
}
$IPBHTML .= "<div class='general_box'>
	" . (($this->settings['friends_enabled'] AND $this->memberData['g_can_add_friends'] AND $member['pp_setting_count_friends']) ? ("<div class='friend_list clear' id='friend_list'>
			...
			" . ((is_array($friends) and count($friends)) ? ("
				<ul class='clearfix'>
				".$this->__f__404a5c8355a7e4b68ac038b6333e8936($friends,$member,$pagination)."				</ul>				
			") : ("
				<p>
...
function __f__404a5c8355a7e4b68ac038b6333e8936($friends=array(), $member=array(), $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $friends as $friend )
...
{
$count_2356cea350faf06285af0b51c3d41ed1 = is_array($this->functionData['tabReputation']) ? count($this->functionData['tabReputation']) : 0;
$this->functionData['tabReputation'][$count_2356cea350faf06285af0b51c3d41ed1]['member'] = $member;
$this->functionData['tabReputation'][$count_2356cea350faf06285af0b51c3d41ed1]['currentApp'] = $currentApp;
$this->functionData['tabReputation'][$count_2356cea350faf06285af0b51c3d41ed1]['type'] = $type;
$this->functionData['tabReputation'][$count_2356cea350faf06285af0b51c3d41ed1]['supportedApps'] = $supportedApps;
$this->functionData['tabReputation'][$count_2356cea350faf06285af0b51c3d41ed1]['processedResults'] = $processedResults;
$this->functionData['tabReputation'][$count_2356cea350faf06285af0b51c3d41ed1]['pagination'] = $pagination;
}
$IPBHTML .= "<div class='general_box'>
	<div class='maintitle ipsFilterbar clearfix'>
		" . ((count( $supportedApps ) > 1) ? ("
			<ul class='ipsList_inline ipsType_smaller left'>
				".$this->__f__ce5216fe3d0abce0860d05d6595c4054($member,$currentApp,$type,$supportedApps,$processedResults,$pagination)."			</ul>
		") : ("")) . "
...
function __f__ce5216fe3d0abce0860d05d6595c4054($member, $currentApp='', $type='', $supportedApps=array(), $processedResults='', $pagination='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $supportedApps as $_app )
...
{
$count_1d1d9747c2b8f2cebfe3c151bdf20dab = is_array($this->functionData['tabReputation_calendar']) ? count($this->functionData['tabReputation_calendar']) : 0;
$this->functionData['tabReputation_calendar'][$count_1d1d9747c2b8f2cebfe3c151bdf20dab]['results'] = $results;
}
$IPBHTML .= "<div class='ipsBox'>
	".$this->__f__64c6c7e0ddb00cf69997add4055e0abd($results)."</div>";
return $IPBHTML;
}


function __f__64c6c7e0ddb00cf69997add4055e0abd($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8ca2a641ab4a0d8e1f261964424df778 = is_array($this->functionData['tabReputation_posts']) ? count($this->functionData['tabReputation_posts']) : 0;
$this->functionData['tabReputation_posts'][$count_8ca2a641ab4a0d8e1f261964424df778]['results'] = $results;
}
$IPBHTML .= "<div class='ipsBox'>
	".$this->__f__5101ac8d3494737bf6d5fd0b236147da($results)."</div>";
return $IPBHTML;
}


function __f__1cd1a6e779cbf3b1b18c90c8b91367ad($results,$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5101ac8d3494737bf6d5fd0b236147da($results)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $results as $data )
			...
			<div class='post_wrap'>
				...
				<div class='post_body'>
					<p class='posted_info desc lighter ipsType_small'>
						...
						" . (($data['_forum_trail']) ? ("
							in
							".$this->__f__1cd1a6e779cbf3b1b18c90c8b91367ad($results,$data)."						") : ("")) . "
					</p>
					<div class='post entry-content clearfix'>
						{$data['post']}
						<br />
...
{
$count_dd2782801faadc711c549440194a7456 = is_array($this->functionData['tabSingleColumn']) ? count($this->functionData['tabSingleColumn']) : 0;
$this->functionData['tabSingleColumn'][$count_dd2782801faadc711c549440194a7456]['row'] = $row;
$this->functionData['tabSingleColumn'][$count_dd2782801faadc711c549440194a7456]['read_more_link'] = $read_more_link;
$this->functionData['tabSingleColumn'][$count_dd2782801faadc711c549440194a7456]['url'] = $url;
$this->functionData['tabSingleColumn'][$count_dd2782801faadc711c549440194a7456]['title'] = $title;
}
...
{
$count_233d6701c8827f1a2cae1c419d98e866 = is_array($this->functionData['tabStatusUpdates']) ? count($this->functionData['tabStatusUpdates']) : 0;
$this->functionData['tabStatusUpdates'][$count_233d6701c8827f1a2cae1c419d98e866]['updates'] = $updates;
$this->functionData['tabStatusUpdates'][$count_233d6701c8827f1a2cae1c419d98e866]['actions'] = $actions;
$this->functionData['tabStatusUpdates'][$count_233d6701c8827f1a2cae1c419d98e866]['member'] = $member;
}
...
<div class='status_profile_actions'>
	" . ((count( $actions )) ? ("".$this->__f__fb7a1672458836846605f219278fe62b($updates,$actions,$member)."		<br />
		<div class='right'>
...
function __f__fb7a1672458836846605f219278fe62b($updates=array(), $actions, $member=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;

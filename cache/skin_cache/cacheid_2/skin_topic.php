...
{
$count_64941ceeda7fbe2a1446616dd332767c = is_array($this->functionData['archiveStatusMessage']) ? count($this->functionData['archiveStatusMessage']) : 0;
$this->functionData['archiveStatusMessage'][$count_64941ceeda7fbe2a1446616dd332767c]['topic'] = $topic;
$this->functionData['archiveStatusMessage'][$count_64941ceeda7fbe2a1446616dd332767c]['forum'] = $forum;
}
...
{
$count_c1e94e066369169d7702bff4df1956ec = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_c1e94e066369169d7702bff4df1956ec]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_c1e94e066369169d7702bff4df1956ec]['topicData'] = $topicData;
$this->functionData['pollDisplay'][$count_c1e94e066369169d7702bff4df1956ec]['forumData'] = $forumData;
$this->functionData['pollDisplay'][$count_c1e94e066369169d7702bff4df1956ec]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_c1e94e066369169d7702bff4df1956ec]['showResults'] = $showResults;
$this->functionData['pollDisplay'][$count_c1e94e066369169d7702bff4df1956ec]['editPoll'] = $editPoll;
}
$IPBHTML .= "<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=extras&amp;section=vote&amp;t={$topicData['tid']}&amp;page={$this->request['page']}&amp;do=add&amp;secure_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" name='pollForm' method=\"post\">
		...
		") : ("")) . "
		".$this->__f__7a44b408e6534c9688247a242bb84015($poll,$topicData,$forumData,$pollData,$showResults,$editPoll)."		<fieldset class='submit'>
...
function __f__87d554d4d15eb22de1a91b4906d10efc($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__7a44b408e6534c9688247a242bb84015($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__87d554d4d15eb22de1a91b4906d10efc($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_73330077402df0ce2b20001f5082ec5d = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_73330077402df0ce2b20001f5082ec5d]['post'] = $post;
$this->functionData['post'][$count_73330077402df0ce2b20001f5082ec5d]['displayData'] = $displayData;
$this->functionData['post'][$count_73330077402df0ce2b20001f5082ec5d]['topic'] = $topic;
$this->functionData['post'][$count_73330077402df0ce2b20001f5082ec5d]['forum'] = $forum;
}
...
{
$count_7b402702b9788b2004146feab662de31 = is_array($this->functionData['quickEditPost']) ? count($this->functionData['quickEditPost']) : 0;
$this->functionData['quickEditPost'][$count_7b402702b9788b2004146feab662de31]['post'] = $post;
}
$IPBHTML .= "{$post['post']}
    {$post['attachmentHtml']}
	<br />
...
{
$count_8e05b7cac79d35b1002af7fc483c5119 = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_8e05b7cac79d35b1002af7fc483c5119]['title'] = $title;
$this->functionData['show_attachment_title'][$count_8e05b7cac79d35b1002af7fc483c5119]['data'] = $data;
$this->functionData['show_attachment_title'][$count_8e05b7cac79d35b1002af7fc483c5119]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__0ade157c62d31d77a5f28abe0f4f7896($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__0ade157c62d31d77a5f28abe0f4f7896($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_9670f16bd9de78e3c2f19af583b70c4d = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_9670f16bd9de78e3c2f19af583b70c4d]['data'] = $data;
}
...
{
$count_5f1afc09c104858b1042c0b095ffdec2 = is_array($this->functionData['softDeletedPostBit']) ? count($this->functionData['softDeletedPostBit']) : 0;
$this->functionData['softDeletedPostBit'][$count_5f1afc09c104858b1042c0b095ffdec2]['post'] = $post;
$this->functionData['softDeletedPostBit'][$count_5f1afc09c104858b1042c0b095ffdec2]['sdData'] = $sdData;
$this->functionData['softDeletedPostBit'][$count_5f1afc09c104858b1042c0b095ffdec2]['topic'] = $topic;
}
...
{
$count_ea33816cb60955a0ace066f8cff4514c = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_ea33816cb60955a0ace066f8cff4514c]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_ea33816cb60955a0ace066f8cff4514c]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_ea33816cb60955a0ace066f8cff4514c]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_ea33816cb60955a0ace066f8cff4514c]['displayData'] = $displayData;
}
...
<div class='master_list'>
	...
	" . ((is_array( $post_data ) AND count( $post_data )) ? ("
		".$this->__f__9c60baa92402f010ae7c2dce6e6a814c($forum,$topic,$post_data,$displayData)."	") : ("")) . "
	...
	") : ("")) . "<!--hook.if.skin_topic.topicViewTemplate.canShare.post.endif-->
		...
		<div style='text-align:center'>
			...
			<div id='mobileModOptions' style='display:none'>
				".$this->__f__e1f6af455c706bd27a6ee4e5c85fef4f($forum,$topic,$post_data,$displayData)."			</div>
		</div>
	") : ("")) . "
	<div class='controls'>
		<div class='buttons'>
	...
	<!--hook.if.skin_topic.topicViewTemplate.fastReply.pre.startif-->" . (($displayData['fast_reply'] && $displayData['reply_button']['url']) ? ("<h2>{$this->lang->words['qr_title']}</h2>
		<div class='row'>
...
function __f__9c60baa92402f010ae7c2dce6e6a814c($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e1f6af455c706bd27a6ee4e5c85fef4f($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;

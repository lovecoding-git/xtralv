...
{
$count_99e93432a73b1005a196885488cca33c = is_array($this->functionData['editor']) ? count($this->functionData['editor']) : 0;
$this->functionData['editor'][$count_99e93432a73b1005a196885488cca33c]['formField'] = $formField;
$this->functionData['editor'][$count_99e93432a73b1005a196885488cca33c]['content'] = $content;
$this->functionData['editor'][$count_99e93432a73b1005a196885488cca33c]['options'] = $options;
$this->functionData['editor'][$count_99e93432a73b1005a196885488cca33c]['autoSaveData'] = $autoSaveData;
$this->functionData['editor'][$count_99e93432a73b1005a196885488cca33c]['warningInfo'] = $warningInfo;
$this->functionData['editor'][$count_99e93432a73b1005a196885488cca33c]['acknowledge'] = $acknowledge;
$this->functionData['editor'][$count_99e93432a73b1005a196885488cca33c]['bbcodeVersion'] = $bbcodeVersion;
$this->functionData['editor'][$count_99e93432a73b1005a196885488cca33c]['showEditor'] = $showEditor;
}
...
{
$count_f3b08b103c61e9b4c99ea4332c156ac8 = is_array($this->functionData['editorSettings']) ? count($this->functionData['editorSettings']) : 0;
}
...
{
$count_4adc5abdd2c927720b467bd215731cb4 = is_array($this->functionData['mediaGenericWrapper']) ? count($this->functionData['mediaGenericWrapper']) : 0;
$this->functionData['mediaGenericWrapper'][$count_4adc5abdd2c927720b467bd215731cb4]['rows'] = $rows;
$this->functionData['mediaGenericWrapper'][$count_4adc5abdd2c927720b467bd215731cb4]['pages'] = $pages;
$this->functionData['mediaGenericWrapper'][$count_4adc5abdd2c927720b467bd215731cb4]['app'] = $app;
$this->functionData['mediaGenericWrapper'][$count_4adc5abdd2c927720b467bd215731cb4]['plugin'] = $plugin;
}
...
<div>
	<ul class='media_results'>
		" . ((count($rows)) ? ("
			".$this->__f__5cecffbf4cb8b52b21a48d6dc256d9f2($rows,$pages,$app,$plugin)."		") : ("
...
function __f__5cecffbf4cb8b52b21a48d6dc256d9f2($rows, $pages, $app, $plugin)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $rows as $row )
...
{
$count_a46e9ae4648602ba21e6bd37464abc24 = is_array($this->functionData['sharedMedia']) ? count($this->functionData['sharedMedia']) : 0;
$this->functionData['sharedMedia'][$count_a46e9ae4648602ba21e6bd37464abc24]['tabs'] = $tabs;
}
...
<div class='fixed_inner ipsBox'>
	...
	<div class='ipsVerticalTabbed ipsLayout ipsLayout_withleft ipsLayout_smallleft clearfix'>
		<div class='ipsVerticalTabbed_tabs ipsLayout_left'>
			<ul id='mymedia_tabs'>
				".$this->__f__59549c96eef84224d57ec03de39157c3($tabs)."			</ul>
		</div>
...
function __f__59549c96eef84224d57ec03de39157c3($tabs)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tabs as $tab )

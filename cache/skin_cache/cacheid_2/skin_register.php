...
{
$count_e8b6f30dcfb4c07b23f6abc6fe51f42c = is_array($this->functionData['completePartialLogin']) ? count($this->functionData['completePartialLogin']) : 0;
$this->functionData['completePartialLogin'][$count_e8b6f30dcfb4c07b23f6abc6fe51f42c]['mid'] = $mid;
$this->functionData['completePartialLogin'][$count_e8b6f30dcfb4c07b23f6abc6fe51f42c]['key'] = $key;
$this->functionData['completePartialLogin'][$count_e8b6f30dcfb4c07b23f6abc6fe51f42c]['custom_fields'] = $custom_fields;
$this->functionData['completePartialLogin'][$count_e8b6f30dcfb4c07b23f6abc6fe51f42c]['errors'] = $errors;
$this->functionData['completePartialLogin'][$count_e8b6f30dcfb4c07b23f6abc6fe51f42c]['reg'] = $reg;
$this->functionData['completePartialLogin'][$count_e8b6f30dcfb4c07b23f6abc6fe51f42c]['userFromService'] = $userFromService;
}
	...
	<div class='post_form'>
		...
		" . (($custom_fields != '') ? ("<fieldset class='row1'>
				...
				" . ((is_array( $custom_fields['required'] ) && count( $custom_fields['required'] )) ? ("
					".$this->__f__8e04c6f8b8e77cd573e654f25e934a30($mid,$key,$custom_fields,$errors,$reg,$userFromService)."				") : ("")) . "
				
				" . ((is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] )) ? ("
					".$this->__f__e809261a13d98f344293507246f89519($mid,$key,$custom_fields,$errors,$reg,$userFromService)."				") : ("")) . "
			</fieldset>") : ("")) . "
...
function __f__8e04c6f8b8e77cd573e654f25e934a30($mid="",$key="",$custom_fields="",$errors="", $reg="", $userFromService=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__e809261a13d98f344293507246f89519($mid="",$key="",$custom_fields="",$errors="", $reg="", $userFromService=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0825cd0c8cea7bf309d9dcb748be0626 = is_array($this->functionData['lostPasswordForm']) ? count($this->functionData['lostPasswordForm']) : 0;
$this->functionData['lostPasswordForm'][$count_0825cd0c8cea7bf309d9dcb748be0626]['errors'] = $errors;
}
...
{
$count_ba5a6f154b962ec5e95e9c73f76bddf8 = is_array($this->functionData['registerCoppaForm']) ? count($this->functionData['registerCoppaForm']) : 0;
}
$IPBHTML .= "<html>
	<head>
...
{
$count_b8841d0227c8f5241b9c3ab69298f5ca = is_array($this->functionData['registerCoppaStart']) ? count($this->functionData['registerCoppaStart']) : 0;
}
		...
		<div class='row post line_spacing'>
			...
			<br /><br />
				<select name='month' id='coppa_bday_m'>
					".$this->__f__16a789a0d694513a5b21405df776e561()."				</select>
				&nbsp;
				<select name='day' id='coppa_bday_d'>
					".$this->__f__09b52636b767ed9619397567ea24f835()."				</select>
				&nbsp;
				<select name='year' id='coppa_bday_y'>
					".$this->__f__86bf46660c0640d6469a060f9cf79d85()."				</select>
			</div>
		<div class='submit'>
...
function __f__16a789a0d694513a5b21405df776e561()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__09b52636b767ed9619397567ea24f835()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__86bf46660c0640d6469a060f9cf79d85()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_43a0380cf2f7577db70d61dc7fe0e300 = is_array($this->functionData['registerForm']) ? count($this->functionData['registerForm']) : 0;
$this->functionData['registerForm'][$count_43a0380cf2f7577db70d61dc7fe0e300]['general_errors'] = $general_errors;
$this->functionData['registerForm'][$count_43a0380cf2f7577db70d61dc7fe0e300]['data'] = $data;
$this->functionData['registerForm'][$count_43a0380cf2f7577db70d61dc7fe0e300]['inline_errors'] = $inline_errors;
$this->functionData['registerForm'][$count_43a0380cf2f7577db70d61dc7fe0e300]['time_select'] = $time_select;
$this->functionData['registerForm'][$count_43a0380cf2f7577db70d61dc7fe0e300]['custom_fields'] = $custom_fields;
$this->functionData['registerForm'][$count_43a0380cf2f7577db70d61dc7fe0e300]['nexusFields'] = $nexusFields;
$this->functionData['registerForm'][$count_43a0380cf2f7577db70d61dc7fe0e300]['nexusStates'] = $nexusStates;
}
	...
	") : ("<div class='master_list'>
			...
			" . ((is_array( $general_errors ) && count( $general_errors )) ? ("
				<div class='message error'>
					...
					".$this->__f__afef05d5bf888412a6176ac89f855fe2($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."				</div>
			") : ("")) . "
			...
			<form class='ipsForm_vertical' action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&amp;module=global&amp;section=register", "public",'' ), "", "" ) . "\" method=\"post\" name=\"REG\" id='register'>
				...
				" . ((( is_array( $custom_fields['required'] ) && count( $custom_fields['required'] ) ) || ( is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] ) )) ? ("<div class='row line_spacing'>
						" . ((is_array( $custom_fields['required'] ) && count( $custom_fields['required'] )) ? ("
							".$this->__f__7df44cae14ff0ea9b335fc77e617b768($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."						") : ("")) . "
				
						" . ((is_array( $custom_fields['optional'] ) && count( $custom_fields['optional'] )) ? ("
							".$this->__f__5436461a52ece30ed9d9aaa34c3df9d4($general_errors,$data,$inline_errors,$time_select,$custom_fields,$nexusFields,$nexusStates)."						") : ("")) . "
						<!--IBF.MODULES.EXTRA-->
					</div>") : ("")) . "
...
function __f__afef05d5bf888412a6176ac89f855fe2($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__7df44cae14ff0ea9b335fc77e617b768($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $custom_fields['required'] as $_field )
...
function __f__5436461a52ece30ed9d9aaa34c3df9d4($general_errors=array(), $data=array(), $inline_errors=array(), $time_select=array(), $custom_fields=array(), $nexusFields=array(), $nexusStates=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $custom_fields['optional'] as $_field )
...
{
$count_128d80eac4051ecc3a436750a78910bd = is_array($this->functionData['showLostpassForm']) ? count($this->functionData['showLostpassForm']) : 0;
$this->functionData['showLostpassForm'][$count_128d80eac4051ecc3a436750a78910bd]['error'] = $error;
}
...
{
$count_4c9d40c3dc3e49d6d8291b45173f8f49 = is_array($this->functionData['showRevalidateForm']) ? count($this->functionData['showRevalidateForm']) : 0;
$this->functionData['showRevalidateForm'][$count_4c9d40c3dc3e49d6d8291b45173f8f49]['name'] = $name;
$this->functionData['showRevalidateForm'][$count_4c9d40c3dc3e49d6d8291b45173f8f49]['error'] = $error;
}
$IPBHTML .= "<h2>{$this->lang->words['rv_title']}</h2>
" . (($error) ? ("

...
{
$count_6b2cb253a75f3a732611dc507bd82c6a = is_array($this->functionData['ajaxNewUser']) ? count($this->functionData['ajaxNewUser']) : 0;
$this->functionData['ajaxNewUser'][$count_6b2cb253a75f3a732611dc507bd82c6a]['data'] = $data;
}
...
{
$count_4354f8e2144d1e6a999fb41b3286ea8e = is_array($this->functionData['chatRoom']) ? count($this->functionData['chatRoom']) : 0;
$this->functionData['chatRoom'][$count_4354f8e2144d1e6a999fb41b3286ea8e]['options'] = $options;
$this->functionData['chatRoom'][$count_4354f8e2144d1e6a999fb41b3286ea8e]['chatters'] = $chatters;
}
...
<script type='text/javascript'>
	...
	".$this->__f__8dd608b92d57d784485ac28c503056c7($options,$chatters)."	// Ignore private chats from..
	".$this->__f__3a3d1acc263bbf8d799959bc2c62238f($options,$chatters)."	" . ((isset( $this->memberData['_ignoredUsers'] ) AND count( $this->memberData['_ignoredUsers'] )) ? ("
		".$this->__f__5734e2a6be76adecb43bbeb2a87fdeb7($options,$chatters)."	") : ("")) . "
	
	// Badwords
	" . ((is_array($this->caches['badwords']) AND count($this->caches['badwords'])) ? ("
		".$this->__f__61ba2ffe17da91c7a4a90d12d6e182b6($options,$chatters)."	") : ("")) . "
	
	// Groups
	".$this->__f__ecb5df2662e37e743258a1443d75504f($options,$chatters)."	
...
<div class='clearfix'>
	...
	<div class='master_list' id='chatters-online-wrap'>
		...
		<ul id='chatters-online' style='display: none;'>
			".$this->__f__7694e345a04ed2458420c94d185de498($options,$chatters)."		</ul>
	</div>
</div>
...
function __f__8dd608b92d57d784485ac28c503056c7($options=array(), $chatters=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__3a3d1acc263bbf8d799959bc2c62238f($options=array(), $chatters=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $chatters as $data )
...
function __f__5734e2a6be76adecb43bbeb2a87fdeb7($options=array(), $chatters=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__61ba2ffe17da91c7a4a90d12d6e182b6($options=array(), $chatters=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__ecb5df2662e37e743258a1443d75504f($options=array(), $chatters=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__7694e345a04ed2458420c94d185de498($options=array(), $chatters=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $chatters as $data )
...
{
$count_75fb04da6211e46f2a538217af64d21e = is_array($this->functionData['chatRules']) ? count($this->functionData['chatRules']) : 0;
$this->functionData['chatRules'][$count_75fb04da6211e46f2a538217af64d21e]['rules'] = $rules;
}

...
{
$count_1aba5d611d5a66faa653d724fbf72dc5 = is_array($this->functionData['messengerDisabled']) ? count($this->functionData['messengerDisabled']) : 0;
}
...
{
$count_038cfd46b0ee6b341a6f49ce5a4cfcfb = is_array($this->functionData['messengerTemplate']) ? count($this->functionData['messengerTemplate']) : 0;
$this->functionData['messengerTemplate'][$count_038cfd46b0ee6b341a6f49ce5a4cfcfb]['html'] = $html;
$this->functionData['messengerTemplate'][$count_038cfd46b0ee6b341a6f49ce5a4cfcfb]['jumpmenu'] = $jumpmenu;
$this->functionData['messengerTemplate'][$count_038cfd46b0ee6b341a6f49ce5a4cfcfb]['dirData'] = $dirData;
$this->functionData['messengerTemplate'][$count_038cfd46b0ee6b341a6f49ce5a4cfcfb]['totalData'] = $totalData;
$this->functionData['messengerTemplate'][$count_038cfd46b0ee6b341a6f49ce5a4cfcfb]['topicParticipants'] = $topicParticipants;
$this->functionData['messengerTemplate'][$count_038cfd46b0ee6b341a6f49ce5a4cfcfb]['inlineError'] = $inlineError;
$this->functionData['messengerTemplate'][$count_038cfd46b0ee6b341a6f49ce5a4cfcfb]['deletedTopic'] = $deletedTopic;
}
$IPBHTML .= "<div class='master_list'>
	...
	" . ((is_array( $topicParticipants ) and count( $topicParticipants )) ? ("
		...
		".$this->__f__b9f429d1bc1ffb18084a7f566fdafb74($html,$jumpmenu,$dirData,$totalData,$topicParticipants,$inlineError,$deletedTopic)."	") : ("")) . "				
	...
	" . (($this->settings['_hideFolders'] != 1) ? ("<h3>{$this->lang->words['folders']} " . (($this->memberData['g_max_messages'] > 0) ? ("<span class='subtext'>{$totalData['full_percent']}% {$this->lang->words['full']}</span>") : ("")) . "</h3>
		...
		" . ((count($dirData)) ? ("
			".$this->__f__a39a393e57fb93beb2a2b6e9f93b4c68($html,$jumpmenu,$dirData,$totalData,$topicParticipants,$inlineError,$deletedTopic)."		") : ("")) . "") : ("")) . "
</div>";
return $IPBHTML;
}


function __f__b9f429d1bc1ffb18084a7f566fdafb74($html, $jumpmenu, $dirData, $totalData=array(), $topicParticipants=array(), $inlineError='', $deletedTopic=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__a39a393e57fb93beb2a2b6e9f93b4c68($html, $jumpmenu, $dirData, $totalData=array(), $topicParticipants=array(), $inlineError='', $deletedTopic=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_364a41f7d7d5c12024ad7a943ba9f7d5 = is_array($this->functionData['sendNewPersonalTopicForm']) ? count($this->functionData['sendNewPersonalTopicForm']) : 0;
$this->functionData['sendNewPersonalTopicForm'][$count_364a41f7d7d5c12024ad7a943ba9f7d5]['displayData'] = $displayData;
}
...
<form id='msgForm' class='ipsForm_vertical' action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "module=messaging&amp;section=send&amp;do=send", "publicWithApp",'' ), "", "" ) . "\" method=\"post\" enctype='multipart/form-data'>
	" . (($displayData['errors']) ? ("
		<div class='message error'>
			...
			".$this->__f__c59de2131317eb6f55e7241ddd332715($displayData)."			{$this->lang->words['pme_none_sent']}
		</div>
	") : ("")) . "
...
function __f__c59de2131317eb6f55e7241ddd332715($displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_bbb8ad37bfa6ad225c04fea3169eff9d = is_array($this->functionData['sendReplyForm']) ? count($this->functionData['sendReplyForm']) : 0;
$this->functionData['sendReplyForm'][$count_bbb8ad37bfa6ad225c04fea3169eff9d]['displayData'] = $displayData;
}
$IPBHTML .= "" . (($this->settings['_hideFolders'] = 1) ? ("") : ("")) . "
...
" . (($displayData['errors']) ? ("
	<div class='message error'>
		<strong>{$this->lang->words['err_errors']}</strong><br />
		".$this->__f__be02ad1240a34b0954f67bd966aa46b9($displayData)."		{$this->lang->words['pme_none_sent']}
	</div>
") : ("")) . "
" . (($displayData['type'] == 'reply') ? ("
...
function __f__be02ad1240a34b0954f67bd966aa46b9($displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $displayData['errors'] as $_error )
...
{
$count_40049caec22935711239e38026dc2cd8 = is_array($this->functionData['showConversation']) ? count($this->functionData['showConversation']) : 0;
$this->functionData['showConversation'][$count_40049caec22935711239e38026dc2cd8]['topic'] = $topic;
$this->functionData['showConversation'][$count_40049caec22935711239e38026dc2cd8]['replies'] = $replies;
$this->functionData['showConversation'][$count_40049caec22935711239e38026dc2cd8]['members'] = $members;
$this->functionData['showConversation'][$count_40049caec22935711239e38026dc2cd8]['jump'] = $jump;
}
$IPBHTML .= "<div class='controls'>
	...
	{$topic['_pages']}
</div>".$this->__f__efabfafc307e2724ad1f96cbff2ff23e($topic,$replies,$members,$jump)."<div class='controls'>
	<div class='buttons'>
...
function __f__efabfafc307e2724ad1f96cbff2ff23e($topic, $replies, $members, $jump="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_21166c5b7d259fb51c5102321cede8df = is_array($this->functionData['showConversationForArchive']) ? count($this->functionData['showConversationForArchive']) : 0;
$this->functionData['showConversationForArchive'][$count_21166c5b7d259fb51c5102321cede8df]['topic'] = $topic;
$this->functionData['showConversationForArchive'][$count_21166c5b7d259fb51c5102321cede8df]['replies'] = $replies;
$this->functionData['showConversationForArchive'][$count_21166c5b7d259fb51c5102321cede8df]['members'] = $members;
}
...
$IPBHTML .= "<html>
	...
	<body>
		...
		<br />
		<br />
		".$this->__f__b2e4aca0666f15df6fce6c6eeb111d56($topic,$replies,$members)."	</body>
</html>";
return $IPBHTML;
}


function __f__b2e4aca0666f15df6fce6c6eeb111d56($topic, $replies, $members)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $replies as $msg_id => $msg )
...
{
$count_cb9b76a7cbed8e6cf2dfd045bea78077 = is_array($this->functionData['showFolder']) ? count($this->functionData['showFolder']) : 0;
$this->functionData['showFolder'][$count_cb9b76a7cbed8e6cf2dfd045bea78077]['messages'] = $messages;
$this->functionData['showFolder'][$count_cb9b76a7cbed8e6cf2dfd045bea78077]['dirname'] = $dirname;
$this->functionData['showFolder'][$count_cb9b76a7cbed8e6cf2dfd045bea78077]['pages'] = $pages;
$this->functionData['showFolder'][$count_cb9b76a7cbed8e6cf2dfd045bea78077]['currentFolderID'] = $currentFolderID;
$this->functionData['showFolder'][$count_cb9b76a7cbed8e6cf2dfd045bea78077]['jumpFolderHTML'] = $jumpFolderHTML;
}
...
" . ((count( $messages )) ? ("
		".$this->__f__a6a5968f73cf77e3eddb7bf3022f369f($messages,$dirname,$pages,$currentFolderID,$jumpFolderHTML)."") : ("
...
function __f__a6a5968f73cf77e3eddb7bf3022f369f($messages, $dirname, $pages, $currentFolderID, $jumpFolderHTML)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_04f1f8a9ca95cfa7b29a2f0cee97c010 = is_array($this->functionData['showSearchResults']) ? count($this->functionData['showSearchResults']) : 0;
$this->functionData['showSearchResults'][$count_04f1f8a9ca95cfa7b29a2f0cee97c010]['messages'] = $messages;
$this->functionData['showSearchResults'][$count_04f1f8a9ca95cfa7b29a2f0cee97c010]['pages'] = $pages;
$this->functionData['showSearchResults'][$count_04f1f8a9ca95cfa7b29a2f0cee97c010]['error'] = $error;
}
...
<div id='message_list'>
		<table class='ipb_table' id='message_table'>
			...
			" . ((count( $messages )) ? ("
								".$this->__f__3fe45bb6b025a29295a1d3c68fd86519($messages,$pages,$error)."			") : ("
				<tr>
...
function __f__3fe45bb6b025a29295a1d3c68fd86519($messages, $pages, $error)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $messages as $id => $msg )

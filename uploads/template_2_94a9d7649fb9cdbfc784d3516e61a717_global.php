...
if ( \IPS\Theme::i()->settings['footeronoff'] =="1" ):
$return .= <<<CONTENT

      <div class="gradient_footer">
        <div class="ipsGrid ipsGrid_collapsePhone ipsLayout_container grdbr">
          
CONTENT;

if ( \IPS\Theme::i()->settings['cl1'] =="1" ):
$return .= <<<CONTENT

          <div class="ipsGrid_span4 ipsType_left acpr">
            <h5><a class="ttll">
CONTENT;
...
<a href="#"><span class="socialgr"><span class="fafooter"><i class="
CONTENT;
...
<ul class='ipsList_inline ipsType_left ipsSpacer_top flc' id="elFooterLinks">
...
$return .= <<<CONTENT
              ...
              <p class="footercp rmscp">
<script>
document.write(unescape('%A9%20%54%65%6D%70%6C%61%74%65%20%63%72%61%66%74%65%64%20%62%79%20%63%79%62%65%72%70%69%78%65%6C%7A%2E%63%6F%6D'));
</script>
                  </p>
          </div>
...
if ( \IPS\Theme::i()->settings['cl2'] =="1" ):
$return .= <<<CONTENT

            <div class="ipsGrid_span2 ipsType_left alnk">
              <h5><a class="ttll">
CONTENT;
...
if ( \IPS\Theme::i()->settings['cl4'] =="1" ):
$return .= <<<CONTENT

           <div class="ipsGrid_span4 ipsType_left abro">
    <h5><a class="ttll">
CONTENT;
...
$return .= \IPS\Theme::i()->getTemplate( "global", "core" )->footergradient(  );
$return .= <<<CONTENT
...
if ( \IPS\Theme::i()->settings['guestonoff'] =="1" ):
$return .= <<<CONTENT
...
<div class="headerbga">
   <div class="ipsGrid ipsGrid_collapsePhone ipsLayout_container">
                 <div class="ipsGrid_span4 ipsType_left ordo">
...
$return .= <<<CONTENT
       ...
       <div class="ipsGrid_span8 ipsType_right ordo">      
...
if ( \IPS\Theme::i()->settings['usermenuposition'] =="left" ):
$return .= <<<CONTENT

                 <div class="ipsGrid_span6 ipsType_left userico">
...
if ( \IPS\Theme::i()->settings['summer'] =="1" ):
$return .= <<<CONTENT
...
if ( \IPS\Theme::i()->settings['honoff'] =="1" ):
$return .= <<<CONTENT
...
$return .= <<<CONTENT
 <i style="padding:unset !important; font-size:10px; background: -webkit-linear-gradient(left,
CONTENT;
...
$return .= <<<CONTENT
); -webkit-background-clip: text; -webkit-text-fill-color: transparent;" class='fa fa-chevron-down'></i>
			</a>
...
$return .= <<<CONTENT
                     ...
                     <a href=""><i class="fa fa-th-large" aria-hidden="true"  data-action='openSidebar' data-ipsTooltip title='
CONTENT;
...
$return .= htmlspecialchars( \IPS\Http\Url::internal( "app=core&module=modcp", null, "modcp", array(), 0 ), ENT_QUOTES | ENT_DISALLOWED, 'UTF-8', TRUE );
$return .= <<<CONTENT
'><i  class="fa fa-gavel mcpz" aria-hidden="true"></i></a>
...
$return .= htmlspecialchars( \IPS\Http\Url::internal( "", "admin", "", array(), 0 ), ENT_QUOTES | ENT_DISALLOWED, 'UTF-8', TRUE );
$return .= <<<CONTENT
' target='_blank' rel="noopener"><i  class="fa fa-bolt acpz" aria-hidden="true"></i></a>
...
$return .= <<<CONTENT
 id='elRegisterButton' class=''><i class="fa fa-key" aria-hidden="true"></i> 
CONTENT;
...
if ( \IPS\Theme::i()->settings['usermenuposition'] =="right" ):
$return .= <<<CONTENT
...
$return .= <<<CONTENT
                  ...
                  <div class="ipsGrid_span6 ipsType_right userico">
...
if ( \IPS\Theme::i()->settings['onoff_slider'] =="1" ):
$return .= <<<CONTENT
...
$return .= \IPS\Theme::i()->getTemplate( "global", "core" )->gslider(  );
$return .= <<<CONTENT
...
<button onclick="topFunction()" id="kampobtn" title="Go to top"><i class="fa fa-arrow-up" aria-hidden="true" class="bounceIn"></i></button>
...
function scrollFunction() {
  if (document.body.scrollTop > 20 || document.documentElement.scrollTop > 20) {
    document.getElementById("kampobtn").style.display = "block";
     document.getElementById("kampobtn").fadeIn = "slow";
  } else {
    document.getElementById("kampobtn").style.display = "none";
  }
}
...
$return .= <<<CONTENT
_menu' data-ipsDialog-title="share_this_comment" id='elShareComment_
CONTENT;
$return .= htmlspecialchars( $comment->id, ENT_QUOTES | ENT_DISALLOWED, 'UTF-8', FALSE );
$return .= <<<CONTENT
...
$return .= <<<CONTENT
	...
	<div class='ipsPadding ipsHide cPostShareMenu' id='elShareComment_
CONTENT;
$return .= htmlspecialchars( $comment->id, ENT_QUOTES | ENT_DISALLOWED, 'UTF-8', FALSE );
$return .= <<<CONTENT
_menu'>
...
if ( \IPS\Settings::i()->edit_log_prune ):
$return .= <<<CONTENT
...
<div class="copyrightline">
  <div class="ipsLayout_container">
  <div class="leftinv">
    Template crafted with a lot of <i class="fa fa-coffee" aria-hidden="true"></i> by <a href="https://invisioncommunity.com/profile/586784-rovisiontech/content/?type=downloads_file"> cyberpixelz </a>
  </div>
  
  <div class="rightdoc">
   Community Software by <a href="https://invisioncommunity.com/">Invision Power Services, Inc.</a>
  </div>
  </div>
</div>
CONTENT;
...
$return .= htmlspecialchars( \IPS\Http\Url::internal( "app=core&module=system&controller=login", null, "login", array(), 0 ), ENT_QUOTES | ENT_DISALLOWED, 'UTF-8', TRUE );
$return .= <<<CONTENT
' class="ipsFollow ipsPos_middle ipsButton ipsButton_light ipsButton_verySmall 
CONTENT;
...
$return .= <<<CONTENT
 ...
 <p class="rmscp ipsType_center">
    <script language="javascript">
<!--
// == Begin Free HTML Source Code Obfuscation Protection from https://snapbuilder.com == //
document.write(unescape('%3C%69%20%63%6C%61%73%73%3D%22%66%61%20%66%61%2D%63%6F%70%79%72%69%67%68%74%22%20%61%72%69%61%2D%68%69%64%64%65%6E%3D%22%74%72%75%65%22%3E%3C%2F%69%3E%43%79%62%65%72%70%69%78%65%6C%7A%2E%63%6F%6D%20%32%30%31%38%2D%32%30%31%39'));
//-->
</script>
    </p>
<p id='elCopyright'>
...
if ( \IPS\Theme::i()->settings['elixfooteronoff'] =='1' ):
$return .= <<<CONTENT

      <div class="footerdown-elix">
        <div class="ipsLayout_container">
<br>
...
<ul id='elFooterSocialLinks' class='ipsList_inline ipsType_left ipsSpacer_top'>
...
<ul class='ipsList_inline ipsType_keft ipsSpacer_top' id="elFooterLinks">
...
<div class="entirefooter">
  <div class="ipsLayout_container">
  <div class="ipsGrid ipsGrid_collapsePhone">
			<div class="ipsGrid_span4 ipsType_left hrfscz bo">
              <h3 class="h3scza"><i class="fa fa-life-ring" aria-hidden="true"></i> 
CONTENT;
...
$return .= <<<CONTENT
    ...
    <div class="ipsGrid_span2 ipsType_left hrfscz">
              <h3 class="h3scza"><i class="fa fa-share-alt" aria-hidden="true"></i> 
CONTENT;
...
$return .= <<<CONTENT
    ...
    <div class="ipsGrid_span2 ipsType_left hrfscz">
              <h3 class="h3scza"><i class="fa fa-thumb-tack" aria-hidden="true"></i> 
CONTENT;
...
$return .= <<<CONTENT
    ...
    <div class="ipsGrid_span2 ipsType_left hrfscz">
              <h3 class="h3scza"><i class="fa fa-link" aria-hidden="true"></i> 
CONTENT;
...
$return .= <<<CONTENT
    ...
    <div class="ipsGrid_span2 ipsType_left hrfsczp ba">
               <h3 class="h3scza"><i class="fa fa-users" aria-hidden="true"></i> 
CONTENT;
...
$return .= <<<CONTENT
              ...
              <br>
       <div class="ipsGrid ipsGrid_collapsePhone stff">
                    <div class="ipsGrid_span12 ipsType_left ">
                 
CONTENT;

$loadMember = \IPS\Theme::i()->settings['teamz1'];
$return .= <<<CONTENT


CONTENT;

$return .= \IPS\Theme::i()->getTemplate( "global", "core" )->userPhoto( \IPS\Member::load( $loadMember ) );
$return .= <<<CONTENT

            
CONTENT;

$loadMember = \IPS\Theme::i()->settings['teamz2'];
$return .= <<<CONTENT
...
$loadMember = \IPS\Theme::i()->settings['teamz3'];
$return .= <<<CONTENT
...
$loadMember = \IPS\Theme::i()->settings['teamz4'];
$return .= <<<CONTENT
...
$loadMember = \IPS\Theme::i()->settings['teamz5'];
$return .= <<<CONTENT
...
$loadMember = \IPS\Theme::i()->settings['teamz6'];
$return .= <<<CONTENT
...
$return .= \IPS\Theme::i()->getTemplate( "global", "core" )->footerm(  );
$return .= <<<CONTENT
...
if ( \IPS\Theme::i()->settings['onoff_megafooter'] =="1" ):
$return .= <<<CONTENT

<div id="techSecondarybggg">
          <div class="ipsLayout_container">
            <div class="ecolofooter">
<div class="ipsGrid ipsGrid_collapsePhone">
				<div class="ipsGrid_span4 ipsType_left">
                  <h1 class="footerh1 icoa"> 
                  <i class="fa fa-bullhorn titledrb" aria-hidden="true"></i> 
CONTENT;
...
<ul class='ipsList_inline ipsSpacer_top bug-foot' id="elFooterLinks">
...
$return .= <<<CONTENT
		...
		<li>
			<i class="fa fa-globe footer-men" aria-hidden="true"></i> <a href='#elNavLang_menu' id='elNavLang' data-ipsMenu data-ipsMenu-above>
CONTENT;
...
$return .= <<<CONTENT
		...
		<li>
			<i class="fa fa-tint footer-men" aria-hidden="true"></i> <a href='#elNavTheme_menu' id='elNavTheme' data-ipsMenu data-ipsMenu-above>
CONTENT;
...
$return .= <<<CONTENT
		...
		<li><i class="fa fa-envelope-o footer-men" aria-hidden="true"></i> <a rel="nofollow" href='
CONTENT;
...
$return .= <<<CONTENT
  	...
  	<div class="ipsGrid_span3 ipsType_left">
                  <h1 class="footerh1 icob"> 
                   <i class="fa fa-link titledrb" aria-hidden="true"></i> 
CONTENT;
...
$return .= <<<CONTENT
  	...
  	<div class="ipsGrid_span5 ipsType_left">
                  <h1 class="footerh1 icoc"> 
                  <i class="fa fa-share-square-o titledrb" aria-hidden="true"></i> 
CONTENT;
...
$return .= <<<CONTENT
" class="joinfooter hvr-underline-from-footer"> <i class="fa fa-plus footer-add" aria-hidden="true"></i> 
CONTENT;
...
<div id="techSecondarybdg">
          <div class="ipsLayout_container">
            <div class="ecolofooterbdg">
                <div align="center">
<div class="ipsGrid ipsGrid_collapsePhone ">
				<div class="ipsGrid_span6 ipsType_left ono">
...
$return .= <<<CONTENT
    ...
    <div class="ipsGrid_span6 ipsType_right onof">
...
$return .= <<<CONTENT
			...
			<a href='#elNavLang_menu' id='elNavLang' data-ipsMenu data-ipsMenu-above><i class="fa fa-globe footer-men" aria-hidden="true"></i> 
CONTENT;
...
$return .= <<<CONTENT
			...
			<a href='#elNavTheme_menu' id='elNavTheme' data-ipsMenu data-ipsMenu-above><i class="fa fa-tint footer-men" aria-hidden="true"></i> 
CONTENT;
...
$return .= <<<CONTENT
><i class="fa fa-envelope-o footer-men" aria-hidden="true"></i> 
CONTENT;
...
<div class="entirefooter">
  <div class="ipsGrid ipsGrid_collapsePhone otofoo ">
  <div class="ipsGrid_span4 ipsType_left">
   <h1 class="titleoffooter heso">
...
$return .= <<<CONTENT
    ...
    <div class="ipsGrid_span3 ipsType_left dummyahr">
     <h1 class="titleoffooter hest">
...
$return .= <<<CONTENT
     ...
     <div class="ipsGrid_span2 ipsType_left dummyahr">
     <h1 class="titleoffooter hesf">
...
$return .= <<<CONTENT
			...
			<a href='#elNavTheme_menu' id='elNavTheme' data-ipsMenu data-ipsMenu-above><i class="fa fa-paint-brush firis" aria-hidden="true"></i> 
CONTENT;
...
$return .= <<<CONTENT
			...
			<a href='#elNavLang_menu' id='elNavLang' data-ipsMenu data-ipsMenu-above><i class="fa fa-globe firis" aria-hidden="true"></i> 
CONTENT;
...
$return .= <<<CONTENT
> <i class="fa fa-envelope-open-o firis" aria-hidden="true"></i> 
CONTENT;
...
$return .= <<<CONTENT
    ...
    <br><br>
    <div class="thed">
    <div align="left" style="float:left; display:inline-block;" class="coo">
<span class="copyrightdoc">
  Theme crafted by <a href="http://cyberpixelz.com/forums/index.php?/profile/1-doc/">doc</a>
  </span>
    <br>
    <span class="copyrightdoc">
  Copyright  <a href="https://bemgaz.ro/forum/">mixarena 2019</a>
  </span>
    </div>
    <div align="right" style="float:right; display:inline-block;" class="cot">
     <span class="socialdoc">
  Official Copyright:
  </span>
      <br>
        <span class="socialdoc">
          <a href="">Invision Community</a> 
  </span>
    </div>
    </div>
    <br><br>
...
if ( \IPS\Theme::i()->settings['bckttp'] =="1" ):
$return .= <<<CONTENT

        <a href="#" id="tothetop">
        <i style="color:#535c68; "class="fa fa-arrow-down defacss" aria-hidden="true"></i>
        </a>
   <script>
  ...
  var options = {
    ...
    lineWidth: 3,
    rotate: 270,
    colorCircleBackground: '#535c68',
    colorCircle: '#eb4d4b'
  }
  
  var canvas = document.createElement('canvas');    
  $('#tothetop').append(canvas);  
  ...
  function refreshCanvas(){  
    ...
    if(percent >= 5){
      $('.defacss').addClass('rotate90');  
    }
    else{
      $('.defacss').removeClass('rotate90');
    }
    ...
    drawCircle(options.colorCircle, options.colorCircleBackground, options.lineWidth, percent/100);
  } 
});
      </script>
...
<div align="center">
<div class="gradientsld">
  <input type="radio" name="gradientsld" title="slide1" checked="checked" class="gradientsld_nav"/>
  <input type="radio" name="gradientsld" title="slide2" class="gradientsld_nav"/>
  <input type="radio" name="gradientsld" title="slide3" class="gradientsld_nav"/>
  <input type="radio" name="gradientsld" title="slide4" class="gradientsld_nav"/>
  <div class="gradientsld_inner">
    <div class="gradientsld_contents caa">
      <div align="left"><h2 class="gradientsld_caption">
CONTENT;


$return .= <<<CONTENT
</h2></div>
      <p class="gradientsld_txt">
CONTENT;
...
$return .= <<<CONTENT
    ...
    <div class="gradientsld_contents cbb">
      <h2 class="gradientsld_caption">
CONTENT;
...
$return .= <<<CONTENT
    ...
    <div class="gradientsld_contents ccc">
      <h2 class="gradientsld_caption ">
CONTENT;
...
$return .= <<<CONTENT
    ...
    <div class="gradientsld_contents cdd">
      <h2 class="gradientsld_caption">
CONTENT;
...
CONTENT;
	...
	function headerstyleoto( $stats, $orientation='vertical' ) {
		$return = '';
		$return .= <<<CONTENT
...
$return .= <<<CONTENT
" class="bounceIn"></a> 
     <span class="username"><p><a href='#elUserLink_menu' id='elUserLink' data-ipsMenu>
...
<center>
  ...
  <div class="divuserbar">

  

<div class="topuser-bar">
...
$return .= <<<CONTENT
  ...
  <span class="user-top">Welcome, <span class="username">
CONTENT;

$return .= htmlspecialchars( \IPS\Member::loggedIn()->name, ENT_QUOTES | ENT_DISALLOWED, 'UTF-8', FALSE );
$return .= <<<CONTENT
</span></span>
  <span class="spacerbruh"> / </span>
  <span class="number-userc"> Posts: <span class="nr-pwl">
CONTENT;

$return .= htmlspecialchars( \IPS\Member::loggedIn()->member_posts, ENT_QUOTES | ENT_DISALLOWED, 'UTF-8', FALSE );
$return .= <<<CONTENT
</span></span>
    <span class="number-userc"> Warns: <span class="nr-pwl">
CONTENT;

$return .= htmlspecialchars( \IPS\Member::loggedIn()->warn_level, ENT_QUOTES | ENT_DISALLOWED, 'UTF-8', FALSE );
$return .= <<<CONTENT
</span></span>
    <span class="number-userc"> Likes: <span class="nr-pwl">
CONTENT;

$return .= htmlspecialchars( \IPS\Member::loggedIn()->pp_reputation_points, ENT_QUOTES | ENT_DISALLOWED, 'UTF-8', FALSE );
$return .= <<<CONTENT
</span></span>
      <span class="number-userc"> Profile Views: <span class="nr-pwl">
CONTENT;

$return .= htmlspecialchars( \IPS\Member::loggedIn()->members_profile_views, ENT_QUOTES | ENT_DISALLOWED, 'UTF-8', FALSE );
$return .= <<<CONTENT
</span></span>
  <span class="spacerbruh"> \ </span>
  ...
  <div class="messagesnot-rep">
    <div class="usermenu-topz">
			<a href='#elUserLink_menu' id='elUserLink' data-ipsMenu>
...
$return .= <<<CONTENT
      ...
      <a href="" data-action='openSidebar' data-ipsTooltip title='
CONTENT;

$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'manage_blocks', ENT_DISALLOWED, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
'><i class="fa fa-align-left" aria-hidden="true"></i></a>
...
$return .= <<<CONTENT
" data-ipsTooltip title='your member id'>#
CONTENT;
...
$return .= <<<CONTENT
                 ...
                 <br>
                 <a href='#elUserLink_menu' id='elUserLink' data-ipsMenu><span style="color:
CONTENT;
...
$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'view_my_profile', ENT_DISALLOWED, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
'><ion-icon name="person" class="eoico"></ion-icon>
CONTENT;
...
$return .= htmlspecialchars( \IPS\Http\Url::internal( "app=core&module=system&controller=attachments", null, "attachments", array(), 0 ), ENT_QUOTES | ENT_DISALLOWED, 'UTF-8', TRUE );
$return .= <<<CONTENT
'><ion-icon name="attach" class="eoico"></ion-icon>
CONTENT;
...
$return .= htmlspecialchars( \IPS\Http\Url::internal( "app=core&module=system&controller=followed", null, "followed_content", array(), 0 ), ENT_QUOTES | ENT_DISALLOWED, 'UTF-8', TRUE );
$return .= <<<CONTENT
'><ion-icon name="bookmark" class="eoico"></ion-icon>
CONTENT;
...
$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'edit_account_settings', ENT_DISALLOWED, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
'><ion-icon name="settings" class="eoico"></ion-icon>
CONTENT;
...
$return .= htmlspecialchars( \IPS\Http\Url::internal( "app=core&module=system&controller=ignore", null, "ignore", array(), 0 ), ENT_QUOTES | ENT_DISALLOWED, 'UTF-8', TRUE );
$return .= <<<CONTENT
'><ion-icon name="close" class="eoico"></ion-icon>
CONTENT;
...
$return .= htmlspecialchars( \IPS\Http\Url::internal( "app=core&module=modcp", null, "modcp", array(), 0 ), ENT_QUOTES | ENT_DISALLOWED, 'UTF-8', TRUE );
$return .= <<<CONTENT
'><ion-icon name="flash" class="ecoico keoz"></ion-icon>
CONTENT;
...
$return .= htmlspecialchars( \IPS\Http\Url::internal( "", "admin", "", array(), 0 ), ENT_QUOTES | ENT_DISALLOWED, 'UTF-8', TRUE );
$return .= <<<CONTENT
' target='_blank' rel="noopener"><ion-icon name="lock" class="eocio keox"></ion-icon>
CONTENT;
...
$return .= <<<CONTENT
<ion-icon name="power" class="eoico"></ion-icon>
CONTENT;
...
$return .= <<<CONTENT
                 ...
                 <div class="userul-menu">
                   <br>
                    <div class="usertitle-menu">
     <p> User Menu </p>
   </div>
                   <br>
...
$return .= <<<CONTENT
'>
					<ion-icon name="add-circle-outline" class="usericodel"></ion-icon> 
CONTENT;
...
$return .= <<<CONTENT
' data-ipsMenu data-ipsMenu-closeOnClick='false'>
				<ion-icon name="notifications-outline" class="usericodel"></ion-icon> 
CONTENT;
...
$return .= <<<CONTENT
' data-ipsMenu data-ipsMenu-closeOnClick='false'>
					<ion-icon name="folder-open" class="usericodel"></ion-icon> 
CONTENT;
...
$return .= <<<CONTENT
' data-ipsMenu data-ipsMenu-closeOnClick='false'>
						<ion-icon name="megaphone" class="usericodel"></ion-icon> Reports 
CONTENT;
...
$return .= <<<CONTENT
		                 ...
		                 <a href="" data-action='openSidebar'><ion-icon name="cube" class="usericodel" ></ion-icon> Open Sidebar</a>    
...
$return .= <<<CONTENT
" data-ipsTooltip title='your member id'>#0</span>
                 <br>
                 <a href='#elUserLink_menu' id='elUserLink' data-ipsMenu><span style="color:
CONTENT;
...
$return .= <<<CONTENT
                 ...
                 <a href='#elUserLink_menu' id='elUserLink' data-ipsMenu></a>                 
   </div>
     <div class="userul-menu">
                   <br>
                    <div class="usertitle-menu">
...
$return .= <<<CONTENT
' data-ipsMenu-closeOnClick="false" data-ipsMenu id='elUserSignIn'>
               <ion-icon name="key" class="usericodel"></ion-icon> Sign In
            </a>
...
$return .= <<<CONTENT
 id='elRegisterButton' class=''><ion-icon name="add" class="usericodel"></ion-icon> Sign Up</a>
...
CONTENT;
 ...
 <div id='elSiteOffline'>
	<h2 class='ipsType_reset'><i class='fa fa-warning'></i></h2>
...
<ul class='ipsList_inline ipsType_left ' id="elFooterLinks">
...
$return .= <<<CONTENT
    ...
    <div class="ipsGrid_span2 ipsType_left bbro">
      <h3><a class="docahr">
CONTENT;
...
$return .= <<<CONTENT
    ...
    <div class="ipsGrid_span6 ipsType_right cbro">
<figure class="onixff">
...
if ( \IPS\Theme::i()->settings['socialonoff'] =="1" ):
$return .= <<<CONTENT

       <div class="ipsGrid_span12 ipsType_center socialf">
         <a data-ipsTooltip title='Facebook' href="
CONTENT;
...
" aria-hidden="true"></i></a>
         <a data-ipsTooltip title='Twitter' href="
CONTENT;
...
$return .= <<<CONTENT
" aria-hidden="true"></i></a>
         <a data-ipsTooltip title='Instagram' href="
CONTENT;
...
$return .= <<<CONTENT
" aria-hidden="true"></i></a>
         <a data-ipsTooltip title='Whatsapp' href="
CONTENT;
...
$return .= <<<CONTENT
" aria-hidden="true"></i></a>
         <a data-ipsTooltip title='Google +' href="
CONTENT;
...
$return .= <<<CONTENT
'>
					<ion-icon name="add-circle-outline" class="usericodel spacexe"></ion-icon>
				</a>
				<div id='elCreateNew_menu' class='ipsMenu ipsMenu_auto ipsHide'>
					<ul>
...
$return .= <<<CONTENT
' data-ipsMenu data-ipsMenu-closeOnClick='false'>
				<ion-icon name="notifications-outline" class="usericodel spacexe"></ion-icon>  <span class='ipsNotificationCount eldro 
CONTENT;
...
$return .= <<<CONTENT
' data-ipsMenu data-ipsMenu-closeOnClick='false'>
					<ion-icon name="folder-open" class="usericodel spacexe"></ion-icon>  <span class='ipsNotificationCount eldro 
CONTENT;
...
$return .= <<<CONTENT
' data-ipsMenu data-ipsMenu-closeOnClick='false'>
						<ion-icon name="megaphone" class="usericodel spacexe"></ion-icon> 
CONTENT;

if ( \IPS\Member::loggedIn()->reportCount() ):
$return .= <<<CONTENT
<span class='ipsNotificationCount eldro' data-notificationType='reports'>
CONTENT;
...
$return .= <<<CONTENT
		                 ...
		                 <a href="" data-action='openSidebar' data-ipsTooltip title='Open Sidebar'><ion-icon name="cube" class="usericodel spacexe" ></ion-icon></a>    
...
$return .= <<<CONTENT
  ...
  <div class="spc"> </div>
   <div class="user-avatar orizonlef">
...
$return .= <<<CONTENT
               ...
               <div class="username-avatar orizonlef">
                 <a href='#elUserLink_menu' id='elUserLink' data-ipsMenu><span style="color:
CONTENT;
...
$return .= htmlspecialchars( \IPS\Member::loggedIn()->name, ENT_QUOTES | ENT_DISALLOWED, 'UTF-8', FALSE );
$return .= <<<CONTENT
 <i class="fa fa-chevron-down olzzz" aria-hidden="true"></i></span>
			</a>
			<ul id='elUserLink_menu' class='ipsMenu ipsMenu_normal ipsHide'>
				<li class='ipsMenu_title'>
CONTENT;
...
$return .= <<<CONTENT
	...
	<div class='ipsPadding ipsHide cPostShareMenu' id='elShareReview_
CONTENT;
$return .= htmlspecialchars( $review->id, ENT_QUOTES | ENT_DISALLOWED, 'UTF-8', FALSE );
$return .= <<<CONTENT
_menu'>
...
if ( \IPS\Theme::i()->settings['slider_onoff'] =='1' ):
$return .= <<<CONTENT

<div class="slideshow-container">
<div class="mySlides fade exo roga">
    <span class="gigj">
CONTENT;
...
<div class="mySlides fade exo rogb">  
  <span class="gigj ">
CONTENT;
...
<div class="mySlides fade exo rogc">
    <span class="gigj ">
CONTENT;
...
if ( \IPS\Theme::i()->settings['slider_arrowsonoff'] =='1' ):
$return .= <<<CONTENT
...
if ( \IPS\Theme::i()->settings['slider_dotonoff'] =='1' ):
$return .= <<<CONTENT
...
if ( \IPS\Theme::i()->settings['christmas'] =="1" ):
$return .= <<<CONTENT
...
$return .= <<<CONTENT
" data-ipsTooltip class='ipsRepBadge ipsRepBadge_positive'>
...
$return .= htmlspecialchars( \IPS\Http\Url::internal( "app=core&module=search&controller=search&tags={$tag}", null, "tags", array(), 0 ), ENT_QUOTES | ENT_DISALLOWED, 'UTF-8', TRUE );
$return .= <<<CONTENT
" class='ipsTag' title="
CONTENT;
...
<div class="techsld">
  <input type="radio" name="techsld" title="slide1" checked="checked" class="techsld_nav"/>
  <input type="radio" name="techsld" title="slide2" class="techsld_nav"/>
  <input type="radio" name="techsld" title="slide3" class="techsld_nav"/>
  <input type="radio" name="techsld" title="slide4" class="techsld_nav"/>
  <div class="techsld_inner">
    <div class="techsld_contents caa"><i class="techsld_image 
CONTENT;


$return .= <<<CONTENT
"></i>
      <h2 class="techsld_caption">
CONTENT;
...
$return .= <<<CONTENT
    ...
    <div class="techsld_contents cbb"><i class="techsld_image 
CONTENT;
...
$return .= <<<CONTENT
    ...
    <div class="techsld_contents ccc"><i class="techsld_image 
CONTENT;
...
$return .= <<<CONTENT
    ...
    <div class="techsld_contents cdd"><i class="techsld_image 
CONTENT;
...
$return .= <<<CONTENT
		...
		<li class='cNotifications cUserNav_icon marginuserbar'>
			<a href='
CONTENT;
...
$return .= <<<CONTENT
			...
			<li class='cInbox cUserNav_icon marginuserbar'>
				<a href='
CONTENT;
...
$return .= <<<CONTENT
			...
			<li class='cReports cUserNav_icon marginuserbar'>
				<a href='
CONTENT;

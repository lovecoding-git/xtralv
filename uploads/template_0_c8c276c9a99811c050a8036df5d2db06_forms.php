...
CONTENT;
	...
	function checkboxset( $name, $value, $required, $options, $multiple=FALSE, $class='', $disabled=FALSE, $toggles=array(), $id=NULL, $unlimited=NULL, $unlimitedLang='all', $unlimitedToggles=array(), $toggleOn=TRUE, $descriptions=array(), $impliedUnlimited=FALSE ) {
		$return = '';
		$return .= <<<CONTENT
...
$return .= <<<CONTENT
" class="ipsHide ipsField__checkboxOverflow__search" />
...
$return .= <<<CONTENT
' class='ipsComposeArea_attachments ipsClearfix ipsAreaBackground_light ipsUploader ipsUploader--withBorder ipsUploader--insertable' id="
CONTENT;
$return .= htmlspecialchars( $name, ENT_QUOTES | ENT_DISALLOWED, 'UTF-8', FALSE );
$return .= <<<CONTENT
_drop_
...
'>
						<div data-role='files' class='ipsHide ipsComposeArea_attachmentsContainer'>
							<h4 class='ipsType_small ipsType_withHr ipsType_uppercase ipsType_reset'>
CONTENT;
...
$return .= <<<CONTENT
										...
										<div class='ipsUploader__row ipsUploader__row--insertable ipsAttach ipsContained ipsAttach_done' id='elAttach_
CONTENT;
...
$return .= <<<CONTENT
 data-filekey='
CONTENT;
$return .= htmlspecialchars( $file->securityKey, ENT_QUOTES | ENT_DISALLOWED, 'UTF-8', FALSE );
$return .= <<<CONTENT
'
CONTENT;
...
$return .= <<<CONTENT
 ipsType_large'></i> 
											...
											<div class='ipsUploader_rowMeta ipsFlex ipsFlex-flex:11 ipsFlex-fd:column ipsFlex-jc:center ipsFlex-ai:start' data-action='insertFile'>
												<h2 class='ipsUploader_rowTitle ipsMargin:none ipsType_reset ipsAttach_title ipsTruncate ipsTruncate_line' data-role='title'>
CONTENT;
...
$return .= <<<CONTENT
										...
										<div class='ipsUploader__row ipsUploader__row--image ipsUploader__row--insertable ipsAttach ipsContained ipsAttach_done' id='elAttach_
CONTENT;
$return .= htmlspecialchars( $attachID, ENT_QUOTES | ENT_DISALLOWED, 'UTF-8', FALSE );
$return .= <<<CONTENT
' data-role='file' data-fileid='
...
'>
							<ul class='ipsPos_right ipsButton_split'>
								<li  class='ipsButton ipsButton_tiny ipsButton_light'><i class='fa fa-
CONTENT;
...
$return .= <<<CONTENT
				...
				<div class='ipsFlex ipsFlex-ai:center sm:ipsFlex-fd:column sm:ipsFlex-ai:stretch'>
					<a href="#" data-action='uploadFile' class="ipsButton ipsButton_small ipsButton_primary ipsMargin_right sm:ipsMargin_right:none" id="
CONTENT;
$return .= htmlspecialchars( $name, ENT_QUOTES | ENT_DISALLOWED, 'UTF-8', FALSE );
$return .= <<<CONTENT
_browse_
...
$return .= <<<CONTENT
						...
						<a href="#" data-action='stockPhoto' class="ipsButton ipsButton_small ipsButton_veryLight ipsMargin_right sm:ipsMargin:none" id="
CONTENT;
$return .= htmlspecialchars( $name, ENT_QUOTES | ENT_DISALLOWED, 'UTF-8', FALSE );
$return .= <<<CONTENT
_stockphoto_
...
$return .= <<<CONTENT
                    ...
                    <a href="#" data-action='stockPhoto' class="ipsButton ipsButton_verySmall ipsButton_veryLight" id="
CONTENT;
$return .= htmlspecialchars( $name, ENT_QUOTES | ENT_DISALLOWED, 'UTF-8', FALSE );
$return .= <<<CONTENT
_stockphoto_

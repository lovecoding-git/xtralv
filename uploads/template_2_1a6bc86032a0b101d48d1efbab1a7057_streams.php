...
{
	public $cache_key = '11bc0f4031feb1295ac463820283ea9c';
...
$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'stream_unread_links', ENT_DISALLOWED, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
</h3>
		<ul class='ipsSideMenu_list ipsSideMenu_withRadios cStreamForm_list ipsType_normal ipsSpacer_top ipsSpacer_half' data-ipsSideMenu data-ipsSideMenu-type='radio' data-ipsSideMenu-responsive='false'>
...
$val = "{$v}_inline"; $return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( $val, ENT_DISALLOWED, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
	...
	<div class='ipsBox_alt'>
		<ul class="ipsButton_split ipsPos_right ipsClearfix ipsSpacer_bottom ipsSpacer_half">
			<li>
				<a href="
CONTENT;
$return .= htmlspecialchars( $stream->baseUrl->setQueryString( 'view', 'condensed'), ENT_QUOTES | ENT_DISALLOWED, 'UTF-8', FALSE );
$return .= <<<CONTENT
...
$return .= <<<CONTENT
" class="ipsButton ipsButton_veryVerySmall 
CONTENT;
...
$return .= <<<CONTENT
			...
			<li>
				<a href="
CONTENT;
$return .= htmlspecialchars( $stream->baseUrl->setQueryString( 'view', 'expanded'), ENT_QUOTES | ENT_DISALLOWED, 'UTF-8', FALSE );
$return .= <<<CONTENT
...
$return .= <<<CONTENT
 ipsType_light ipsPos_right ipsType_small ipsType_reset ipsJS_show ipsResponsive_hidePhone' data-role='updateMessage'><i class='fa fa-refresh'></i> 
CONTENT;

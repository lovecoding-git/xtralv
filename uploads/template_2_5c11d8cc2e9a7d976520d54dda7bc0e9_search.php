...
$return .= \IPS\Member::loggedIn()->language()->addToStack( htmlspecialchars( 'core_members', ENT_DISALLOWED, 'UTF-8', FALSE ), TRUE, array(  ) );
$return .= <<<CONTENT
</label>
						</span>
						<div class='ipsGrid ipsGrid_collapsePhone'>
...
$return .= <<<CONTENT
		...
		<li>
			<a href='#' class='ipsSideMenu_item' data-ipsMenuValue='
CONTENT;
...
<div data-controller='core.front.search.results' data-term='{$termJSON}' data-role="resultsArea" class='ipsBox'>

...
class _Controller extends \IPS\Helpers\CoverPhoto\Controller
{
	...
	public function editlog()
	{
		...
		\IPS\Output::i()->output = \IPS\Theme::i()->getTemplate( 'global', 'core', 'front' )->commentEditHistory( $item->editHistory( \IPS\Member::loggedIn()->modPermission( 'can_view_editlog' ) ), $item );
	}

...
{	
	...
	public static function defaultConstants()
	{
		...
		{
			$uniqueKey = mb_substr( md5( '8d8b4' . '$Rev: 3023$'), 10, 10 );
		}
		...
		return array(
			...
			// some features behave unexepectedly
				...
				// Marketplace API
				// All of these are just used by IPS developers to test Marketplace integration
				'MARKETPLACE_URL'				=> "https://invisioncommunity.com", // The URL to the Marketplace
				'MARKETPLACE_GUEST_TOKEN'		=> "a6f37dc05b427d82aa5a2e5b6e6229ed_f45f8df7aa132ddfebebe33853187a5f1211d3be8cdf0b41f92c3d20664e9596", // The OAuth access token for making requests when the user is not authenticated
			...
			// to change them.
				...
				'CACHEBUST_KEY'		=> mb_substr( md5( '8d8b4' . '$Rev: 3023$'), 10, 10 ),
				...
				// Mobile App Stuff
				// Do not change these for white-label purposes. White-label apps will be accounted for through settings
				// @todo These are the *beta* app IDs. Need to updae when apps go final.
				'APP_MULTICOMMUNITY_ITUNES_ID'	=> '1520255870',
				'APP_MULTICOMMUNITY_ITUNES_URL'	=> 'https://testflight.apple.com/join/bzsWOXFO',
				'APP_MULTICOMMUNITY_PLAY_ID'	=> 'com.invisioncommunity.communities',
				'APP_MULTICOMMUNITY_PLAY_URL'	=> 'https://play.google.com/apps/testing/com.invisioncommunity.communities',
				'APP_MULTICOMMUNITY_SCHEMA'		=> 'invisioncommunities',
	...
	final public static function checkThirdParty( bool $upgrade=FALSE ): bool
	{
		...
		{
			return \IPS\Cicloud\checkThirdParty( $upgrade );
		}

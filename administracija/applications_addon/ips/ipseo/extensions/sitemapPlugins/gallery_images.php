...
class sitemap_ipseo_gallery_images extends ipseoSitemapPlugin
{
	public function generate()
	{
		...
		while($addedCount < $max)
		{
			...
			{						
				...
				$url		= ipSeo_FURL::build( $url, 'none', $image['caption_seo'], 'viewimage' );
				$lastMod	= is_null($image['post_date']) ? $image['idate'] : $image['post_date'];	

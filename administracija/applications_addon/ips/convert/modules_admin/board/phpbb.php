		...
		private function convert_members()
		{
			...
			while ( $row = ipsRegistry::DB('hb')->fetch($this->lib->queryRes) )
			{
				...
				$members = array(
					...
					'bday_day'			=> ($row['user_birthday']) ? date('j', $row['user_birthday']) : '',
					'bday_month'		=> ($row['user_birthday']) ? date('n', $row['user_birthday']) : '',
					'bday_year'			=> ($row['user_birthday']) ? date('Y', $row['user_birthday']) : '',

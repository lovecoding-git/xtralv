		...
		private function convert_gallery_images()
		{
			...
			while ( $row = ipsRegistry::DB('hb')->fetch($this->lib->queryRes) )
			{
				...
				if ($filedata['filedata'])
				{
					...
					$this->lib->convertImage($row['filedataid'], $save, '', array(), true);
				}
				...
				else
				{
					...
					$save['masked_file_name'] .= "/{$row['attachmentid']}.attach";
						
					$this->lib->convertImage($row['filedataid'], $save, $us['gallery_path'], array(), false);
				}

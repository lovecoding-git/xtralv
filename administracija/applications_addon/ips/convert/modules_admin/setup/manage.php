...
class admin_convert_setup_manage extends ipsCommand
{
    ...
    */
	private function edit_save()
	{
		...
		$this->registry->output->silentRedirect( $this->settings['base_url'] . 'app=convert&module=setup&section=boink' );
	}
    ...
    */
	private function delete()
	{
		...
		$this->registry->output->silentRedirect( $this->settings['base_url'] . 'app=convert&module=setup&section=manage' );
	}

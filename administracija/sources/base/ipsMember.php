 ...
 *
 * Last Updated: $Date: 2015-01-06 14:58:47 -0500 (Tue, 06 Jan 2015) $
 * </pre>
 *
...
class IPSMember
{
	...
	static public function canGiveRep( $data, $memberData )
	{
		...
		if( is_array( $reppedArray ) )
		{
			...
			if ( is_array( $repped ) )
			{
				if( in_array( ipsRegistry::member()->getProperty('member_id'), $repped ) AND ipsRegistry::$settings['reputation_point_types'] != 'like' )
				{
					return false;
				}
			}

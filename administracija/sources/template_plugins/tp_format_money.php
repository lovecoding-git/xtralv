...
* Main loader class
*/
class tp_format_money extends output implements interfaceTemplatePlugins
{
	/**
	...
	public function runPlugin( $data, $options )
	{
		...
		$return	= '" . $this->registry->classifieds->formatMoney( ' . $data . ' )  . "';
	...
	public function getPluginInfo()
	{
		...
		return array( 'name'    => 'format_money',
					  'author'  => 'IPS, Inc.',
					  'usage'   => '{parse format_money="1234.56"}',
					  'options' => array() );
	}
}
 ...
 * Ouput format: HTML
 * (Matt Mecham)
 * Last Updated: $Date: 2014-10-01 13:50:54 -0400 (Wed, 01 Oct 2014) $
 * </pre>
 *
...
class htmlOutput extends coreOutput implements interface_output 
{
	...
	public function fetchOutput( $output, $title, $navigation, $documentHeadItems, $jsLoaderItems, $extraData=array() )
	{
		...
		if ( $this->_outputType == 'normal' )
		{
	        ...
	        $ieCompatible = "<meta http-equiv='X-UA-Compatible' content='IE=edge' />";
	        
	        if ( strpos( $this->member->user_agent, 'Trident/7' ) !== FALSE )
	        {
		        $ieCompatible = "<meta http-equiv='X-UA-Compatible' content='IE=EmulateIE10' />";
	        }

...
class _Achievements
{
	...
	public function matches( \IPS\Member $member, $filters, $object=NULL )
	{
		...
		if(
			!isset( $filters['achievement_points_operator'] ) OR !$filters['achievement_points_operator']
			OR !isset( $filters['achievement_points_value'] ) OR !$filters['achievement_points_value']
			OR !isset( $filters['achievement_badges'] ) OR !$filters['achievement_badges']
			OR !isset( $filters['achievement_ranks'] ) OR !$filters['achievement_ranks']
		)
		{
			return TRUE;
		}

		if ( $filters['achievement_points_operator'] and $filters['achievement_points_value'] )
		{
			$pass = FALSE;
